...
condition|)
block|{
comment|//can use the map directly
return|return
name|map
return|;
block|}
...
literal|"this"
argument_list|,
literal|"Lorg/apache/cxf/jaxb/NamespaceMapper"
operator|+
name|postFix
operator|+
literal|";"
...
name|xd
operator|.
name|getDefaultRootElementField
argument_list|()
operator|!=
literal|null
condition|)
