...
parameter_list|()
block|{     }
comment|/**      * Determines the appropriate SchemaValidationType to return based on either      * a Boolean (for backwards compatibility) or the selected Schema Validation Type.      *       * @param message      * @return      */
specifier|public
specifier|static
name|SchemaValidationType
