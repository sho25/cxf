...
block|{
name|buildTypesWithSchemaImports
argument_list|(
name|service
operator|.
name|getSchemas
...
argument_list|(
literal|"Problem creating schema implementation"
argument_list|,
name|e
argument_list|)
throw|;
block|}
comment|//  try to cast the resulting extension:
try|try
block|{
return|return
name|Schema
...
name|RuntimeException
argument_list|(
literal|"Schema implementation problem"
argument_list|,
name|e
argument_list|)
throw|;
...
expr_stmt|;
block|}
comment|/**      * @param schemas      * @param imports      * @param def      */
specifier|protected
name|void
name|buildTypesWithSchemaImports
parameter_list|(
...
argument_list|)
decl_stmt|;
comment|// this ensures only the schemas directly referenced by the wsdl are included.
if|if
condition|(
name|defNamespaces
operator|.
