...
begin_comment
comment|//CHECKSTYLE:OFF:NCSS    -   This class is just huge and complex
end_comment
...
name|getProperty
argument_list|(
literal|"cxf.validateServiceSchemas"
argument_list|,
literal|"false"
argument_list|)
operator|.
...
name|WARNING
argument_list|,
literal|"Could not create databinding "
operator|+
name|db
operator|.
name|value
...
parameter_list|)
block|{
comment|//ignore, use the no-arg constructor
block|}
return|return
name|cls
operator|.
...
condition|)
block|{
comment|// CXF will only evaluate this endpoint
name|factory
operator|.
...
name|getProperty
argument_list|(
literal|"requireExplicitContractLocation"
argument_list|)
decl_stmt|;
if|if
condition|(
...
name|Message
argument_list|(
literal|"NO_WSDL_NO_SERVICE_CLASS_PROVIDED"
argument_list|,
name|LOG
argument_list|,
name|getWsdlURL
...
argument_list|)
expr_stmt|;
comment|//Set all out of band indexes to MAX_VALUE, anything left at MAX_VALUE after this is unmapped
for|for
control|(
name|MessagePartInfo
name|mpi
...
condition|)
block|{
comment|//header part in wsdl, need to get this mapped in to the unwrapped form
if|if
condition|(
name|paraAnnos
operator|!=
...
condition|)
block|{
comment|//early iterate over FaultInfo before cycling on exception types
comment|//as fi.getMessageParts() is very time-consuming due to elements
comment|//copy in ArrayList constructor
name|mpiMap
operator|=
operator|new
name|HashMap
...
condition|)
block|{
name|processParameterizedTypes
argument_list|()
expr_stmt|;
block|}
name|TypeVariable
...
return|;
block|}
comment|/**      * If 'validate' is true, this class will validate the service. It will report problems      * with the service model and the XML schema for the service.      * @param validate      */
specifier|public
name|void
name|setValidate
parameter_list|(
