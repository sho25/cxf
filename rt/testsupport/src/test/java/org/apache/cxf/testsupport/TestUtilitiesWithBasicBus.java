...
specifier|public
class|class
name|TestUtilitiesWithBasicBus
extends|extends
name|TestUtilities
block|{
specifier|private
...
expr_stmt|;
block|}
comment|/**      * Add objects to the bus to set up the local transport, soap transport, soap bindings, and WSDL manager.      * All you need to test databindings and other type-related operations.      * @throws BusException       */
specifier|public
name|void
name|setUp
parameter_list|()
