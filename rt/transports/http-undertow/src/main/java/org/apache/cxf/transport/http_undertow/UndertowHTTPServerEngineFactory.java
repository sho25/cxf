...
begin_comment
comment|/**  * This Bus Extension handles the configuration of network port  * numbers for use with "http" or "https". This factory  * caches the UndertowHTTPServerEngines so that they may be  * retrieved if already previously configured.  */
end_comment
...
decl_stmt|;
comment|/**      * This map holds TLS Server Parameters that are to be used to      * configure a subsequently created UndertowHTTPServerEngine.      */
specifier|private
name|Map
argument_list|<
name|String
...
argument_list|(
operator|new
name|UndertowBusLifeCycleListener
argument_list|()
argument_list|)
expr_stmt|;
block|}
...
return|;
block|}
comment|/**      * This call sets TLSParametersMap for a UndertowHTTPServerEngine      *      */
specifier|public
name|void
...
block|}
block|}
comment|/**      * This call sets the ThreadingParameters for a UndertowHTTPServerEngine      *      */
specifier|public
name|void
...
block|}
block|}
comment|/**      * calls thru to {{@link #createUndertowHTTPServerEngine(String, int, String)} with 'null' for host value      */
specifier|public
name|void
name|setTLSServerParametersForPort
parameter_list|(
...
expr_stmt|;
block|}
comment|/**      * This call retrieves a previously configured UndertowHTTPServerEngine for the      * given port. If none exists, this call returns null.      */
specifier|public
...
name|fine
argument_list|(
literal|"Creating Undertow HTTP Server Engine for port "
operator|+
name|port
operator|+
literal|"."
...
return|;
block|}
comment|/**      * Calls thru to {{@link #createUndertowHTTPServerEngine(String, int, String)} with a 'null' host value      */
specifier|public
specifier|synchronized
name|UndertowHTTPServerEngine
name|createUndertowHTTPServerEngine
...
name|fine
argument_list|(
literal|"Stopping Undertow HTTP Server Engine on port "
operator|+
name|port
operator|+
literal|"."
...
parameter_list|()
block|{
comment|// shut down the Undertow server in the portMap
