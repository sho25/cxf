...
name|websocket
decl_stmt|;
comment|//FIXME use a ref-id based request and response association instead of using this sequential queue
specifier|private
name|BlockingQueue
argument_list|<
name|Response
...
condition|)
block|{
comment|//TODO add a configurable timeout
try|try
block|{
name|response
operator|=
...
block|}
block|}
comment|// Request and Response are used to represent request and response messages trasfered over the websocket
comment|//REVIST move these classes to be used in other places
specifier|static
class|class
name|Request
block|{
