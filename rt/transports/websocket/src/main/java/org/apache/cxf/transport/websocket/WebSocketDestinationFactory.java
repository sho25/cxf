...
name|?
argument_list|>
name|UNDERTOW_WEBSOCKET_DESTINATION_CTR
init|=
name|probeUndertowConstructor
argument_list|(
literal|"org.apache.cxf.transport.websocket.undertow.UndertowWebSocketDestination"
argument_list|)
decl_stmt|;
specifier|private
specifier|static
...
condition|)
block|{
comment|// for the embedded mode, we stick to jetty if jetty is available
name|JettyHTTPServerEngineFactory
name|serverEngineFactory
init|=
name|bus
...
condition|)
block|{
comment|// use UndertowWebSocketDestination
name|UndertowHTTPServerEngineFactory
name|undertowServerEngineFactory
init|=
name|bus
