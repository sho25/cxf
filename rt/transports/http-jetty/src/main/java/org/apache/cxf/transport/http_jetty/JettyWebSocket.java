...
condition|)
block|{
comment|//TODO use a more appropriate exception (invalidxxx?);
throw|throw
operator|new
name|IOException
argument_list|(
...
return|;
block|}
comment|///// this is copied from AttachmentDeserializer. we may think about putting this method to IOUtils
specifier|private
specifier|static
name|String
name|readLine
