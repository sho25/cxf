...
parameter_list|)
block|{
comment|//ignore, just use the new session manager
block|}
block|}
else|else
block|{
comment|//9.4+ stores the session id handling and cache and everything on the server, just need the handler
name|sh
operator|=
operator|new
name|SessionHandler
