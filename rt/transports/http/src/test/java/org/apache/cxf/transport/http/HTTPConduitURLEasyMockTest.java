...
init|=
literal|"Some Response Message I can test"
decl_stmt|;
specifier|private
enum|enum
name|ResponseStyle
...
condition|)
block|{
comment|// disable http proxy so that the connection mocking works (see setUpConduit)
name|System
operator|.
name|clearProperty
argument_list|(
...
specifier|public
name|void
name|testSendOnewayChunkedEmptyPartialResponseProcessResponse
parameter_list|()
throws|throws
name|Exception
block|{
...
specifier|public
name|void
name|testSendOnewayDoNotProcessResponse
parameter_list|()
throws|throws
name|Exception
block|{
