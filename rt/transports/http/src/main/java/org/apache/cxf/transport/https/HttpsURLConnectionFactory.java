...
specifier|private
name|Class
name|deprecatedSunHttpsURLConnectionClass
decl_stmt|;
specifier|private
name|Class
name|deprecatedSunHostnameVerifierClass
decl_stmt|;
...
block|{
comment|// handle the deprecated sun case
try|try
block|{
name|Class
name|connectionClass
init|=
name|getDeprecatedSunHttpsURLConnectionClass
argument_list|()
decl_stmt|;
name|Class
name|verifierClass
init|=
name|getDeprecatedSunHostnameVerifierClass
argument_list|()
decl_stmt|;
name|Method
name|setHostnameVerifier
...
name|forName
argument_list|(
literal|"com.sun.net.ssl.HttpsURLConnection"
argument_list|)
expr_stmt|;
block|}
return|return
...
name|forName
argument_list|(
literal|"com.sun.net.ssl.HostnameVerifier"
argument_list|)
expr_stmt|;
block|}
return|return
