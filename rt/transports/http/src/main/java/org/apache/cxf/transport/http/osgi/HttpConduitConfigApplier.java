...
begin_comment
comment|/**  * Applies configuration properties to a HTTPConduit  */
end_comment
...
if|if
condition|(
literal|"AsyncExecuteTimeoutRejection"
operator|.
name|equals
argument_list|(
name|k
