...
name|trustDecider
decl_stmt|;
comment|/**      * This field contains the HttpBasicAuthSupplier.      */
specifier|private
...
name|FINE
argument_list|,
literal|"No Basic Auth Supplier configured for Conduit '"
operator|+
name|getConduitName
argument_list|()
operator|+
...
name|FINE
argument_list|,
literal|"HttpBasicAuthSupplier of class '"
operator|+
name|basicAuthSupplier
operator|.
name|getClass
...
name|INFO
argument_list|,
literal|"Basic Auth Supplier, but no Premeptive User Pass."
operator|+
...
block|}
block|}
comment|/**      * This procedure logs the PROTOCOL_HEADERS from the       * Message at the specified logging level.      *       * @param level   The Logging Level.      * @param message The Message.      */
specifier|private
name|void
...
expr_stmt|;
block|}
comment|/**      * This method gets the Basic Auth Supplier that was set/configured for this       * HTTPConduit.      * @return The Basic Auth Supplier or null.      */
specifier|public
name|HttpBasicAuthSupplier
name|getBasicAuthSupplier
parameter_list|()
block|{
return|return
name|this
...
comment|// If this is a GET method we must not touch the output
comment|// stream as this automagically turns the reqest into a POST.
if|if
condition|(
literal|"GET"
operator|.
