...
argument_list|()
decl_stmt|;
comment|// handling the particalResponse by default
name|boolean
name|handlingParticalResponse
init|=
literal|true
decl_stmt|;
comment|// this option will be set to false when we leverage the CXF transport to send stream message
if|if
condition|(
name|Boolean
operator|.
