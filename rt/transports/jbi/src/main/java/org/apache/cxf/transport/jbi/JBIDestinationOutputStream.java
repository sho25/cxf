...
name|SEND_SYNC
init|=
literal|"javax.jbi.messaging.sendSync"
decl_stmt|;
specifier|private
specifier|static
specifier|final
...
control|)
block|{
comment|//check if value is Serializable, and if value is Map or collection,
comment|//just exclude it since the entry of it may not be Serializable as well
if|if
condition|(
name|ent
operator|.
