...
specifier|public
name|void
name|initFromExtensorsAndSpring
parameter_list|(
name|Bus
name|bus
parameter_list|,
...
comment|// Add conduit or destination config from spring
name|Configurer
name|configurer
init|=
name|bus
...
condition|)
block|{
comment|// Using the byte message type by default
name|jmsConfig
operator|.
name|setMessageType
argument_list|(
...
name|serverConfig
operator|.
name|isSetServerReceiveTimeout
argument_list|()
condition|)
block|{
name|jmsConfig
