...
parameter_list|)
block|{
comment|// Fallback if no Workqueuemanager
name|Executor
name|executor
init|=
name|SynchronousExecutor
...
return|;
block|}
comment|/**      * Initialize Sessionfactory, Initialize and start ListenerThread {@inheritDoc}      */
specifier|public
name|void
name|activate
parameter_list|()
...
block|}
block|}
comment|/**      * Decides what correlationId to use for the reply by looking at the request headers. If the request has a      * correlationId set this is taken. Else if the useMessageIDAsCorrelationID is true then the messageId      * from the request message is used as correlation Id      *       * @param request      * @return      * @throws JMSException      */
specifier|public
name|String
