...
specifier|public
class|class
name|NettyHttpServerEngineBeanDefinitionParser
extends|extends
name|AbstractBeanDefinitionParser
block|{
specifier|private
...
block|}
name|String
name|readIdleTimeStr
init|=
name|element
operator|.
name|getAttribute
argument_list|(
literal|"readIdleTime"
argument_list|)
decl_stmt|;
if|if
condition|(
...
block|}
name|String
name|writeIdleTimeStr
init|=
name|element
operator|.
name|getAttribute
argument_list|(
literal|"writeIdleTime"
argument_list|)
decl_stmt|;
if|if
condition|(
...
block|}
name|String
name|maxChunkContentSizeStr
init|=
name|element
operator|.
name|getAttribute
argument_list|(
literal|"maxChunkContentSize"
argument_list|)
decl_stmt|;
if|if
condition|(
...
block|{
return|return
name|SpringNettyHttpServerEngine
operator|.
name|class
return|;
block|}
