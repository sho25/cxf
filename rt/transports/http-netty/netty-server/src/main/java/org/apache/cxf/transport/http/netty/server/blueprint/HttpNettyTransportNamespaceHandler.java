...
begin_comment
comment|//@Namespaces("http://cxf.apache.org/transports/http-netty-server/configuration")
end_comment
...
specifier|final
name|String
name|NETTY_SERVER_ENGINE_FACTORY
init|=
...
name|getResource
argument_list|(
literal|"schemas/configuration/http-netty-server.xsd"
argument_list|)
return|;
block|}
else|else
