...
name|getResource
argument_list|(
literal|"/org/apache/cxf/transport/http/netty/server/spring/invalid-beans.xml"
argument_list|)
operator|.
name|toString
argument_list|()
...
name|getResource
argument_list|(
literal|"/org/apache/cxf/transport/http/netty/server/spring/beans.xml"
argument_list|)
operator|.
name|toString
argument_list|()
...
name|getResource
argument_list|(
literal|"/org/apache/cxf/transport/http/netty/server/spring/beans-props.xml"
argument_list|)
operator|.
name|toString
argument_list|()
