...
decl_stmt|;
comment|/**      * This class replaces the engine in the Netty Http Destination.      */
specifier|private
class|class
...
argument_list|)
expr_stmt|;
comment|// Just create a fake engine
specifier|final
name|NettyHttpServerEngine
name|httpEngine
init|=
...
argument_list|)
decl_stmt|;
comment|//httpEngine.setContinuationsEnabled(false);
name|NettyHttpServerEngineFactory
name|factory
init|=
operator|new
...
argument_list|()
expr_stmt|;
comment|// we don't need to check the status here
