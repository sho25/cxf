...
expr_stmt|;
block|}
comment|/**      * {@link https://issues.apache.org/jira/browse/CXF-7188}      */
annotation|@
name|Test
specifier|public
name|void
name|testTypeWithJaxbAnnotations
parameter_list|()
throws|throws
name|Exception
block|{
...
specifier|public
name|void
name|testWsdlFromJaxbAnnotations
parameter_list|()
throws|throws
name|Exception
block|{
...
name|assertValid
argument_list|(
literal|"//xsd:simpleType[@name='bar']/xsd:restriction[@base='xsd:string']"
argument_list|,
name|doc
argument_list|)
expr_stmt|;
