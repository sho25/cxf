...
name|XSD_DURATION
argument_list|,
literal|"org.apache.cxf.aegis.type.java5.DurationType"
argument_list|)
expr_stmt|;
name|registerIfAvailable
argument_list|(
...
name|XSD_DATE
argument_list|,
literal|"org.apache.cxf.aegis.type.java5.XMLGregorianCalendarType"
argument_list|)
expr_stmt|;
name|registerIfAvailable
argument_list|(
...
name|DatabindingException
argument_list|(
literal|"Couldn't instantiate Type "
argument_list|,
name|e
argument_list|)
throw|;
...
name|debug
argument_list|(
literal|"Could not find optional Type "
operator|+
name|className
operator|+
literal|". Skipping."
