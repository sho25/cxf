...
argument_list|)
expr_stmt|;
comment|/*              * This seems to bespeak some sort of confusion. The problem is that              * no one ever implemented getMinOccurs(name) to even look at the per-element data.              */
name|long
name|minOccurs
init|=
operator|-
...
expr_stmt|;
block|}
comment|/*              * Old code had ridiculous '!=0' here, which cannot have been right.              */
if|if
condition|(
name|minOccurs
operator|!=
