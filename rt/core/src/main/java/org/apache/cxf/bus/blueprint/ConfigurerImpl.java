...
name|xcm
init|=
name|findSetExecutionContextMethod
argument_list|(
name|o
operator|.
name|getClass
...
block|}
block|}
comment|// for Aries blueprint 0.3.1
specifier|private
name|Method
name|findSetExecutionContextMethod
parameter_list|(
...
name|forName
argument_list|(
literal|"org.apache.aries.blueprint.di.ExecutionContext$Holder"
argument_list|,
literal|false
argument_list|,
name|cl
...
name|forName
argument_list|(
literal|"org.apache.aries.blueprint.di.ExecutionContext"
argument_list|,
literal|false
argument_list|,
name|cl
...
name|FINE
argument_list|,
literal|"Could not find the ExecutionContext$Holder.setContext method"
argument_list|,
name|e
argument_list|)
expr_stmt|;
