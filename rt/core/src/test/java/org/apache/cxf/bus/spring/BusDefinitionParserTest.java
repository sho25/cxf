...
specifier|public
name|void
name|testBusConfigureCreateBus
parameter_list|()
block|{
name|ClassPathXmlApplicationContext
name|context
...
name|ClassPathXmlApplicationContext
argument_list|(
literal|"org/apache/cxf/bus/spring/customerBus2.xml"
argument_list|)
expr_stmt|;
name|Bus
name|cxf1
...
name|assertTrue
argument_list|(
literal|"postShutdown not called"
argument_list|,
name|b
operator|.
name|get
...
name|cfgFile
init|=
literal|"org/apache/cxf/bus/spring/lazyInitBus.xml"
decl_stmt|;
name|Bus
name|bus
init|=
