...
parameter_list|)
block|{
comment|//ignorable, just won't get all the errors
name|LOG
operator|.
name|info
argument_list|(
literal|"Unable to set error handler on "
operator|+
name|o
operator|.
name|getClass
...
name|warning
argument_list|(
literal|"Cannot set a catalog resolver into the JDK internal XJC compiler.  Catalog"
operator|+
literal|" resolved schemas may not work correctly"
argument_list|)
expr_stmt|;
block|}
block|}
...
name|WARNING
argument_list|,
literal|"Cannot set a catalog resolver into the XJC compiler.  Catalog"
operator|+
literal|" resolved schemas may not work correctly"
argument_list|,
name|ex
