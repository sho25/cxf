...
return|;
block|}
comment|/**      * For subclasses that hold onto the created Server, this will return the singleton server.      * Default returns null as the default factories do not hold onto the server and will      * create a new one for each call to create();      * @return      */
specifier|public
name|Server
name|getServer
parameter_list|()
