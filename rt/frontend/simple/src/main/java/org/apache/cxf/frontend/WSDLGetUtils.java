...
condition|)
block|{
name|putResolvedSchemaLocationIfRelative
argument_list|(
name|doneSchemas
argument_list|,
name|decodedStart
...
block|}
block|}
comment|/**      * If given decodedStart is relative path, resolves a real location of given schema and puts it into schema map.      *      * @param doneSchemas schema map      * @param decodedStart path referencing schema      * @param schemaReference referenced schema      */
specifier|private
name|void
name|putResolvedSchemaLocationIfRelative
parameter_list|(
