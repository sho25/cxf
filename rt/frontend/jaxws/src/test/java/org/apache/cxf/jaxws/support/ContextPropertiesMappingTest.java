...
specifier|public
name|void
name|testMapRequestfromJaxws2Cxf
parameter_list|()
block|{
name|Object
name|address
...
name|assertNull
argument_list|(
literal|"address should be null"
argument_list|,
name|address
argument_list|)
expr_stmt|;
...
name|assertEquals
argument_list|(
literal|"address should get from requestContext"
argument_list|,
name|address
argument_list|,
name|ADDRESS
...
name|assertEquals
argument_list|(
literal|"the message PROTOCOL_HEADERS should be updated"
argument_list|,
name|header
argument_list|,
name|HEADER
...
name|assertNull
argument_list|(
literal|"requestMethod should be null"
argument_list|,
name|requestMethod
argument_list|)
expr_stmt|;
...
name|assertNotNull
argument_list|(
literal|"requestMethod should not be null"
argument_list|,
name|requestMethod
argument_list|)
expr_stmt|;
...
name|assertNotNull
argument_list|(
literal|"the HTTP_RESPONSE_HEADERS should not be null "
argument_list|,
name|header
argument_list|)
expr_stmt|;
name|assertEquals
argument_list|(
literal|"the HTTP_RESPONSE_HEADERS should be updated"
argument_list|,
name|header
argument_list|,
name|HEADER
...
specifier|public
name|void
name|testUpdateWebServiceContext
parameter_list|()
block|{
name|Exchange
name|xchng
...
name|assertNotNull
argument_list|(
literal|"no response code set on out message"
argument_list|,
name|respCode
argument_list|)
expr_stmt|;
name|assertEquals
argument_list|(
literal|"incorrect response code returned"
argument_list|,
name|RESPONSE_CODE
argument_list|,
name|respCode
