...
literal|"/wsdl:definitions/wsdl:binding/wsdl:operation/"
operator|+
literal|"wsp:PolicyReference[@URI='#echoIntBindingOpPolicy']"
argument_list|,
name|wsdl
argument_list|)
operator|.
...
specifier|public
name|void
name|testAnnotationImplNoInterface
parameter_list|()
throws|throws
name|Exception
block|{
...
literal|"/wsdl:definitions/wsdl:binding/"
operator|+
literal|"wsp:PolicyReference[@URI='#TestImplNoInterfaceServiceSoapBindingBindingPolicy']"
argument_list|,
name|wsdl
argument_list|)
operator|.
...
specifier|public
name|void
name|testAnnotationImplNoInterfacePolicies
parameter_list|()
throws|throws
name|Exception
block|{
...
argument_list|(
operator|new
name|TestImplWithPoliciesNoInterface
argument_list|()
argument_list|)
expr_stmt|;
name|factory
...
literal|"/wsdl:definitions/wsdl:binding/"
operator|+
literal|"wsp:PolicyReference[@URI='#TestImplWithPoliciesNoInterfaceServiceSoapBindingBindingPolicy']"
argument_list|,
name|wsdl
argument_list|)
operator|.
