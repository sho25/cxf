...
literal|"rawtypes"
argument_list|)
comment|// JAX-WS api doesn't specify this as List<Handler<? extends MessageContext>>
name|List
argument_list|<
name|Handler
argument_list|>
...
name|assertTrue
argument_list|(
literal|"custom header should be present"
argument_list|,
name|headers
operator|.
name|containsKey
...
name|assertTrue
argument_list|(
literal|"existing SOAPAction header should not be removed"
argument_list|,
name|headers
operator|.
name|containsKey
