...
argument_list|()
expr_stmt|;
comment|// Verify outputStream
name|CachedStream
name|expectedOs
init|=
name|prepareOutputStreamFromResource
argument_list|(
literal|"resources/greetMeRpcLitRespChanged.xml"
argument_list|)
decl_stmt|;
name|assertTrue
argument_list|(
literal|"The content of outputStream should remain unchanged"
argument_list|,
name|compareInputStream
argument_list|(
name|expectedOs
operator|.
name|getInputStream
...
return|;
block|}
comment|/*     private CachedStream prepareOutputStreamFromSOAPMessage(SOAPMessage soapMessage) throws Exception {         CachedStream os = new CachedStream();         soapMessage.writeTo(os);         return os;     }*/
specifier|private
class|class
name|CachedStream
extends|extends
