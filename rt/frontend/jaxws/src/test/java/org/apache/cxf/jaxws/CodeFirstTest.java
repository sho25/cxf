...
name|fail
argument_list|(
literal|"should throw AddNumbersException"
argument_list|)
expr_stmt|;
block|}
catch|catch
...
name|fail
argument_list|(
literal|"should throw AddNumbersSubException"
argument_list|)
expr_stmt|;
block|}
catch|catch
...
name|fail
argument_list|(
literal|"Proxy should be closed"
argument_list|)
expr_stmt|;
block|}
catch|catch
...
argument_list|()
decl_stmt|;
comment|//factory.setServiceClass(serviceInterface);
name|factory
operator|.
name|setServiceBean
argument_list|(
operator|new
name|GenericsServiceImpl
argument_list|()
argument_list|)
expr_stmt|;
name|factory
...
argument_list|(
literal|"//xsd:schema/xsd:complexType[@name='convert']/xsd:sequence/xsd:element/@type"
argument_list|,
name|Constants
operator|.
name|XSD_INT
...
name|setAddress
argument_list|(
literal|"local://localhost/testNoRootBare"
argument_list|)
expr_stmt|;
name|Server
name|server
...
name|setAddress
argument_list|(
literal|"local://localhost/testcxf2766"
argument_list|)
expr_stmt|;
name|Server
name|server
...
name|assertValid
argument_list|(
literal|"//wsdl:message[@name='doReturnResponse']/wsdl:part[@name='returnResponse']"
argument_list|,
name|doc
argument_list|)
expr_stmt|;
...
name|QName
argument_list|(
literal|"http://cxf.apache.org/service.wsdl"
argument_list|,
literal|"BareService"
argument_list|)
decl_stmt|;
...
name|name
operator|=
literal|"return-response"
argument_list|,
name|targetNamespace
operator|=
literal|"http://cxf.apache.org/service.wsdl/types"
argument_list|,
name|partName
operator|=
literal|"returnResponse"
argument_list|)
annotation|@
name|WebMethod
argument_list|(
name|action
operator|=
literal|"http://cxf.apache.org/doReturn"
argument_list|)
