...
begin_comment
comment|/**  *   * 	  *   * 	  The servlet-link element is used in the service-impl-bean element  * 	  to specify that a Service Implementation Bean is defined as a  * 	  JAX-RPC Service Endpoint.  *   * 	  The value of the servlet-link element must be the servlet-name of  * 	  a JAX-RPC Service Endpoint in the same WAR file.  *   * 	  Used in: service-impl-bean  *   * 	  Example:  *<servlet-link>StockQuoteService</servlet-link>  *   * 	    *         *   *<p>Java class for servlet-linkType complex type.  *   *<p>The following schema fragment specifies the expected content contained within this class.  *   *<pre>  *&lt;complexType name="servlet-linkType">  *&lt;simpleContent>  *&lt;restriction base="&lt;http://java.sun.com/xml/ns/javaee>string">  *&lt;/restriction>  *&lt;/simpleContent>  *&lt;/complexType>  *</pre>  *   *   */
end_comment
