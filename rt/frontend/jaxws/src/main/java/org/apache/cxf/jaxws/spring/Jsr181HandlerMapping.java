...
init|=
literal|"org.apache.cxf.transport.servlet"
decl_stmt|;
specifier|private
specifier|static
specifier|final
name|String
name|AOP_UTILS_CLASS_NAME
init|=
...
specifier|private
name|Method
name|aopUtilsGetTargetClassMethod
decl_stmt|;
specifier|private
name|String
name|urlPrefix
...
name|Message
argument_list|(
literal|"AOP_GET_TARGET_CLASS_MISSING"
argument_list|,
name|LOG
argument_list|)
decl_stmt|;
...
name|?
argument_list|>
name|aopUtilsGetTargetClass
parameter_list|(
name|Object
name|possiblyProxiedObject
parameter_list|)
block|{
if|if
condition|(
...
expr_stmt|;
block|}
comment|/**      * For unit testing ONLY. Disable use of Spring-AOP method to unwrap target classes, to      * ensure that this code works when AOP is not there.      * @param b      */
specifier|public
name|void
name|setSimulateNoAopForUnitTest
parameter_list|(
name|boolean
name|b
parameter_list|)
