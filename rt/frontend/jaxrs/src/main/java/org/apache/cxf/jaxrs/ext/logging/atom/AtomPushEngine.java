...
argument_list|)
expr_stmt|;
comment|// syncing for safe converter/deliverer on the fly replacement
...
name|println
argument_list|(
literal|"Delivery failed, shutting engine down"
argument_list|)
expr_stmt|;
name|executor
operator|.
...
parameter_list|)
block|{
comment|// no action on executor.shutdownNow();
block|}
finally|finally
block|{
name|LoggingThread
