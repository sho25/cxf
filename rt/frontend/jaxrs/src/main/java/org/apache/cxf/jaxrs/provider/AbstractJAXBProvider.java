...
name|SoftReference
argument_list|<
name|JAXBMarshallerUnmarshallerCache
argument_list|>
argument_list|>
name|threadMarshallerCaches
init|=
operator|new
name|HashMap
argument_list|<
...
block|{
name|JAXBMarshallerUnmarshallerCache
name|marshallerUnMarshallerCache
init|=
literal|null
decl_stmt|;
synchronized|synchronized
...
name|JAXBMarshallerUnmarshallerCache
argument_list|>
name|marshallerUnMarshallerCacheRef
init|=
name|threadMarshallerCaches
operator|.
name|get
...
argument_list|)
decl_stmt|;
comment|// need to set this value to make JAXRSClientServerBookTest passed
name|marshaller
operator|.
name|setProperty
argument_list|(
...
block|{
comment|// set the default the value to the marshaller
name|marshaller
operator|.
name|setProperty
argument_list|(
