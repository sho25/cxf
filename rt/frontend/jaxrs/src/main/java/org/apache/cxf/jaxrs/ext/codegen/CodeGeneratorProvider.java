...
name|warning
argument_list|(
literal|"Resource with path "
operator|+
name|path
operator|+
literal|" can not be mapped to a class"
argument_list|)
expr_stmt|;
return|return;
block|}
...
argument_list|()
operator|+
literal|" * Generated by Apache CXF"
operator|+
name|getLineSep
argument_list|()
operator|+
...
name|warning
argument_list|(
literal|"Method with path "
operator|+
name|path
operator|+
literal|" can not be mapped to a class method"
argument_list|)
expr_stmt|;
return|return;
block|}
...
block|{
comment|// TODO : write a custom annotation class based on HttpMethod
block|}
block|}
name|List
argument_list|<
