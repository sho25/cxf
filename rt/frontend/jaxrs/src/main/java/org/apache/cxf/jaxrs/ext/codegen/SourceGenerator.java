...
expr_stmt|;
block|}
comment|//TODO: similar procedure should work for representation, method and param
comment|// thus some of the code here will need to be moved into a sep function to be
comment|// reused by relevant handlers
specifier|private
name|Element
name|getResourceElement
parameter_list|(
