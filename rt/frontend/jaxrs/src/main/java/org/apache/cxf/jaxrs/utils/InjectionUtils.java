...
name|add
argument_list|(
literal|"javax.ws.rs.sse.SseEventSink"
argument_list|)
expr_stmt|;
name|VALUE_CONTEXTS
operator|.
...
condition|)
block|{
comment|//pass empty string to boxed number type will result in 404
return|return
literal|null
return|;
block|}
...
condition|)
block|{
comment|// allow == checks for Boolean object
name|pClass
operator|=
operator|(
name|Class
...
block|)
block|{
comment|// to avoid creating too much ProxyClassLoader to save Metaspace usage
name|LOG
operator|.
name|log
argument_list|(
...
name|FINE
argument_list|,
literal|"can't find required ProxyClassLoader for type "
operator|+
name|type
operator|.
name|getName
...
name|FINE
argument_list|,
literal|"create a new one with parent  "
operator|+
name|Proxy
operator|.
name|class
...
name|FINE
argument_list|,
literal|"ThreadLocalProxy classloader is  "
operator|+
name|ThreadLocalProxy
operator|.
name|class
