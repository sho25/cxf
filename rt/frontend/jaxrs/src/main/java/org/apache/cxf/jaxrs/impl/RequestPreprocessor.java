...
block|{
comment|/**      * Whether to allow the client to override the HTTP method via either METHOD_QUERY or METHOD_HEADER.      * The default is false.      */
specifier|private
specifier|static
specifier|final
name|String
name|ALLOW_HTTP_METHOD_OVERRIDE
init|=
