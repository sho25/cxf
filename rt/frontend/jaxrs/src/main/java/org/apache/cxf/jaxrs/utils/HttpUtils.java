...
specifier|final
name|String
name|REPLACE_LOOPBACK_PROPERTY
init|=
literal|"replace.loopback.address.with.localhost"
decl_stmt|;
specifier|private
specifier|static
specifier|final
...
name|String
argument_list|>
name|KNOWN_HTTP_VERBS_WITH_NO_REQUEST_CONTENT
init|=
operator|new
name|HashSet
argument_list|<>
...
name|String
argument_list|>
name|KNOWN_HTTP_VERBS_WITH_NO_RESPONSE_CONTENT
init|=
operator|new
name|HashSet
argument_list|<>
...
expr_stmt|;
block|}
comment|// If it is going to be an empty string nothing to encode.
if|if
condition|(
name|i
operator|!=
...
name|enc
init|=
name|getMediaTypeCharsetParameter
argument_list|(
name|mt
argument_list|)
decl_stmt|;
