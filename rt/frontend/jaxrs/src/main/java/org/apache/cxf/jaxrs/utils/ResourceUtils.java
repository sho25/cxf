...
specifier|final
name|String
name|NOT_RESOURCE_METHOD_MESSAGE_ID
init|=
literal|"NOT_RESOURCE_METHOD"
decl_stmt|;
specifier|private
specifier|static
specifier|final
name|String
name|NOT_SUSPENDED_ASYNC_MESSAGE_ID
init|=
literal|"NOT_SUSPENDED_ASYNC_METHOD"
decl_stmt|;
specifier|private
specifier|static
specifier|final
name|String
name|NO_VOID_RETURN_ASYNC_MESSAGE_ID
init|=
literal|"NO_VOID_RETURN_ASYNC_METHOD"
decl_stmt|;
specifier|private
specifier|static
specifier|final
...
name|add
argument_list|(
literal|"javax.ws.rs.core.Feature"
argument_list|)
expr_stmt|;
name|SERVER_PROVIDER_CLASS_NAMES
operator|.
name|add
argument_list|(
literal|"org.apache.cxf.jaxrs.ext.ContextProvider"
argument_list|)
expr_stmt|;
block|}
specifier|private
...
condition|)
block|{
comment|// if needed we can also support multiple default methods
name|defaultMethod
operator|=
name|m
expr_stmt|;
...
name|MediaType
argument_list|>
name|defaultConsumes
parameter_list|,
name|List
argument_list|<
name|MediaType
argument_list|>
name|defaultProduces
parameter_list|)
block|{
...
condition|)
block|{
comment|//if a bridge/synthetic method isn't already mapped to something, go ahead and do it
name|Method
name|annotatedMethod
init|=
name|AnnotationUtils
...
name|ancestor
init|=
name|getAncestorWithSameServiceClass
argument_list|(
name|cri
argument_list|,
name|subClass
...
parameter_list|,
name|boolean
name|useSingletonResourceProvider
parameter_list|,
name|Bus
name|bus
parameter_list|)
