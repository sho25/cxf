...
name|URISyntaxException
block|{
comment|// TODO : do encodePartiallyEncoded only once here, do not do it inside buildPath()
comment|// buildFromEncoded and buildFromEncodedMap - we'll need to be careful such that
comment|// path '/' separators are not encoded so probably we'll need to create PathSegments
comment|// again if fromEncoded is set
if|if
condition|(
name|fromEncoded
condition|)
