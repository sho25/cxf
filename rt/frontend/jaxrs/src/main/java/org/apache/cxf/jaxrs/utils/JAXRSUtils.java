...
static|static
block|{
comment|//TODO: Populate it with the upgrade to the more up to date API
name|EXCEPTIONS_MAP
operator|=
operator|new
name|HashMap
...
argument_list|)
decl_stmt|;
comment|//TODO: enable this code after the upgrade to the more up-to-date API
comment|//if (cls == null&& status / 100 == 5) {
comment|//    cls = ServerErrorException.class;
comment|//}
return|return
name|cls
operator|==
