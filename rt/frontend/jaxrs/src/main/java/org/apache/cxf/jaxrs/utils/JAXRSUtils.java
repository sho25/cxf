...
argument_list|)
decl_stmt|;
comment|//private static final ResourceBundle BUNDLE = BundleUtils.getBundle(JAXRSUtils.class);
specifier|private
name|JAXRSUtils
parameter_list|()
block|{             }
...
expr_stmt|;
block|}
comment|// TODO : this is done per every form parameter hence it needs to be refactored
name|FormUtils
operator|.
name|populateMap
argument_list|(
...
argument_list|)
decl_stmt|;
comment|// get the cookie with this name...
name|List
argument_list|<
name|String
argument_list|>
