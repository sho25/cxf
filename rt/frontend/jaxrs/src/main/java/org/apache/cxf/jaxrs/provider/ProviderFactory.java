...
decl_stmt|;
specifier|private
name|LegacyParamConverterProvider
name|legacyParamConverter
decl_stmt|;
specifier|private
name|List
argument_list|<
...
argument_list|)
decl_stmt|;
comment|//TODO: consider using List as a value type for postmatching filters
specifier|private
name|Map
argument_list|<
name|NameKey
...
argument_list|()
decl_stmt|;
comment|// This may be better be kept at OperationResourceInfo ? Though we may have many methods
comment|// across different resources that use the same BeanParam.
specifier|private
name|Map
argument_list|<
name|Class
...
argument_list|()
decl_stmt|;
comment|//TODO: Client-only providers, consider introducing ClientProviderFactory,
comment|//      will make it easier to split the client API into a separate module
specifier|private
name|List
argument_list|<
name|ProviderInfo
