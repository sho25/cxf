...
parameter_list|)
block|{
comment|// Whatever is set inside Configuration is also set in this ProviderFactory
comment|// We use it only to support Configuration injection at a basic level
name|this
operator|.
name|dynamicConfiguration
operator|=
...
condition|)
block|{
comment|//TODO: review the possibility of ParamConverterProvider needing to have Contexts injected
name|Object
name|converter
init|=
name|provider
