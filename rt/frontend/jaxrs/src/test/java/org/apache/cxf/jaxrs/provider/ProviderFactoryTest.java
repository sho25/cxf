...
specifier|public
name|void
name|testDefaultJaxbProviderCloned
parameter_list|()
block|{
name|ProviderFactory
name|pf
...
specifier|public
name|void
name|testDefaultJaxbProviderClonedMultipleThreads
parameter_list|()
throws|throws
name|Exception
block|{
...
name|doneSignal
argument_list|,
literal|"http://localhost:8080/base/1"
argument_list|)
argument_list|)
expr_stmt|;
name|executor
...
name|doneSignal
argument_list|,
literal|"http://localhost:8080/base/2"
argument_list|)
argument_list|)
expr_stmt|;
name|executor
...
name|doneSignal
argument_list|,
literal|"http://localhost:8080/base/3"
argument_list|)
argument_list|)
expr_stmt|;
name|executor
...
name|doneSignal
argument_list|,
literal|"http://localhost:8080/base/4"
argument_list|)
argument_list|)
expr_stmt|;
name|executor
...
name|doneSignal
argument_list|,
literal|"http://localhost:8080/base/5"
argument_list|)
argument_list|)
expr_stmt|;
name|startSignal
...
specifier|public
name|void
name|testDefaultJsonProviderCloned
parameter_list|()
block|{
name|ProviderFactory
name|pf
