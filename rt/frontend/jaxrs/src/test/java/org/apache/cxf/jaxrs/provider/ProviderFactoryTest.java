...
argument_list|()
decl_stmt|;
name|doTestDefaultJaxbProviderCloned
argument_list|(
name|pf
argument_list|,
literal|"http://localhost:8080/base/"
argument_list|)
expr_stmt|;
name|checkJaxbProvider
argument_list|(
name|pf
argument_list|)
expr_stmt|;
...
specifier|public
name|void
name|testDefaultJaxbProviderMultipleThreads
parameter_list|()
throws|throws
name|Exception
block|{
...
control|)
block|{
name|doTestDefaultJaxbProviderClonedMultipleThreads
argument_list|()
expr_stmt|;
block|}
block|}
...
specifier|public
name|void
name|testNotFoundExceptionMapper
parameter_list|()
throws|throws
name|Exception
block|{
...
specifier|public
name|void
name|testServerErrorExceptionMapper
parameter_list|()
throws|throws
name|Exception
block|{
...
argument_list|)
decl_stmt|;
name|ServerErrorExceptionMapper
name|nf
init|=
operator|new
name|ServerErrorExceptionMapper
...
argument_list|)
expr_stmt|;
name|InternalServerErrorExceptionMapper
name|is
init|=
operator|new
name|InternalServerErrorExceptionMapper
