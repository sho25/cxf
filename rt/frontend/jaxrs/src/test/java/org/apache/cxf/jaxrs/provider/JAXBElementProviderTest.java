...
specifier|public
name|void
name|testGenericsAndSingleContext
parameter_list|()
throws|throws
name|Exception
block|{
...
specifier|public
name|void
name|testGenericsAndSingleContext2
parameter_list|()
throws|throws
name|Exception
block|{
...
specifier|public
name|void
name|testWriteCollectionWithCustomPrefixes
parameter_list|()
throws|throws
name|Exception
block|{
...
specifier|public
name|void
name|testObjectFactoryExtraClass
parameter_list|()
throws|throws
name|Exception
block|{
...
argument_list|)
expr_stmt|;
name|doTestObjectFactoryExtraClass
argument_list|(
name|provider
argument_list|)
expr_stmt|;
...
specifier|public
name|void
name|testObjectFactoryExtraClass2
parameter_list|()
throws|throws
name|Exception
block|{
...
name|xml
init|=
literal|"<param xmlns=\"http://jaxbelement/10\">"
operator|+
literal|"<filter name=\"foo\"/><comment>a</comment></param>"
decl_stmt|;
name|JAXBElementProvider
argument_list|<
name|ParamJAXBElement
...
specifier|public
name|void
name|testSetSchemasFromAnnotation
parameter_list|()
block|{
name|JAXBElementProvider
argument_list|<
