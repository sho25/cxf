...
specifier|public
name|void
name|testQueryParametersIntegerArrayValueIsColection
parameter_list|()
throws|throws
name|Exception
block|{
...
argument_list|(
operator|new
name|MyTypeParamConverterProvider
argument_list|()
argument_list|)
expr_stmt|;
name|messageImpl
...
specifier|public
name|void
name|testQueryParameterDefaultValue
parameter_list|()
throws|throws
name|Exception
block|{
...
name|getMethod
argument_list|(
literal|"testGenericObjectParamDefaultValue"
argument_list|,
name|argType
argument_list|)
decl_stmt|;
