...
specifier|static
class|class
name|SyntheticHelloInterfaceImpl
extends|extends
name|AbstractSyntheticHello
implements|implements
name|SyntheticHelloInterface
...
specifier|public
name|void
name|testClassResourceInfoWithSyntheticMethod
parameter_list|()
throws|throws
name|Exception
block|{
...
name|assertEquals
argument_list|(
literal|"there must be only one method, which is the getById(String)"
argument_list|,
literal|1
argument_list|,
name|cri
...
name|Path
argument_list|(
literal|"overridden-string"
argument_list|)
specifier|protected
interface|interface
name|OverriddenInterfaceString
extends|extends
name|OverriddenInterface
argument_list|<
name|String
...
specifier|public
name|void
name|testClassResourceInfoWithOverriddenMethods
parameter_list|()
throws|throws
name|Exception
block|{
...
name|assertEquals
argument_list|(
literal|"there must be one read method"
argument_list|,
literal|1
argument_list|,
name|oris
