...
argument_list|()
decl_stmt|;
comment|// strip comments out, as xmlbeans doesn't
comment|// seem to like them
do|do
block|{
if|if
condition|(
...
condition|)
block|{
comment|// need to check return type and throw exception
comment|// if wrong type
name|Scriptable
name|s
init|=
operator|(
