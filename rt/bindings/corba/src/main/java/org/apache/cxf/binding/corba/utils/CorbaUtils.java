...
name|names
init|=
name|namingServiceStringToNameComponents
argument_list|(
name|path
argument_list|)
decl_stmt|;
comment|// (re)bind the object into the Naming Service
comment|//
try|try
block|{
name|namingService
...
return|;
block|}
comment|// Split the string into NameComponents, delimited by '/'
comment|//
name|StringTokenizer
name|components
init|=
...
return|;
block|}
comment|// Allocate space for the result
comment|//
name|NameComponent
index|[]
name|result
...
return|;
block|}
comment|// Iterate over all the components, splitting each into
comment|// its "id" and "kind" fields, and copying into "result".
comment|//
name|int
name|count
init|=
