...
specifier|public
name|void
name|testUsingReadDocElementsData0
parameter_list|()
throws|throws
name|Exception
block|{
name|testUsingReadDocElements
argument_list|(
literal|0
argument_list|)
expr_stmt|;
...
specifier|public
name|void
name|testUsingReadDocElementsData1
parameter_list|()
throws|throws
name|Exception
block|{
...
specifier|public
name|void
name|testUsingReadDocElementsData2
parameter_list|()
throws|throws
name|Exception
block|{
...
argument_list|()
decl_stmt|;
comment|//System.out.println("UsingReadDocElements: " + result);
name|assertEquals
argument_list|(
name|DATA
index|[
