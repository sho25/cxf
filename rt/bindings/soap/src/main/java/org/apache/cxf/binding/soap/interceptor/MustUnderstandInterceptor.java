...
condition|)
block|{
comment|//The default here really should be to make o = "" and process
comment|//so any mustUnderstands are kill immediately. That will break
comment|//existing apps though.  Thus, it's a migration issue.
return|return;
block|}
name|Collection
argument_list|<
