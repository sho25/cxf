...
specifier|final
name|String
name|ADDITIONAL_ENVELOPE_BODY_NS
init|=
literal|"additional.env.body.ns"
decl_stmt|;
comment|/**      *       */
specifier|public
specifier|static
...
name|processor
operator|.
name|getEnvelopeAndBodyNamespaces
argument_list|()
argument_list|)
expr_stmt|;
block|}
...
name|event
decl_stmt|;
comment|//just put in the map, in case of duplicates in env and body,
comment|//body one will always come afterwards, so we're fine
name|namespaces
operator|.
name|put
argument_list|(
