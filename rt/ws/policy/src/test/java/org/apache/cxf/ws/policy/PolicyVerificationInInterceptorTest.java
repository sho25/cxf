...
specifier|public
class|class
name|PolicyVerificationInInterceptorTest
extends|extends
name|Assert
block|{
specifier|private
...
argument_list|()
expr_stmt|;
comment|/*         control.reset();         setupMessage(true, true, true, true);         EasyMock.expect(message.get(Message.PARTIAL_RESPONSE_MESSAGE)).andReturn(Boolean.TRUE);         control.replay();         interceptor.handleMessage(message);         control.verify();         */
block|}
annotation|@
name|Test
specifier|public
