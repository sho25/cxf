...
parameter_list|)
block|{
comment|//REVISIT not sure if this class-based comparison works in general as the fault class defined
comment|// in the service interface has no direct relationship to the message body's type.
name|MessagePartInfo
name|fmpi
init|=
name|fi
