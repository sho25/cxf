...
specifier|public
name|void
name|testAcknowledgeLastMessageNumberExceeded
parameter_list|()
throws|throws
name|SequenceFault
block|{
...
specifier|public
name|void
name|testAllPredecessorsAcknowledged
parameter_list|()
block|{
name|SequenceAcknowledgement
name|ack
...
name|assertTrue
argument_list|(
literal|"all predecessors acknowledged"
argument_list|,
operator|!
name|ds
operator|.
...
name|assertTrue
argument_list|(
literal|"not all predecessors acknowledged"
argument_list|,
name|ds
operator|.
name|allPredecessorsAcknowledged
