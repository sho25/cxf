...
specifier|public
name|void
name|testCreateSequenceStoreOutboundMessage
parameter_list|()
throws|throws
name|SQLException
throws|,
...
argument_list|)
expr_stmt|;
comment|// set the last message flag
name|EasyMock
operator|.
name|expect
argument_list|(
...
argument_list|)
expr_stmt|;
comment|// verify the updated sequence
name|seqs
operator|=
name|store
operator|.
...
specifier|public
name|void
name|testCreateSequenceStoreInboundMessage
parameter_list|()
throws|throws
name|SQLException
throws|,
