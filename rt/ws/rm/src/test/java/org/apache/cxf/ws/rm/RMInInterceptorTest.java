...
specifier|public
name|void
name|testProcessInvalidMessage
parameter_list|()
throws|throws
name|SequenceFault
throws|,
...
name|fail
argument_list|(
literal|"must reject the invalid rm message"
argument_list|)
expr_stmt|;
block|}
catch|catch
...
specifier|public
name|void
name|testProcessInvalidMessageOnFault
parameter_list|()
throws|throws
name|SequenceFault
throws|,
...
name|fail
argument_list|(
literal|"unexpected exception thrown from handleFault: "
operator|+
name|e
argument_list|)
expr_stmt|;
...
specifier|public
name|void
name|testProcessValidMessageOnFault
parameter_list|()
throws|throws
name|SequenceFault
throws|,
...
argument_list|)
expr_stmt|;
comment|// test 1. a normal sequence fault case without non-anonymous faultTo
name|EasyMock
operator|.
name|expect
argument_list|(
...
argument_list|()
expr_stmt|;
comment|// 2. a sequence fault case with non anonymous faultTo
name|control
operator|.
name|reset
argument_list|()
...
argument_list|()
expr_stmt|;
comment|// 3. a robust oneway case
name|control
operator|.
name|reset
argument_list|()
...
expr_stmt|;
block|}
comment|// 4. a runtime exception case
name|control
operator|.
name|reset
argument_list|()
