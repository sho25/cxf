...
name|getDeclaredMethod
argument_list|(
literal|"getEffectiveConfiguration"
argument_list|,
operator|new
name|Class
index|[]
...
specifier|public
name|void
name|testRecoverReliableClientEndpointWithAttachment
parameter_list|()
throws|throws
name|NoSuchMethodException
throws|,
...
argument_list|(
literal|"persistence/SerializedRMMessage.txt"
argument_list|)
decl_stmt|;
name|CachedOutputStream
name|cos
...
argument_list|()
decl_stmt|;
name|setUpRecoverReliableEndpointWithAttachment
argument_list|(
name|endpoint
argument_list|,
name|conduit
...
block|}
block|}
comment|// just read the begining of the input and compare it against the specified string
specifier|private
specifier|static
name|boolean
name|assertStartsWith
