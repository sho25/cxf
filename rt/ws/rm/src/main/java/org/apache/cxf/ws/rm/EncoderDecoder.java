...
return|;
block|}
comment|/**      * Get the SOAP Header element from a message document.      *       * @param doc      * @return header      * @throws JAXBException if not found      */
specifier|protected
name|Element
name|getSoapHeader
parameter_list|(
...
return|;
block|}
comment|/**      * Inserts a Header element containing a WS-RM Fault into a SOAP message.      *       * @param sf      * @param qname constructed element name      * @param doc      */
specifier|public
name|void
name|insertHeaderFault
parameter_list|(
name|SequenceFault
name|sf
parameter_list|,
