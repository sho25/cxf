...
begin_comment
comment|/**  * Policy loader for WS-I RSP assertion. This provides the hooks for Neethi to handle the assertion.  */
end_comment
...
comment|// that point. If nothing uses WS-I RSP no warnings/errors will display
block|}
block|}
specifier|public
name|void
