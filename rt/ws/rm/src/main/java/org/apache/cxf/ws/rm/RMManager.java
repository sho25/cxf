...
return|;
block|}
comment|/**      * Get the WS-Addressing namespace being used for a message. If the WS-Addressing namespace has not been      * set, this returns the default from the supplied configuration.      *       * @param config      * @param message      * @return namespace URI      */
name|String
name|getAddressingNamespace
parameter_list|(
name|RMConfiguration
...
return|;
block|}
comment|/**      * Get the WS-Addressing namespace being used for a message. If the WS-Addressing namespace has not been set, this      * returns the best default.      *       * @param message      * @return namespace URI      */
specifier|public
name|String
name|getAddressingNamespace
parameter_list|(
...
parameter_list|)
block|{
comment|// only happens with invalid namespace combination, just fall back to manager default
name|config
operator|=
name|getConfiguration
argument_list|()
...
return|;
block|}
comment|/**      * Get the WS-RM namespace being used for a message. If the WS-RM namespace has not been set, this returns the      * default from the supplied configuration.      *       * @param config      * @param message      * @return namespace URI      */
name|String
name|getRMNamespace
parameter_list|(
name|RMConfiguration
...
return|;
block|}
comment|/**      * Get the WS-RM namespace being used for a message. If the WS-RM namespace has not been set, this returns the best      * default.      *       * @param message      * @return namespace URI      */
name|String
name|getRMNamespace
parameter_list|(
name|Message
