...
specifier|final
name|String
name|WSRM10_WSA_VERSION_PROPERTY
init|=
...
return|;
block|}
comment|/**      * Get the WS-Addressing namespace being used for a message. If the WS-Addressing namespace has not been      * set, this returns the default configured for this manager.      *       * @param message      * @return namespace URI      */
name|String
name|getAddressingNamespace
parameter_list|(
name|Message
...
return|;
block|}
comment|/**      * Get the WS-RM namespace being used for a message. If the WS-RM namespace has not been set, this returns      * the default configured for this manager.      *       * @param message      * @return namespace URI      */
name|String
name|getRMNamespace
parameter_list|(
name|Message
...
name|FINE
argument_list|,
literal|"Shutting down RMManager with {0} remaining endpoints for protocol variation {1}."
argument_list|,
operator|new
name|Object
index|[]
