...
begin_comment
comment|/**  * Holder for names for WS-ReliableMessaging 1.1.  */
end_comment
...
specifier|final
name|QName
name|TERMINATE_SEQUENCE_RESPONSE_QNAME
init|=
operator|new
name|QName
argument_list|(
name|NAMESPACE_URI
argument_list|,
literal|"TerminateSequenceResponse"
argument_list|)
decl_stmt|;
specifier|public
specifier|static
...
specifier|final
name|String
name|TERMINATE_SEQUENCE_RESPONSE_ACTION
init|=
name|NAMESPACE_URI
operator|+
literal|"/TerminateSequenceResponse"
...
specifier|final
name|QName
name|SEQUENCE_CLOSED_FAULT_QNAME
init|=
operator|new
name|QName
argument_list|(
...
specifier|final
name|QName
name|WSRM_REQUIRED_FAULT_QNAME
init|=
operator|new
name|QName
argument_list|(
