...
specifier|final
name|String
name|CREATE_ENDPOINTS_TABLE_STMT
init|=
literal|"CREATE TABLE CXF_ENDPOINTS "
operator|+
literal|"(QNAME_URI VARCHAR(1024), "
operator|+
literal|"QNAME_LOCAL VARCHAR(1024), "
operator|+
literal|"ENDPOINT_ID VARCHAR(1024), "
operator|+
literal|"WSRM_URI VARCHAR(256) NOT NULL, "
operator|+
literal|"WSA_URI VARCHAR(256) NOT NULL, "
operator|+
literal|"PRIMARY KEY (QNAME_URI, QNAME_LOCAL))"
decl_stmt|;
specifier|private
specifier|static
specifier|final
...
specifier|private
name|PreparedStatement
name|selectDestSequenceStmt
decl_stmt|;
specifier|private
name|PreparedStatement
name|selectSrcSequenceStmt
decl_stmt|;
specifier|private
name|PreparedStatement
...
name|fine
argument_list|(
literal|"Table CXF_ENDPOINTS already exists."
argument_list|)
expr_stmt|;
block|}
block|}
