...
specifier|final
name|String
name|INBOUND_ATTS_TABLE_NAME
init|=
literal|"CXF_RM_INBOUND_ATTACHMENTS"
decl_stmt|;
specifier|private
specifier|static
specifier|final
name|String
name|OUTBOUND_ATTS_TABLE_NAME
init|=
literal|"CXF_RM_OUTBOUND_ATTACHMENTS"
decl_stmt|;
specifier|private
specifier|static
specifier|final
...
specifier|final
name|String
name|CREATE_ATTACHMENTS_TABLE_STMT
init|=
name|buildCreateTableStatement
argument_list|(
literal|"{0}"
...
specifier|final
name|String
name|CREATE_ATTACHMENT_STMT_STR
init|=
literal|"INSERT INTO {0} (SEQ_ID, MSG_NO, ATTACHMENT_NO, DATA) VALUES(?, ?, ?, ?)"
decl_stmt|;
specifier|private
specifier|static
specifier|final
name|String
name|DELETE_ATTACHMENTS_STMT_STR
init|=
literal|"DELETE FROM {0} WHERE SEQ_ID = ? AND MSG_NO = ?"
decl_stmt|;
specifier|private
...
specifier|final
name|String
name|SELECT_ATTACHMENTS_STMT_STR
init|=
literal|"SELECT ATTACHMENT_NO, DATA FROM {0} WHERE SEQ_ID = ? AND MSG_NO = ?"
decl_stmt|;
specifier|private
specifier|static
specifier|final
...
specifier|final
name|String
name|CREATE_INBOUND_ATTACHMENT_STMT_STR
init|=
name|MessageFormat
operator|.
name|format
...
specifier|final
name|String
name|CREATE_OUTBOUND_ATTACHMENT_STMT_STR
init|=
name|MessageFormat
operator|.
name|format
...
specifier|final
name|String
name|DELETE_INBOUND_ATTACHMENTS_STMT_STR
init|=
name|MessageFormat
operator|.
name|format
...
specifier|final
name|String
name|DELETE_OUTBOUND_ATTACHMENTS_STMT_STR
init|=
name|MessageFormat
operator|.
name|format
...
specifier|final
name|String
name|SELECT_INBOUND_ATTACHMENTS_STMT_STR
init|=
name|MessageFormat
operator|.
name|format
...
specifier|final
name|String
name|SELECT_OUTBOUND_ATTACHMENTS_STMT_STR
init|=
name|MessageFormat
operator|.
name|format
...
name|FINE
argument_list|,
literal|"Successfully stored {0} attachment {1} for message number {2} in sequence {3}"
argument_list|,
operator|new
name|Object
index|[]
