...
argument_list|)
decl_stmt|;
comment|// special check for closing RM 1.0 sequence with no application message
comment|//  need to generate Sequence header for the LastMessage element anyway, in this case
name|boolean
name|close10
init|=
name|isLastMessage
