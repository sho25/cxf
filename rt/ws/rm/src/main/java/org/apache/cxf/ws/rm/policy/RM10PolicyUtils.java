...
expr_stmt|;
block|}
comment|//REVISIT this class shouldn't be picking RMP200702 assertions (see below)
name|ais
operator|=
name|aim
operator|.
...
control|)
block|{
comment|//REVISIT this class can't handle RMP200702 assertions, so guard against CCE
if|if
condition|(
name|ai
operator|.
...
name|warning
argument_list|(
literal|"Ignoring unexpected assertion class: "
operator|+
name|ai
operator|.
name|getAssertion
