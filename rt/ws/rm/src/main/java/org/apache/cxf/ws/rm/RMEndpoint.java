...
return|;
block|}
comment|/**      * Set the protocol used by this endpoint. This method is only intended for use in testing; all normal use      * uses the constructor to set the value.      *       * @param protocol      */
specifier|public
name|void
name|setProtocol
parameter_list|(
