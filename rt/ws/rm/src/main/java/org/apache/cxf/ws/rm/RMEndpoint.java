...
return|;
block|}
comment|/**      * Get the encoder/decoder used by this endpoint.      *       * @return URI      */
specifier|public
name|EncoderDecoder
...
return|;
block|}
comment|/**      * Set the encoder/decoder used by this endpoint. This should only be used if the encoder/decoder was not      * set by the constructor, and only used once in that case - once set the encoder/decoder should never be      * changed.      *       * @param codec      */
specifier|public
name|void
