...
name|println
argument_list|(
literal|"encrypt before sign, not yet"
argument_list|)
expr_stmt|;
block|}
else|else
...
condition|)
block|{
comment|//sigTokId = getSecConvTokenId();
block|}
elseif|else
if|if
condition|(
...
condition|)
block|{
comment|//sigTokId = getIssuedSignatureTokenId();
block|}
elseif|else
if|if
condition|(
