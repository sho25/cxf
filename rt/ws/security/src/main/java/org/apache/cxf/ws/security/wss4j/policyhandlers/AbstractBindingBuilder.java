...
block|}
block|}
comment|/**      * Create a SecurityTokenReference to point to a SAML Assertion      * @param assertion the SAML AssertionWrapper      * @param useDirectReferenceToAssertion whether to refer directly to the assertion or not      * @return a SecurityTokenReference to a SAML Assertion      */
specifier|private
name|SecurityTokenReference
name|createSTRForSamlAssertion
parameter_list|(
