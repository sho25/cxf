...
control|)
block|{
comment|//WSSecurityEngineResult wser =
comment|//        (WSSecurityEngineResult) wsSecEngineResults.get(j);
comment|//Integer actInt = (Integer)wser.get(WSSecurityEngineResult.TAG_ACTION);
comment|//how to find if it's due to an IssuedToken?
name|found
operator|=
literal|true
expr_stmt|;
