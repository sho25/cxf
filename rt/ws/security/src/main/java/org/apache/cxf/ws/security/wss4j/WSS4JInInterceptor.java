...
expr_stmt|;
block|}
comment|// Now check SAML SenderVouches + Holder Of Key requirements
name|boolean
...
condition|)
block|{
comment|// Don't try to parse a Principal for the Decryption case
continue|continue;
block|}
specifier|final
name|Principal
...
literal|null
operator|&&
name|isSecurityContextPrincipal
argument_list|(
name|p
argument_list|,
name|wsResult
...
block|}
block|}
comment|/**      * Checks if a given WSS4J Principal can be represented as a user principal      * inside SecurityContext. Example, UsernameToken or PublicKey principals can      * be used to facilitate checking the user roles, etc.      */
specifier|protected
name|boolean
name|isSecurityContextPrincipal
parameter_list|(
