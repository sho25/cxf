...
name|add
argument_list|(
name|doSecureConversationSignature
argument_list|(
name|token
argument_list|,
literal|null
...
argument_list|)
expr_stmt|;
comment|/*             if (isTokenProtection()&& !(SPConstants.IncludeTokenType.INCLUDE_TOKEN_NEVER == token.getInclusion())) {                 sigParts.add(new WSEncryptionPart(sig.getBSTTokenId()));             }             */
name|sig
operator|.
name|addReferencesToSign
argument_list|(
