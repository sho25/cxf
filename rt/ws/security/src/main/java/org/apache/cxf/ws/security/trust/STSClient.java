...
argument_list|)
expr_stmt|;
comment|/*             //REVISIT - KeyValueToken support - how to get the key?             RSAPublicKey key = getPublicKey();                          RSAKeyValue value = new RSAKeyValue(writer.getDocument(), key);             StaxUtils.copy(value.getElement(), writer);             */
name|writer
operator|.
name|writeEndElement
argument_list|()
