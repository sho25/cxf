...
condition|)
block|{
comment|//TODO: get the token out of it.  Need to find an STS that actually
comment|//suports this first to test it
block|}
name|el
operator|=
name|DOMUtils
...
argument_list|)
expr_stmt|;
comment|// Unlikely to ever be otherwise, but still prudent to check.
if|if
condition|(
name|actAsEl
operator|.
