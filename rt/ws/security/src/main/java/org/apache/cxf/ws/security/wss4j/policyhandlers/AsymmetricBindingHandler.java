...
condition|)
block|{
comment|// Special flag telling WSS4J to sign the initiator token.
comment|// Use this instead of the BST ID so that we don't
comment|// have to deal with maintaining such logic here.
name|sigParts
operator|.
name|add
argument_list|(
