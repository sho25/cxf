...
expr_stmt|;
block|}
comment|/*     public WSS4JStaxOutInterceptor(Map<String, Object> props) {         this();         setProperties(props);     }     */
specifier|public
name|boolean
name|isAllowMTOM
parameter_list|()
...
expr_stmt|;
block|}
comment|/*     private OutboundWSSec createOutSecurityContext(Message message) {         WSSSecurityProperties properties = new WSSSecurityProperties();                  OutboundWSSec wssec = new OutboundWSSec(properties);                  return wssec;     }     */
specifier|public
specifier|final
name|WSS4JStaxOutInterceptorInternal
name|createEndingInterceptor
