...
begin_comment
comment|/**  * Validate a SignedEndorsingEncryptedSupportingToken policy.  */
end_comment
...
parameter_list|)
block|{
comment|// Tokens must be encrypted even if TLS is used unless we have a TransportBinding policy available
if|if
condition|(
name|isTLSInUse
argument_list|(
...
name|setNotAsserted
argument_list|(
literal|"The received token does not match the signed endorsing encrypted "
operator|+
