...
condition|)
block|{
comment|//no keys were needed for anything
return|return;
block|}
if|if
condition|(
...
condition|)
block|{
comment|//for a TransportBinding, these won't come back in the response
name|assertPolicy
argument_list|(
name|aim
argument_list|,
...
decl_stmt|;
comment|//
comment|// Prefetch all signature results
comment|//
name|List
argument_list|<
name|WSSecurityEngineResult
...
block|{
comment|// TODO need to revisit all of the other endorsed policies
name|EndorsingTokenPolicyValidator
