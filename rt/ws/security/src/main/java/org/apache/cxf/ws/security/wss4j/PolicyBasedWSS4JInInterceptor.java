...
block|}
block|}
comment|/**      * Translate a CXF AlgorithmSuite object into WSS4J's AlgorithmSuite object      */
specifier|private
name|AlgorithmSuite
name|translateAlgorithmSuite
parameter_list|(
...
name|algorithmSuite
operator|.
name|setEncryptionDerivedKeyLength
argument_list|(
name|cxfAlgorithmSuite
operator|.
...
name|algorithmSuite
operator|.
name|setSignatureDerivedKeyLength
argument_list|(
name|cxfAlgorithmSuite
operator|.
...
return|;
block|}
comment|/**      * Get the WS-SecurityPolicy Binding that is in operation      */
specifier|private
name|Binding
name|getBinding
parameter_list|(
