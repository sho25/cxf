...
name|WSS4JUtils
block|{
comment|// FAULT error messages
specifier|public
specifier|static
specifier|final
name|String
name|UNSUPPORTED_TOKEN_ERR
init|=
literal|"An unsupported token was provided"
decl_stmt|;
specifier|public
specifier|static
specifier|final
name|String
name|UNSUPPORTED_ALGORITHM_ERR
init|=
literal|"An unsupported signature or encryption algorithm was used"
decl_stmt|;
specifier|public
specifier|static
specifier|final
...
specifier|final
name|String
name|INVALID_SECURITY_TOKEN_ERR
init|=
literal|"An invalid security token was provided"
decl_stmt|;
specifier|public
specifier|static
specifier|final
name|String
name|FAILED_AUTHENTICATION_ERR
init|=
...
specifier|final
name|String
name|SECURITY_TOKEN_UNAVAILABLE_ERR
init|=
...
return|;
block|}
comment|/**      * Map a WSSecurityException FaultCode to a standard error String, so as not to leak      * internal configuration to an attacker.      */
specifier|public
specifier|static
name|String
...
parameter_list|)
block|{
comment|// Allow a Replay Attack message to be returned, otherwise it could be confusing
comment|// for clients who don't understand the default caching functionality of WSS4J/CXF
if|if
condition|(
name|ex
operator|.
