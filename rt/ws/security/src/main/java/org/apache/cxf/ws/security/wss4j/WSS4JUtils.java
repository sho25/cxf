...
comment|// complete
block|}
comment|/**      * Get the security token lifetime value (in milliseconds). The default is "300000" (5 minutes).      * @return the security token lifetime value in milliseconds      */
specifier|public
specifier|static
name|long
