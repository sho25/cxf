...
begin_comment
comment|/**  * A WSS4J-based Validator to validate a received WS-Security credential by dispatching  * it to a STS via WS-Trust. The default binding is "validate", but "issue" using "OnBehalfOf"  * is also possible by setting the "useIssueBinding" property.  */
end_comment
