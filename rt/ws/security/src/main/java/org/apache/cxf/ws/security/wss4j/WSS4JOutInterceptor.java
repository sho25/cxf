...
expr_stmt|;
block|}
comment|// If a custom Id has been set, then change the Id for the internal interceptor as well, as otherwise
comment|// we can't add two WSS4JOutInterceptor instances to the interceptor chain.
if|if
condition|(
operator|!
name|WSS4JOutInterceptor
...
argument_list|)
expr_stmt|;
comment|// Enable XOP Include unless the user has explicitly configured it
if|if
condition|(
name|getString
argument_list|(
