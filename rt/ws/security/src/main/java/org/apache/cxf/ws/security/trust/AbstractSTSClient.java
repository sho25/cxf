...
return|;
block|}
comment|/**      * Get some custom Element to be inserted into the RequestSecurityToken      */
specifier|public
name|Element
name|getCustomContent
parameter_list|()
...
condition|)
block|{
comment|// We can also support a CallbackHandler her as per getDelegationSecurityToken if required
specifier|final
name|boolean
name|isString
init|=
...
expr_stmt|;
block|}
comment|// Default to Bearer KeyType
name|String
name|keyTypeTemplate
init|=
name|keyType
...
name|fine
argument_list|(
literal|"No ID extracted from token, so just making one up"
argument_list|)
expr_stmt|;
name|id
operator|=
