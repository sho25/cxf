...
begin_comment
comment|/**  * In these test-cases, the client is using DOM and the service is using StaX. The tests are  * for different Encryption Key Identifier methods.  */
end_comment

begin_class
specifier|public
class|class
name|DOMToStaxEncryptionIdentifierTest
extends|extends
