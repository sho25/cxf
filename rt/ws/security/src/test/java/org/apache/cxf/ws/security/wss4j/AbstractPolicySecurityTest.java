...
comment|/*          * dumpDocument(inDoc);          */
comment|/* This verifies of the header elements have been          * wrapped in an EncryptedHeader          * See SOAP Message Security 1.1, chapter 9.3          */
name|verifyEncryptedHeader
argument_list|(
name|originalDoc
argument_list|,
name|inDoc
...
argument_list|)
expr_stmt|;
comment|// Find EncryptedData in the message, should not be there
specifier|final
name|XPathExpression
name|strData
init|=
...
name|compile
argument_list|(
literal|"/s:Envelope/s:Header/xenc:EncryptedData"
argument_list|)
decl_stmt|;
specifier|final
name|NodeList
...
name|assertEquals
argument_list|(
literal|"EncryptedData found without in header without being wrapped in an EncryptedHeader."
argument_list|,
literal|0
argument_list|,
name|strDataNodes
