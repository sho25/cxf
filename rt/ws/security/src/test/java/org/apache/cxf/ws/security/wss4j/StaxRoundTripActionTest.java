...
begin_comment
comment|/**  * Test StaX Security actions on the inbound side  */
end_comment

begin_class
specifier|public
class|class
name|StaxRoundTripActionTest
extends|extends
...
name|fail
argument_list|(
literal|"Failure expected on the wrong action"
argument_list|)
expr_stmt|;
block|}
catch|catch
