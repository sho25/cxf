...
block|}
comment|/**      * {@inheritDoc}      */
comment|// Synchronization can not be avoided at the moment as
comment|// the file position is continuously changed.
comment|// Realistically, the log files will probably be viewed
comment|// by the admin so it's not a problem. However the memory mapping can
comment|// help in making it more flexible
specifier|public
