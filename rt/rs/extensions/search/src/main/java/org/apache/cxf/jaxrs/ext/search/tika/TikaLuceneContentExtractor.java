...
return|;
block|}
comment|/**      * Extract the content and metadata from the input stream using DocumentMetadata descriptor to      * create a document with strongly typed fields. Depending on media type validation,      * the detector could be run against input stream in order to ensure that parser supports this      * type of content.       * @param in input stream to extract the content and metadata from        * @param metadata document descriptor with field names and their types      * @return the extracted document or null if extraction is not possible or was unsuccessful      */
specifier|public
name|Document
name|extract
parameter_list|(
