...
return|;
block|}
comment|/**      * Extract the content and metadata from the file. Depending on media type validation,      * the detector could be run against file content in order to ensure that parser supports this      * type of content.       * @param file file to extract the content and metadata from        * @return the extracted document or null if extraction is not possible or was unsuccessful      */
specifier|public
name|Document
name|extract
parameter_list|(
