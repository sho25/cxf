...
parameter_list|)
function_decl|;
comment|/**      * Returns the typed search condition representing      * the search expression which is extracted from      * the request URI      *      * @param cls the type of the bean(s) the new search condition will      *        attempt to match      * @param beanProperties mapping between search and bean properties      * @param parserProperties parser properties      * @return the search condition      */
parameter_list|<
name|T
parameter_list|>
name|SearchCondition
...
parameter_list|)
function_decl|;
comment|/**      * Returns the typed search condition representing      * the provided search expression      *      * @param expression the search expression      * @param cls the type of the bean(s) the new search condition will      *        attempt to match      * @param beanProperties mapping between search and bean properties      * @param parserProperties parser properties      * @return the search condition      */
parameter_list|<
name|T
parameter_list|>
name|SearchCondition
