...
name|jettison
operator|.
name|JSONSequenceTooLargeException
import|;
end_import
...
specifier|final
name|String
name|DROP_ROOT_CONTEXT_PROPERTY
init|=
...
specifier|final
name|String
name|ARRAY_KEYS_PROPERTY
init|=
literal|"json.array.keys"
decl_stmt|;
specifier|private
specifier|static
specifier|final
...
init|=
literal|"json.root.is.array"
decl_stmt|;
specifier|private
specifier|static
specifier|final
name|String
name|DROP_ELEMENT_IN_XML_PROPERTY
init|=
literal|"drop.xml.elements"
decl_stmt|;
specifier|private
specifier|static
specifier|final
name|String
name|IGNORE_EMPTY_JSON_ARRAY_VALUES_PROPERTY
init|=
literal|"ignore.empty.json.array.values"
decl_stmt|;
static|static
block|{
operator|new
...
specifier|private
name|boolean
name|writeNullAsString
init|=
literal|true
decl_stmt|;
specifier|private
name|boolean
name|escapeForwardSlashesAlways
decl_stmt|;
annotation|@
name|Override
specifier|public
...
block|}
name|boolean
name|dropElementsInXmlStreamProp
init|=
...
name|config
operator|.
name|setEscapeForwardSlashAlways
argument_list|(
name|escapeForwardSlashesAlways
argument_list|)
expr_stmt|;
