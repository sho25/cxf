...
specifier|public
name|void
name|testDoNotEscapeForwardSlashes
parameter_list|()
throws|throws
name|Exception
block|{
...
specifier|public
name|void
name|testEscapeForwardSlashesAlways
parameter_list|()
throws|throws
name|Exception
block|{
...
name|provider
operator|.
name|setEscapeForwardSlashesAlways
argument_list|(
literal|true
argument_list|)
expr_stmt|;
...
name|Exception
block|{
name|doTestReadFromQualifiedTag
argument_list|(
literal|"."
argument_list|)
expr_stmt|;
...
specifier|public
name|void
name|testReadFromQualifiedTagCustomNsSep
parameter_list|()
throws|throws
name|Exception
block|{
...
specifier|public
name|void
name|testIgnoreNamespacesPackageInfo
parameter_list|()
throws|throws
name|Exception
block|{
...
name|assertEquals
argument_list|(
literal|"{\"thebook2\":{\"id\":123,\"name\":\"CXF\"}}"
argument_list|,
name|s
argument_list|)
expr_stmt|;
...
specifier|public
name|void
name|testIgnoreNamespacesPackageInfo2
parameter_list|()
throws|throws
name|Exception
block|{
...
name|Exception
block|{
name|doTestWriteToSingleQualifiedTag
argument_list|(
literal|"."
argument_list|)
expr_stmt|;
...
specifier|public
name|void
name|testWriteToSingleQualifiedTagCustomNsSep
parameter_list|()
throws|throws
name|Exception
block|{
...
specifier|public
name|void
name|testWriteArrayWithStructuredArrayKeyName
parameter_list|()
throws|throws
name|Exception
block|{
...
specifier|public
name|void
name|testWriteArrayWithStructuredArrayKeyName2
parameter_list|()
throws|throws
name|Exception
block|{
...
name|contains
argument_list|(
literal|"\"beanblist\":[{\"name\":[\"beanbArray\"]}]"
argument_list|)
argument_list|)
expr_stmt|;
name|assertTrue
...
specifier|public
name|void
name|testWriteArrayWithStructuredArrayKeyNameDropRoot
parameter_list|()
throws|throws
name|Exception
block|{
...
specifier|public
name|void
name|testWriteArrayWithStructuredArrayKeyNameSingleBean
parameter_list|()
throws|throws
name|Exception
block|{
...
specifier|public
name|void
name|testAttributesAsElementsWithTransform
parameter_list|()
throws|throws
name|Exception
block|{
...
name|expected
init|=
literal|"{\"tagholder\":{\"attr\":\"attribute\",\"thetag\":{\"attrInt\":123,\"group\":\"B\",\"name\":\"A\"}}}"
decl_stmt|;
name|assertEquals
argument_list|(
name|expected
...
specifier|public
name|void
name|testAttributesAsElementsWithInteger
parameter_list|()
throws|throws
name|Exception
block|{
