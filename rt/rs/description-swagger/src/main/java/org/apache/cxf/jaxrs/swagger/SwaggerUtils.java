...
block|}
return|return
name|getUserResourceFromStream
argument_list|(
name|is
argument_list|)
return|;
...
name|UserResource
argument_list|>
name|getUserResourcesFromResourceObjects
parameter_list|(
name|List
argument_list|<
name|String
...
block|{
return|return
name|getUserResourceFromSwagger12
argument_list|(
name|map
argument_list|)
return|;
...
block|{
return|return
name|getUserResourceFromSwagger20
argument_list|(
name|map
argument_list|)
return|;
...
condition|)
block|{
comment|// relative resource and operation paths overlap in Swagger 1.2
name|operPath
operator|=
name|operPath
operator|.
...
argument_list|)
decl_stmt|;
comment|//"path", "query", "body", "header", "form"
name|String
name|paramType
init|=
operator|(
