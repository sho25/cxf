...
argument_list|()
decl_stmt|;
comment|// Right before 1.5.18, the entity was always a String but became a model object
comment|// (io.swagger.models.Swagger) after. For now, let us serialize it to JSON manually.
name|String
name|swaggerJson
init|=
name|entity
