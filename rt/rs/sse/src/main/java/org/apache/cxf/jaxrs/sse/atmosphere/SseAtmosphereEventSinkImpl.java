...
try|try
block|{
comment|// The resource's request property is null here, we have to
comment|// rely on initial request to understand what to close, response
comment|// or stream.
if|if
condition|(
name|usingStream
...
name|warning
argument_list|(
literal|"SSE Atmosphere response was not delivered"
argument_list|)
expr_stmt|;
name|future
operator|.
