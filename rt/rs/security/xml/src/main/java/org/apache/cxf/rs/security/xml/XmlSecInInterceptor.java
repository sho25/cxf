...
throw|;
block|}
comment|/*else if (XMLSecurityConstants.C14n.equals(event.getAlgorithmUsage())&& sigProps.getSignatureC14Method() != null&& !sigProps.getSignatureC14Method().equals(event.getAlgorithmURI())) {             throw new XMLSecurityException("empty", "The signature c14n algorithm "                 + event.getAlgorithmURI() + " is not allowed");         }*/
comment|// TODO Signature Digest Transform checking
block|}
specifier|private
name|void
name|checkSignatureTrust
