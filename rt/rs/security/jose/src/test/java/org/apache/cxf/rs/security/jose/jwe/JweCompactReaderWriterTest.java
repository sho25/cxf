...
name|EC_CURVE_P256
argument_list|,
literal|"0_NxaRPUMQoAJt50Gz8YiTr8gRTwyEaCumd-MToTmIo"
argument_list|)
decl_stmt|;
name|ECPublicKey
name|alicePublicKey
...
name|EC_CURVE_P256
argument_list|,
literal|"gI0GAILBdu7T53akrFmMyGcsF3n5dO7MmwNBHKW5SV0"
argument_list|,
literal|"SLW_xSffzlPWrHEVI30DHM_4egVwt3NQqeUD7nMFpps"
argument_list|)
decl_stmt|;
name|ECPublicKey
name|bobPublicKey
...
name|assertEquals
argument_list|(
literal|"VqqN6vgjbSBcIijNcacQGg"
argument_list|,
name|Base64UrlUtility
operator|.
name|encode
...
name|derivedKey2
init|=
name|calculateDerivedKeyFromHeaders
argument_list|(
name|headers
argument_list|,
name|headers
