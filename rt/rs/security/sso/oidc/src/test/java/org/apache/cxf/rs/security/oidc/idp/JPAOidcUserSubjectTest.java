...
argument_list|)
expr_stmt|;
comment|//        OidcUserSubject oidcSubject3 = new OidcUserSubject();
comment|//        oidcSubject3.setLogin("bob");
comment|//        IdToken idToken2 = new IdToken();
comment|//        idToken2.setAudience(c.getClientId());
comment|//        oidcSubject3.setIdToken(idToken2);
comment|//        atr.setSubject(oidcSubject3);
comment|//
comment|//        ServerAccessToken at3 = provider.createAccessToken(atr);
comment|//        ServerAccessToken at4 = provider.getAccessToken(at3.getTokenKey());
comment|//        OidcUserSubject oidcSubject4 = (OidcUserSubject)at4.getSubject();
comment|//        assertEquals(c.getClientId(), oidcSubject4.getIdToken().getAudience());
block|}
specifier|private
name|Client
name|addClient
