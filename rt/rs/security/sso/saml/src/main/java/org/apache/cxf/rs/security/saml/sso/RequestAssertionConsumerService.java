...
name|samlResponse
decl_stmt|;
comment|/*         // URL Decoding only applies for the re-direct binding         if (!postBinding) {             try {                 samlResponseDecoded = URLDecoder.decode(samlResponse, "UTF-8");             } catch (UnsupportedEncodingException e) {                 throw new BadRequestException();             }         }         */
name|InputStream
name|tokenStream
init|=
literal|null
