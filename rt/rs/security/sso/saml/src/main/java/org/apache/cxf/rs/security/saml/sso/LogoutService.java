...
comment|// optionally listing the user login name and/or linking to the main application address,
comment|// the user may click on it, will be redirected to IDP and the process will start again
return|return
operator|new
name|LogoutResponse
argument_list|(
