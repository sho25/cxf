...
name|assertTrue
argument_list|(
literal|"ID must start with a letter or underscore, and can only contain letters, digits, "
operator|+
literal|"underscores, hyphens, and periods."
argument_list|,
name|authnRequest
operator|.
name|getID
...
name|setNameValue
argument_list|(
literal|"uid=joe,ou=people,ou=saml-demo,o=example.com"
argument_list|)
expr_stmt|;
name|nameIdBean
operator|.
