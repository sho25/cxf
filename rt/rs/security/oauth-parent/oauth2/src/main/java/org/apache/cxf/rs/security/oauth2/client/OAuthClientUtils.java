...
block|}
block|}
comment|/**      * Creates OAuth Authorization header with Bearer scheme      * @param consumer represents the registered client      * @param accessToken the access token        * @return the header value      */
specifier|public
specifier|static
name|String
...
return|;
block|}
comment|/**      * Creates OAuth Authorization header with the scheme that      * may require an access to the current HTTP request properties      * @param consumer represents the registered client      * @param accessToken the access token        * @param httpProps http request properties, can be null for Bearer tokens      * @return the header value      */
specifier|public
specifier|static
name|String
name|createAuthorizationHeader
