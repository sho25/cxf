...
operator|||
operator|!
name|isConfidentialClientSecretValid
argument_list|(
name|client
argument_list|,
name|providedClientSecret
...
return|;
block|}
comment|/**      * Get the {@link Client} reference      * @param clientId The Client Id      * @param params request parameters      * @return Client the client reference       * @throws {@link javax.ws.rs.WebApplicationException} if no matching Client is found,       *         the error is returned directly to the end user without       *         following the redirect URI if any      */
specifier|protected
name|Client
name|getClient
parameter_list|(
