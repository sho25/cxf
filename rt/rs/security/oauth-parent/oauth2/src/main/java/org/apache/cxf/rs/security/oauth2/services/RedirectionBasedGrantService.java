...
parameter_list|)
block|{
comment|// at the moment the only option to map a subject login name
comment|// to an actual name is to extend this method, a mapper interface can be introduced too
block|}
