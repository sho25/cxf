...
argument_list|)
expr_stmt|;
comment|// Reporting scope is required if the approved scope is different and
comment|// optional - otherwise; lets always report it for now if it is non-empty
name|List
argument_list|<
name|OAuthPermission
argument_list|>
...
expr_stmt|;
block|}
comment|//TODO: also report other token parameters if any if needed
block|}
return|return
name|Response
operator|.
