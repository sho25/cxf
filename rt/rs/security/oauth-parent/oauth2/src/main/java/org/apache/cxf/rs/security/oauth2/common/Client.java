...
return|;
block|}
comment|/*      * Set the optional Base64 encoded Application Public X509 Certificate      * It can be used in combination with the clientSecret property to support       * Basic or other password-aware authentication on top of 2-way TLS.      */
specifier|public
name|void
name|setApplicationCertificate
parameter_list|(
name|String
name|applicationCertificate
parameter_list|)
