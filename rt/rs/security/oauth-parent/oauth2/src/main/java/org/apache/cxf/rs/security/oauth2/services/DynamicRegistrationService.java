...
parameter_list|)
block|{
comment|//TODO: Passing AccessTokenRegistration to OAuthDataProvider may be needed
name|String
name|regAccessToken
init|=
name|OAuthUtils
...
argument_list|)
decl_stmt|;
comment|// Or check OAuthDataProvider.getAccessToken
comment|// if OAuthDataProvider.createAccessToken was used
name|validateRegistrationAccessToken
argument_list|(
name|regAccessToken
argument_list|)
expr_stmt|;
