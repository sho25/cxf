...
name|SCOPE
decl_stmt|;
comment|// Extension - an array of resource audiences, the name is based on combining
comment|// a property 'resource' (the resource indicators draft) and "_uris", similar to
comment|// a "redirect_uris" property. This property name may change in the future.
specifier|public
specifier|static
specifier|final
name|String
