...
block|{
comment|// TODO: the secret may not be included and only used to create a signature
comment|//       so the header will effectively be similar to the one used during
comment|//       RequestToken requests; we'd need to handle this case too
name|String
name|consumerKey
init|=
name|oAuthMessage
