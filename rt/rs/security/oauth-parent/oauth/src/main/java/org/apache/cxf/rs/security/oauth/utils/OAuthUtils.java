...
name|String
argument_list|>
name|parsePermissionsFromRequest
parameter_list|(
name|OAuthMessage
name|message
parameter_list|)
...
return|;
block|}
comment|/**      * Translates parameters into<code>application/x-www-form-urlencoded</code> String      *      * @param parameters parameters to encode      * @param encoding   The name of a supported      *<a href="../lang/package-summary.html#charenc">character      *                   encoding</a>.      * @return Translated string      */
specifier|public
specifier|static
name|String
name|format
