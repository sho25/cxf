...
decl_stmt|;
comment|// TODO
comment|//        if (keyPswdChars == null) {
comment|//            PrivateKeyPasswordProvider provider = loadPasswordProvider(m, props, keyOper);
comment|//            keyPswdChars = provider != null ? provider.getPassword(props) : null;
comment|//        }
return|return
name|CryptoUtils
operator|.
