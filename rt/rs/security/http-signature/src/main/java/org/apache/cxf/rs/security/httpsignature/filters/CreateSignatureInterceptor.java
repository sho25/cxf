...
begin_comment
comment|/**  * RS WriterInterceptor which adds digests of the body and signing of headers. It will not be invoked for an  * empty request body (e.g. a GET request). In that case use one of the filters.  */
end_comment
