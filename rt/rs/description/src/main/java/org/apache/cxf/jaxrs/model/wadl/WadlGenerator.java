...
expr_stmt|;
block|}
comment|/**      * Set the default WADL response media type.      * For example, a browser may display WADL better if Content-Type       * is set application/xml which is a default response content type.       * Users may set it to application/vnd.sun.wadl+xml or other type.      * @param mt WADL response media type       */
specifier|public
name|void
