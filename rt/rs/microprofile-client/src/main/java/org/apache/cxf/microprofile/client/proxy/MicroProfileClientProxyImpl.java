...
throw|;
block|}
comment|/**      * Returns the incoming request headers from the current JAX-RS request, assuming      * that this is invoked inside a JAX-RS request. If not, it will return an empty      * map.      */
specifier|private
specifier|static
name|MultivaluedMap
argument_list|<
