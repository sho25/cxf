...
parameter_list|)
block|{
comment|// no-op - will revert to baseURL config value (as opposed to baseURI)
block|}
if|if
condition|(
name|baseURI
...
argument_list|(
literal|"Unable to determine base URI from configuration"
argument_list|)
throw|;
block|}
block|}
