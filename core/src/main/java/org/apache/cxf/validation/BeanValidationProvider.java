...
specifier|private
name|ClassLoader
name|validateContextClassloader
decl_stmt|;
specifier|public
name|BeanValidationProvider
parameter_list|()
...
specifier|public
name|ClassLoader
name|getValidateContextClassloader
parameter_list|()
block|{
return|return
name|validateContextClassloader
...
specifier|public
name|void
name|setValidateContextClassloader
parameter_list|(
name|ClassLoader
name|validateContextClassloader
parameter_list|)
...
try|try
block|{
comment|// In OSGi, hibernate's hunt for an EL provided can fail without this.
if|if
condition|(
name|validateContextClassloader
operator|!=
