...
name|skipHack
argument_list|(
literal|"org.apache.cxf.JDKBugHacks.all"
argument_list|)
condition|)
block|{
return|return;
...
name|skipHack
argument_list|(
literal|"org.apache.cxf.JDKBugHacks.imageIO"
argument_list|,
literal|"true"
argument_list|)
condition|)
...
name|skipHack
argument_list|(
literal|"org.apache.cxf.JDKBugHacks.documentBuilderFactory"
argument_list|)
condition|)
block|{
name|DocumentBuilderFactory
...
name|skipHack
argument_list|(
literal|"org.apache.cxf.JDKBugHacks.gcRequestLatency"
argument_list|)
condition|)
block|{
name|Class
...
condition|)
block|{
comment|//something already set it, move on
name|method
operator|=
name|clazz
operator|.
...
name|skipHack
argument_list|(
literal|"org.apache.cxf.JDKBugHacks.policy"
argument_list|)
condition|)
block|{
name|Class
...
name|skipHack
argument_list|(
literal|"org.apache.cxf.JDKBugHacks.authConfiguration"
argument_list|)
condition|)
block|{
name|Class
...
name|skipHack
argument_list|(
literal|"org.apache.cxf.JDKBugHacks.securityProviders"
argument_list|)
condition|)
block|{
name|java
