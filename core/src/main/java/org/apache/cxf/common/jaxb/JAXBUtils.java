...
name|WARNING
argument_list|,
literal|"Failed to create MinumEscapeHandler for unknown jaxb class:"
operator|+
name|cls
argument_list|)
expr_stmt|;
...
name|postFix
operator|+
literal|".bind.marshaller.MinimumEscapeHandler"
argument_list|,
name|cls
argument_list|)
decl_stmt|;
...
name|INFO
argument_list|,
literal|"Failed to create MinumEscapeHandler"
argument_list|,
name|e
argument_list|)
expr_stmt|;
