...
parameter_list|)
block|{
comment|// Fall back to load the location as a stream
try|try
init|(
name|InputStream
name|ins
...
parameter_list|)
block|{
comment|//jsse has the restriction that different key in keystore
comment|//cannot has different password, use MultiKeyPasswordKeyManager
comment|//as fallback when this happen
