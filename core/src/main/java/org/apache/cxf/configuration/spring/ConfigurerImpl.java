...
try|try
block|{
comment|//this will prevent a call into the AbstractBeanFactory.markBeanAsCreated(...)
comment|//which saves ALL the names into a HashSet.  For URL based configuration,
comment|//this can leak memory
if|if
condition|(
name|beanFactory
operator|instanceof
