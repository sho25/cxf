...
name|assertEquals
argument_list|(
literal|"com.example.test.passed"
argument_list|,
name|PackageUtils
operator|.
name|parsePackageName
argument_list|(
literal|"http://www.example.com/test:passed"
argument_list|,
literal|" "
argument_list|)
argument_list|)
...
name|assertEquals
argument_list|(
literal|"org.apache.cxf.no_body_parts.wsdl"
argument_list|,
name|PackageUtils
operator|.
name|parsePackageName
...
specifier|public
name|void
name|testGetPackageNameByNameSpaceURI
parameter_list|()
throws|throws
name|Exception
block|{
...
name|assertEquals
argument_list|(
literal|"uri.cxf_apache_org.jstest"
argument_list|,
name|PackageUtils
operator|.
name|getPackageNameByNameSpaceURI
argument_list|(
literal|"uri:cxf.apache.org:jstest"
argument_list|)
argument_list|)
expr_stmt|;
name|assertEquals
argument_list|(
literal|"soapinterface.ems.esendex.com"
argument_list|,
name|PackageUtils
operator|.
name|getPackageNameByNameSpaceURI
argument_list|(
literal|"com.esendex.ems.soapinterface"
argument_list|)
argument_list|)
expr_stmt|;
name|assertEquals
argument_list|(
literal|"ddd.cc.bb.aa.eee.fff_v01_00"
argument_list|,
name|PackageUtils
operator|.
name|getPackageNameByNameSpaceURI
argument_list|(
literal|"http://aa.bb.cc.ddd/eee/fff_v01.00"
argument_list|)
argument_list|)
expr_stmt|;
block|}
...
name|assertEquals
argument_list|(
literal|"http://util.common.cxf.apache.org/"
argument_list|,
name|packageName
argument_list|)
expr_stmt|;
