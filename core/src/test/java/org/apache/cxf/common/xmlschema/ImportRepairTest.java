...
try|try
block|{
comment|//bug in the JDK doesn't set this, but accesses it
name|config
operator|.
name|setParameter
argument_list|(
literal|"http://www.oracle.com/xml/jaxp/properties/xmlSecurityPropertyManager"
argument_list|,
name|Class
operator|.
name|forName
argument_list|(
literal|"com.sun.org.apache.xerces.internal.utils.XMLSecurityPropertyManager"
argument_list|)
operator|.
name|newInstance
argument_list|()
...
name|forName
argument_list|(
literal|"com.sun.org.apache.xerces.internal.utils.XMLSecurityManager"
argument_list|)
operator|.
name|newInstance
argument_list|()
