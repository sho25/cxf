...
argument_list|()
expr_stmt|;
comment|// Force it to load the attachments
try|try
block|{
name|msg
operator|.
...
name|fail
argument_list|(
literal|"Failure expected on too many attachments"
argument_list|)
expr_stmt|;
block|}
catch|catch
...
specifier|public
name|void
name|testChangingMaxAttachmentCount
parameter_list|()
throws|throws
name|Exception
block|{
...
specifier|public
name|void
name|testInvalidContentDispositionFilename
parameter_list|()
throws|throws
name|Exception
block|{
...
name|append
argument_list|(
literal|"Content-Disposition: attachment; filename=../../../../../../../../etc/passwd\n"
argument_list|)
operator|.
name|append
argument_list|(
