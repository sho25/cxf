...
throw|;
block|}
comment|/*          * An element's namespace must match the containing namespace.          */
if|if
condition|(
operator|!
name|element
...
name|severe
argument_list|(
literal|"Attempt to set the QName of an element to a namespace that "
operator|+
literal|"is outside of the containing schema"
argument_list|)
expr_stmt|;
throw|throw
operator|new
name|XmlSchemaInvalidOperation
argument_list|(
literal|"Attempt to set the QName of an element to a namespace "
operator|+
literal|"that is outside of the containing schema"
argument_list|)
throw|;
block|}
name|element
