...
name|getResourceAsStream
argument_list|(
literal|"../resources/complexReqIn4.xml"
argument_list|)
argument_list|)
decl_stmt|;
name|Map
...
name|getResourceAsStream
argument_list|(
literal|"../resources/complexReq4partial.xml"
argument_list|)
argument_list|)
decl_stmt|;
name|verifyReaders
...
specifier|public
name|void
name|testReadWithAppendPostWrap
parameter_list|()
throws|throws
name|Exception
block|{
...
name|XMLStreamException
block|{
comment|/*         if (true) {             System.out.println(">>>>>>>>>");             StaxUtils.copy(reader, System.out);             System.out.println("<<<<<<<<<");             return;         }         */
