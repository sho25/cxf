...
expr_stmt|;
block|}
comment|// TODO: if wsdlNode is null throw exception
name|customizedElements
operator|.
name|put
argument_list|(
...
block|{
name|Element
name|jaxbBindingElement
init|=
name|getJaxbBindingElement
argument_list|(
name|jaxwsBindingNode
argument_list|)
decl_stmt|;
...
name|StAXUtil
operator|.
name|createFreshXMLStreamReader
argument_list|(
name|is
argument_list|)
decl_stmt|;
