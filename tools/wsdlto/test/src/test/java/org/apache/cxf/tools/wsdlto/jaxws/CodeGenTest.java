...
specifier|public
name|void
name|testAsyncMethodFromCommandLine
parameter_list|()
throws|throws
name|Exception
block|{
...
name|getLocation
argument_list|(
literal|"/wsdl2java_wsdl/hello_world_async_noservice.wsdl"
argument_list|)
argument_list|)
expr_stmt|;
name|env
...
name|fail
argument_list|(
literal|"Should not have generated testIntAsync"
argument_list|)
expr_stmt|;
block|}
catch|catch
...
name|loadClass
argument_list|(
literal|"org.apache.cxf.w2j.hello_world_async_soap_http.GreeterDAsync"
argument_list|)
expr_stmt|;
name|method1
operator|=
...
name|loadClass
argument_list|(
literal|"org.apache.cxf.w2j.hello_world_async_soap_http.GreeterCAsync"
argument_list|)
expr_stmt|;
try|try
block|{
...
name|fail
argument_list|(
literal|"Should not have generated greetMeSometimeAsync"
argument_list|)
expr_stmt|;
block|}
catch|catch
...
name|loadClass
argument_list|(
literal|"org.apache.cxf.w2j.hello_world_async_soap_http.GreeterBAsync"
argument_list|)
expr_stmt|;
try|try
block|{
...
name|str1
init|=
literal|"javax.xml.ws.Holder<java.awt.Image>"
decl_stmt|;
name|String
name|str2
init|=
...
name|getLocation
argument_list|(
literal|"/wsdl2java_wsdl/tns_url_with_colon.wsdl"
argument_list|)
argument_list|)
expr_stmt|;
name|processor
...
name|loadClass
argument_list|(
literal|"org.apache.cxf.w2j.hello_world_soap_http.tns.soap.Greeter"
argument_list|)
decl_stmt|;
name|assertNotNull
argument_list|(
literal|"Greeter class from wsdl targetNamespace could not be found"
argument_list|,
name|sei
argument_list|)
expr_stmt|;
...
name|loadClass
argument_list|(
literal|"org.apache.cxf.w2j.hello_world_soap_http.tns.types.GreetMe"
argument_list|)
decl_stmt|;
name|assertNotNull
argument_list|(
literal|"GreetMe class from schema targetNamespace could not be found"
argument_list|,
name|tc
argument_list|)
expr_stmt|;
...
name|getLocation
argument_list|(
literal|"/wsdl2java_wsdl/tns_urn.wsdl"
argument_list|)
argument_list|)
expr_stmt|;
name|processor
...
name|loadClass
argument_list|(
literal|"apache.cxf.issue._6527.Greeter"
argument_list|)
decl_stmt|;
name|assertNotNull
argument_list|(
...
name|loadClass
argument_list|(
literal|"apache.cxf.issue._6527.types.GreetMe"
argument_list|)
decl_stmt|;
name|assertNotNull
argument_list|(
...
name|getLocation
argument_list|(
literal|"/wsdl2java_wsdl/helloworld-noservice-header.wsdl"
argument_list|)
argument_list|)
expr_stmt|;
name|processor
...
name|output
argument_list|,
literal|"org/apache/cxf/helloworld/HelloWorldServiceImpl.java"
argument_list|)
decl_stmt|;
name|assertTrue
argument_list|(
...
name|loadClass
argument_list|(
literal|"org.apache.cxf.helloworld.HelloWorldServiceImpl"
argument_list|)
decl_stmt|;
name|Method
index|[]
...
name|output
argument_list|,
literal|"org/apache/cxf/w2j/hello_world_soap_http/types/SayHiResponse"
argument_list|)
decl_stmt|;
name|assertFalse
argument_list|(
...
name|output
argument_list|,
literal|"org/apache/cxf/w2j/hello_world_soap_http/types/GreetMeResponse"
argument_list|)
decl_stmt|;
name|assertFalse
argument_list|(
...
specifier|public
name|void
name|testFaultSerialVersionUIDNONEFQCN
parameter_list|()
throws|throws
name|Exception
block|{
...
name|output
argument_list|,
literal|"org/apache/cxf/w2j/hello_world_soap_http/BadRecordLitFault.java"
argument_list|)
expr_stmt|;
name|assertTrue
argument_list|(
...
name|loadClass
argument_list|(
literal|"org.apache.cxf.w2j.hello_world_soap_http.NoSuchCodeLitFault"
argument_list|)
decl_stmt|;
name|Field
...
name|loadClass
argument_list|(
literal|"org.apache.cxf.w2j.hello_world_soap_http.BadRecordLitFault"
argument_list|)
expr_stmt|;
name|assertEquals
argument_list|(
...
specifier|public
name|void
name|testNoFaultSerialVersionUID
parameter_list|()
throws|throws
name|Exception
block|{
...
name|fail
argument_list|(
literal|"shouldn't have serialVersionUID field"
argument_list|)
expr_stmt|;
block|}
catch|catch
...
specifier|public
name|void
name|testFaultSerialVersionUIDNONE
parameter_list|()
throws|throws
name|Exception
block|{
...
specifier|public
name|void
name|testFaultSerialVersionUIDNONETIMESTAMP
parameter_list|()
throws|throws
name|Exception
block|{
...
specifier|public
name|void
name|testFaultSerialVersionUIDNumber
parameter_list|()
throws|throws
name|Exception
block|{
...
specifier|public
name|void
name|testNoTargetNamespaceSchema
parameter_list|()
throws|throws
name|Exception
block|{
...
name|getLocation
argument_list|(
literal|"/wsdl2java_wsdl/cxf6580/hello_import.wsdl"
argument_list|)
argument_list|)
expr_stmt|;
name|env
...
name|getLocation
argument_list|(
literal|"/wsdl2java_wsdl/cxf6580/catalog.xml"
argument_list|)
argument_list|)
expr_stmt|;
name|processor
...
name|output
argument_list|,
literal|"org/apache/hello_soap_http/types/Hello.java"
argument_list|)
decl_stmt|;
name|assertTrue
argument_list|(
...
name|output
argument_list|,
literal|"org/apache/hello_soap_http/types/HelloResponse.java"
argument_list|)
expr_stmt|;
name|assertTrue
argument_list|(
...
name|getLocation
argument_list|(
literal|"/wsdl2java_wsdl/cxf2193/hello_world_extension_wrapped.wsdl"
argument_list|)
argument_list|)
expr_stmt|;
name|processor
...
name|output
argument_list|,
literal|"org/apache/cxf/w2j/extension_wrapped/Greeter.java"
argument_list|)
decl_stmt|;
name|assertTrue
argument_list|(
...
name|loadClass
argument_list|(
literal|"org.apache.cxf.w2j.extension_wrapped.Greeter"
argument_list|)
decl_stmt|;
name|Method
name|method
...
name|assertNotNull
argument_list|(
literal|"@RequestWrapper is expected"
argument_list|,
name|reqWrapper
argument_list|)
expr_stmt|;
...
specifier|public
name|void
name|testMultilevelExtensionWrapper
parameter_list|()
throws|throws
name|Exception
block|{
...
name|getLocation
argument_list|(
literal|"/wsdl2java_wsdl/cxf8025/hello_world_multilevel_extension_wrapped.wsdl"
argument_list|)
argument_list|)
expr_stmt|;
name|processor
...
name|output
argument_list|,
literal|"org/apache/cxf/w2j/multilevel_extension_wrapped/Greeter.java"
argument_list|)
decl_stmt|;
name|assertTrue
argument_list|(
...
name|loadClass
argument_list|(
literal|"org.apache.cxf.w2j.multilevel_extension_wrapped.Greeter"
argument_list|)
decl_stmt|;
name|Method
name|method
...
name|getMethod
argument_list|(
literal|"greetMeMultilevelExtension"
argument_list|,
operator|new
name|Class
index|[]
...
name|assertNotNull
argument_list|(
literal|"greetMeMultilevelExtension operation is NOT generated correctly as excepted"
argument_list|,
name|method
argument_list|)
expr_stmt|;
...
name|assertNotNull
argument_list|(
literal|"@RequestWrapper is expected on greetMeMultilevelExtension"
argument_list|,
name|reqWrapper
argument_list|)
expr_stmt|;
...
specifier|public
name|void
name|testMultilevelExtensionWrapperStackDepth
parameter_list|()
throws|throws
name|Exception
block|{
...
name|contains
argument_list|(
literal|" * porttype documentation"
argument_list|)
argument_list|)
expr_stmt|;
name|assertTrue
...
name|contains
argument_list|(
literal|"     * porttype op documentation"
argument_list|)
argument_list|)
expr_stmt|;
name|List
...
argument_list|()
argument_list|,
literal|"org/apache/cxf/w2j/hello_world_soap_http/SOAPServiceTest1.java"
argument_list|)
argument_list|)
decl_stmt|;
name|boolean
...
specifier|public
name|void
name|testPassShemaFileAsJAXBBinding
parameter_list|()
throws|throws
name|Exception
block|{
...
name|getLocation
argument_list|(
literal|"/wsdl2java_wsdl/Invoice.xsd"
argument_list|)
argument_list|)
expr_stmt|;
name|processor
...
name|output
argument_list|,
literal|"org/apache/invoice/Invoice.java"
argument_list|)
decl_stmt|;
name|assertTrue
argument_list|(
...
name|assertEquals
argument_list|(
literal|"15 files including wsdl and class files are expected"
argument_list|,
literal|15
argument_list|,
name|jarEntries
...
name|assertTrue
argument_list|(
literal|"hello_world_messages.wsdl is expected"
argument_list|,
name|jarEntries
operator|.
name|contains
argument_list|(
literal|"hello_world_messages.wsdl"
argument_list|)
argument_list|)
expr_stmt|;
name|assertTrue
argument_list|(
literal|"org/apache/cxf/w2j/hello_world/SOAPService.class is expected"
argument_list|,
name|jarEntries
operator|.
name|contains
argument_list|(
literal|"org/apache/cxf/w2j/hello_world/SOAPService.class"
argument_list|)
argument_list|)
expr_stmt|;
block|}
