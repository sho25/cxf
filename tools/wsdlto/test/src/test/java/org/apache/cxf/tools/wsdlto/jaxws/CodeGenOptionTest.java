...
return|;
block|}
comment|/**      * Tests that, when 'suppress-generated-date' option is set, javadocs      * won't contain the current date in all the generated java classes.      */
annotation|@
name|Test
specifier|public
name|void
name|testSuppressGeneratedDatePresentOption
parameter_list|()
throws|throws
name|Exception
block|{
...
expr_stmt|;
block|}
comment|/**      * Tests that, when 'suppress-generated-date' option is not present, javadocs      * will contain the current date in all the generated java classes.      */
annotation|@
name|Test
specifier|public
name|void
name|testSuppressGeneratedDateNotPresentOption
parameter_list|()
throws|throws
name|Exception
block|{
...
name|contains
argument_list|(
literal|"Generated source version"
argument_list|)
condition|)
block|{
break|break;
...
name|contains
argument_list|(
literal|"This class was generated by"
argument_list|)
expr_stmt|;
block|}
return|return
