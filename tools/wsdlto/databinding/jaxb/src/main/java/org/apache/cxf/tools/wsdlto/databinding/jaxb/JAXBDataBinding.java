...
argument_list|)
decl_stmt|;
comment|//installResolverIntoSchemaCompiler(schemaCompiler);
...
try|try
block|{
comment|//JAXB xjc cannot properly do this for "jar" URL's so we'll go ahead and do
comment|//the resolving ourselves.
name|URL
name|url
init|=
operator|new
