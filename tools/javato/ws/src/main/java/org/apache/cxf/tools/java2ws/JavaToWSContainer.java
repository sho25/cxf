...
argument_list|)
expr_stmt|;
comment|// check for custom compiler object to pass on
if|if
condition|(
name|getContext
argument_list|()
...
parameter_list|)
block|{
comment|// Try to find an exception with a message on the stack
name|Throwable
name|e
init|=
name|ex
...
name|println
argument_list|(
literal|"Use the verbose setting to show the stacktrace of this error"
argument_list|)
expr_stmt|;
block|}
throw|throw
