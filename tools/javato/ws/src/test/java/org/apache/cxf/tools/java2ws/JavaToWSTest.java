...
name|outputFile
argument_list|(
literal|"org/apache/cxf/tools/fortest/cxf2941/jaxws/HelloStringResponse.java"
argument_list|)
decl_stmt|;
name|String
name|str
...
name|assertTrue
argument_list|(
literal|"name value in annoataion @XmlElement is not correct"
argument_list|,
name|str
operator|.
name|contains
...
name|outputFile
argument_list|(
literal|"org/apache/cxf/tools/fortest/cxf2934/jaxws/HelloStringResponse.java"
argument_list|)
decl_stmt|;
name|String
name|str
...
literal|"/tmp.wsdl"
block|,
literal|"org.apache.cxf.tools.fortest.cxf1450.WebParamService"
block|}
decl_stmt|;
name|CommandInterfaceUtils
operator|.
...
name|outputFile
argument_list|(
literal|"org/apache/cxf/tools/fortest/cxf1450/jaxws/HelloStringResponse.java"
argument_list|)
decl_stmt|;
name|String
name|str
