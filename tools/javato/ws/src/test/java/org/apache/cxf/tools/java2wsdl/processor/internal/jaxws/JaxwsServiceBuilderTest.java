...
name|getResource
argument_list|(
literal|"expected/doc_wrapped_bare.wsdl"
argument_list|)
operator|.
name|toURI
argument_list|()
...
name|getResource
argument_list|(
literal|"expected/rpc_lit_service_no_anno.wsdl"
argument_list|)
operator|.
name|toURI
argument_list|()
...
name|getResource
argument_list|(
literal|"expected/rpc_on_method.wsdl"
argument_list|)
operator|.
name|toURI
argument_list|()
...
name|getResource
argument_list|(
literal|"expected/expected_someheaders.wsdl"
argument_list|)
operator|.
name|toURI
argument_list|()
