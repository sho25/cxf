...
argument_list|()
decl_stmt|;
comment|// workaround for now - sent bug to WSCommons - the elements
comment|// QName should have its namespace included.
name|QName
name|schemaName
init|=
name|element
...
argument_list|()
decl_stmt|;
comment|/*         // workaround for now - sent bug to WSCommons - the attribute         // QName should have its namespace included. */
if|if
condition|(
name|schemaName
operator|.
