...
name|getResource
argument_list|(
literal|"/wsdl/arrays-mixed.wsdl"
argument_list|)
operator|.
name|toString
argument_list|()
...
name|assertNull
argument_list|(
literal|"All nested anonymous types should have \"nested\" names"
argument_list|,
name|typeMap
operator|.
name|getType
...
argument_list|)
expr_stmt|;
comment|// Checkstyle forces me to split the method...
name|assertMixedArraysMappingEasyTypes
argument_list|(
name|typeMap
argument_list|)
expr_stmt|;
comment|// elem types are no longer strings from now.
name|assertMixedArraysMappingDifficultSequences
argument_list|(
name|typeMap
argument_list|)
expr_stmt|;
name|assertMixedArraysMappingDifficultArrays
argument_list|(
name|typeMap
argument_list|)
expr_stmt|;
...
name|getType
argument_list|(
literal|"p1-unwrapped-sequenceArray"
argument_list|)
decl_stmt|;
name|assertEquals
argument_list|(
...
name|getType
argument_list|(
literal|"p1-unwrapped-sequence-qArray"
argument_list|)
decl_stmt|;
name|assertEquals
argument_list|(
...
name|QName
argument_list|(
literal|"http://schemas.apache.org/idltypes/anon.idl"
argument_list|,
literal|"p1-unwrapped-sequence-q"
argument_list|)
argument_list|,
name|p1q
operator|.
...
name|getType
argument_list|(
literal|"p3-unwrapped-arrayArray"
argument_list|)
decl_stmt|;
name|assertEquals
argument_list|(
...
name|getType
argument_list|(
literal|"p3-unwrapped-array-qArray"
argument_list|)
decl_stmt|;
name|assertEquals
argument_list|(
...
name|getType
argument_list|(
literal|"p5-anonymous-unwrapped-sequenceArray"
argument_list|)
decl_stmt|;
name|assertEquals
argument_list|(
...
literal|""
argument_list|,
literal|"p5-anonymous-unwrapped-sequence"
argument_list|)
argument_list|,
name|p5
operator|.
...
name|getType
argument_list|(
literal|"p5-anonymous-unwrapped-sequence-qArray"
argument_list|)
decl_stmt|;
name|assertEquals
argument_list|(
...
literal|"http://schemas.apache.org/idltypes/anon.idl"
argument_list|,
literal|"p5-anonymous-unwrapped-sequence-q"
argument_list|)
argument_list|,
name|p5q
operator|.
...
name|getType
argument_list|(
literal|"MixedArrayType.p6-anonymous-wrapped-sequenceType"
argument_list|)
decl_stmt|;
name|assertEquals
argument_list|(
...
name|getType
argument_list|(
literal|"MixedArrayType.p6-anonymous-wrapped-sequence-qType"
argument_list|)
decl_stmt|;
name|assertEquals
argument_list|(
...
name|getType
argument_list|(
literal|"p7-anonymous-unwrapped-arrayArray"
argument_list|)
decl_stmt|;
name|assertEquals
argument_list|(
...
literal|""
argument_list|,
literal|"p7-anonymous-unwrapped-array"
argument_list|)
argument_list|,
name|p7
operator|.
...
name|getType
argument_list|(
literal|"p7-anonymous-unwrapped-array-qArray"
argument_list|)
decl_stmt|;
name|assertEquals
argument_list|(
...
literal|"http://schemas.apache.org/idltypes/anon.idl"
argument_list|,
literal|"p7-anonymous-unwrapped-array-q"
argument_list|)
argument_list|,
name|p7q
operator|.
...
name|getType
argument_list|(
literal|"MixedArrayType.p8-anonymous-wrapped-arrayType"
argument_list|)
decl_stmt|;
name|assertEquals
argument_list|(
...
name|getType
argument_list|(
literal|"MixedArrayType.p8-anonymous-wrapped-array-qType"
argument_list|)
decl_stmt|;
name|assertEquals
argument_list|(
...
literal|"http://schemas.apache.org/idl/anon.idl/corba/typemap/"
decl_stmt|;
comment|// p9 is unwrapped, so there's "MixedArrayType.p9-anonymous-unwrapped-non-primitive-sequenceArray" type
comment|// registered and "MixedArrayType.p9-anonymous-unwrapped-non-primitive-sequence" as type of the element
comment|// which is Struct
name|Sequence
name|p9
init|=
operator|(
...
name|getType
argument_list|(
literal|"MixedArrayType.p9-anonymous-unwrapped-non-primitive-sequenceArray"
argument_list|)
decl_stmt|;
name|assertEquals
argument_list|(
...
literal|""
argument_list|,
literal|"p9-anonymous-unwrapped-non-primitive-sequence"
argument_list|)
argument_list|,
name|p9
operator|.
...
name|corbaTm
argument_list|,
literal|"MixedArrayType.p9-anonymous-unwrapped-non-primitive-sequence"
argument_list|)
argument_list|,
name|p9
operator|.
...
name|getType
argument_list|(
literal|"MixedArrayType.p9-anonymous-unwrapped-non-primitive-sequence-qArray"
argument_list|)
decl_stmt|;
name|assertEquals
argument_list|(
...
literal|"http://schemas.apache.org/idltypes/anon.idl"
argument_list|,
literal|"p9-anonymous-unwrapped-non-primitive-sequence-q"
argument_list|)
argument_list|,
name|p9q
operator|.
...
name|corbaTm
argument_list|,
literal|"MixedArrayType.p9-anonymous-unwrapped-non-primitive-sequence-q"
argument_list|)
argument_list|,
name|p9q
operator|.
...
argument_list|)
expr_stmt|;
comment|// p10 is wrapped, so there's no "MixedArrayType.p10-anonymous-wrapped-non-primitive-sequenceArray"
name|Anonsequence
name|p10
init|=
operator|(
...
name|getType
argument_list|(
literal|"MixedArrayType.p10-anonymous-wrapped-non-primitive-sequenceType"
argument_list|)
decl_stmt|;
name|assertEquals
argument_list|(
...
name|corbaTm
argument_list|,
literal|"MixedArrayType.p10-anonymous-wrapped-non-primitive-sequence.item"
argument_list|)
argument_list|,
name|p10
operator|.
...
name|getType
argument_list|(
literal|"MixedArrayType.p10-anonymous-wrapped-non-primitive-sequence-qType"
argument_list|)
decl_stmt|;
name|assertEquals
argument_list|(
...
name|corbaTm
argument_list|,
literal|"MixedArrayType.p10-anonymous-wrapped-non-primitive-sequence-q.item"
argument_list|)
argument_list|,
name|p10q
operator|.
...
literal|"http://schemas.apache.org/idl/anon.idl/corba/typemap/"
decl_stmt|;
comment|// p11 is unwrapped, so the same case as p9
name|Array
name|p11
init|=
operator|(
...
name|getType
argument_list|(
literal|"MixedArrayType.p11-anonymous-unwrapped-non-primitive-arrayArray"
argument_list|)
decl_stmt|;
name|assertEquals
argument_list|(
...
literal|""
argument_list|,
literal|"p11-anonymous-unwrapped-non-primitive-array"
argument_list|)
argument_list|,
name|p11
operator|.
...
name|corbaTm
argument_list|,
literal|"MixedArrayType.p11-anonymous-unwrapped-non-primitive-array"
argument_list|)
argument_list|,
name|p11
operator|.
...
name|getType
argument_list|(
literal|"MixedArrayType.p11-anonymous-unwrapped-non-primitive-array-qArray"
argument_list|)
decl_stmt|;
name|assertEquals
argument_list|(
...
literal|"http://schemas.apache.org/idltypes/anon.idl"
argument_list|,
literal|"p11-anonymous-unwrapped-non-primitive-array-q"
argument_list|)
argument_list|,
name|p11q
operator|.
...
name|corbaTm
argument_list|,
literal|"MixedArrayType.p11-anonymous-unwrapped-non-primitive-array-q"
argument_list|)
argument_list|,
name|p11q
operator|.
...
argument_list|)
expr_stmt|;
comment|// p12 us wrapped - see p10
name|Anonarray
name|p12
init|=
operator|(
...
name|getType
argument_list|(
literal|"MixedArrayType.p12-anonymous-wrapped-non-primitive-arrayType"
argument_list|)
decl_stmt|;
name|assertEquals
argument_list|(
...
name|corbaTm
argument_list|,
literal|"MixedArrayType.p12-anonymous-wrapped-non-primitive-array.item"
argument_list|)
argument_list|,
name|p12
operator|.
...
name|getType
argument_list|(
literal|"MixedArrayType.p12-anonymous-wrapped-non-primitive-array-qType"
argument_list|)
decl_stmt|;
name|assertEquals
argument_list|(
...
name|corbaTm
argument_list|,
literal|"MixedArrayType.p12-anonymous-wrapped-non-primitive-array-q.item"
argument_list|)
argument_list|,
name|p12q
operator|.
