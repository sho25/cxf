...
specifier|public
name|void
name|testIllegalWSDLImportProtocol
parameter_list|()
throws|throws
name|Exception
block|{
...
name|getLocation
argument_list|(
literal|"/validator_wsdl/ftp_import.wsdl"
argument_list|)
block|}
decl_stmt|;
name|WSDLValidator
...
name|indexOf
argument_list|(
literal|"The ftp URI scheme is not allowed"
argument_list|)
operator|!=
operator|-
literal|1
...
specifier|public
name|void
name|testIllegalXSDImportProtocol
parameter_list|()
throws|throws
name|Exception
block|{
...
name|getLocation
argument_list|(
literal|"/validator_wsdl/ftp_import2.wsdl"
argument_list|)
block|}
decl_stmt|;
name|WSDLValidator
