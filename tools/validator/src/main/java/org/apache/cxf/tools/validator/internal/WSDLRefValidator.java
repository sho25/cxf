...
parameter_list|)
block|{
comment|// no check as any namespace URI is already a valid target namespace string.
block|}
specifier|public
name|void
...
condition|)
block|{
comment|//System.out.println("Fail: " + vNode.getXPath());
name|FailureLocation
name|loc
init|=
name|getFailureLocation
...
argument_list|()
operator|+
literal|" is not correct, please check that the correct namespace is being used"
argument_list|)
expr_stmt|;
throw|throw
operator|new
