...
begin_comment
comment|/**  * Provides methods to create a {@link Connection} object that represents a Web  * service defined from the supplied parameters. This interface is returned from  * an environment naming context lookup by a J2EE component.  */
end_comment
