...
return|;
block|}
comment|/**       * Instantiates the instance of the provider using CDI/BeanManager       */
specifier|private
specifier|static
class|class
...
name|beanManager
operator|.
name|getInjectionTargetFactory
argument_list|(
name|annotatedType
argument_list|)
decl_stmt|;
