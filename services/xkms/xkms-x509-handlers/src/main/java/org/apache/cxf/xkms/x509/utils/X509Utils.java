...
condition|)
block|{
comment|// At least one of the components reported a problem, so we
comment|// include the reported error code
name|Iterator
argument_list|<
name|String
argument_list|>
...
block|{
comment|// no error here, we simply did not find any matching
...
name|setService
argument_list|(
literal|"http://services.sopera.org/xkms/v2.0"
argument_list|)
expr_stmt|;
return|return
name|ret
