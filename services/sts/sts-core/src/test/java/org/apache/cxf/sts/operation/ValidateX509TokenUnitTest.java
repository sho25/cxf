...
begin_comment
comment|/**  * Some unit tests for the validate operation to validate X.509 tokens.  */
end_comment

begin_class
specifier|public
class|class
name|ValidateX509TokenUnitTest
extends|extends
name|org
operator|.
name|junit
...
argument_list|()
decl_stmt|;
comment|/**      * Test to successfully validate an X.509 token      */
annotation|@
name|org
operator|.
name|junit
...
argument_list|)
expr_stmt|;
comment|// Create a BinarySecurityToken
name|CryptoType
name|cryptoType
init|=
operator|new
...
expr_stmt|;
block|}
comment|/**      * Test to validate an invalid X.509 token      */
annotation|@
name|org
operator|.
name|junit
...
specifier|public
name|void
name|testValidateInvalidX509Token
parameter_list|()
throws|throws
name|Exception
block|{
