...
expr_stmt|;
block|}
comment|/**      * Test to successfully issue a SAML 2 token on-behalf-of a SAML 1 token      */
annotation|@
name|org
operator|.
name|junit
...
specifier|public
name|void
name|testIssueSaml2TokenOnBehalfOfSaml1
parameter_list|()
throws|throws
name|Exception
block|{
...
expr_stmt|;
block|}
comment|/**      * Test to successfully issue a SAML 2 token on-behalf-of a SAML 2 Symmetric HOK token      */
annotation|@
name|org
operator|.
name|junit
...
specifier|public
name|void
name|testIssueSaml2TokenOnBehalfOfSaml2SymmetricHOK
parameter_list|()
throws|throws
name|Exception
block|{
...
name|fail
argument_list|(
literal|"Failure expected as HolderOfKey is not allowed by default"
argument_list|)
expr_stmt|;
block|}
catch|catch
...
expr_stmt|;
block|}
comment|/**      * Test to successfully issue a SAML 2 token on-behalf-of a SAML 1 Symmetric HOK token      */
annotation|@
name|org
operator|.
name|junit
...
specifier|public
name|void
name|testIssueSaml2TokenOnBehalfOfSaml1SymmetricHOK
parameter_list|()
throws|throws
name|Exception
block|{
...
expr_stmt|;
block|}
comment|/**      * Test to successfully issue a SAML 2 token on-behalf-of a SAML 2 PublicKey HOK token      */
annotation|@
name|org
operator|.
name|junit
...
specifier|public
name|void
name|testIssueSaml2TokenOnBehalfOfSaml2PublicKeyHOK
parameter_list|()
throws|throws
name|Exception
block|{
...
expr_stmt|;
block|}
comment|/**      * Test to successfully issue a SAML 2 token on-behalf-of a SAML 1 PublicKey HOK token      */
annotation|@
name|org
operator|.
name|junit
...
specifier|public
name|void
name|testIssueSaml2TokenOnBehalfOfSaml1PublicKeyHOK
parameter_list|()
throws|throws
name|Exception
block|{
...
expr_stmt|;
block|}
comment|/**      * Test to unsuccessfully issue a SAML 2 token on-behalf-of a SAML 2 token. The      * problem is that the Audience Restriction URLs in the original token do not      * match the AppliesTo address.      */
annotation|@
name|org
operator|.
name|junit
...
specifier|public
name|void
name|testSaml2AudienceRestriction
parameter_list|()
throws|throws
name|Exception
block|{
...
name|fail
argument_list|(
literal|"Failure expected due to AudienceRestriction"
argument_list|)
expr_stmt|;
block|}
catch|catch
...
block|}
block|}
comment|/**      * Test to unsuccessfully issue a SAML 2 token on-behalf-of a SAML 1 token. The      * problem is that the Audience Restriction URLs in the original token do not      * match the AppliesTo address.      */
annotation|@
name|org
operator|.
name|junit
...
specifier|public
name|void
name|testSaml1AudienceRestriction
parameter_list|()
throws|throws
name|Exception
block|{
...
name|fail
argument_list|(
literal|"Failure expected as UsernameTokens are not accepted for OnBehalfOf by default"
argument_list|)
expr_stmt|;
block|}
catch|catch
...
expr_stmt|;
block|}
comment|/**      * Test to successfully issue a SAML 2 token on-behalf-of a SAML 2 token      * but WS-Security user different than on-behalf-of subject      */
annotation|@
name|org
operator|.
name|junit
...
specifier|public
name|void
name|testIssueSaml2TokenOnBehalfOfSaml2DifferentWSUser
parameter_list|()
throws|throws
name|Exception
block|{
...
argument_list|)
expr_stmt|;
comment|// Mock up message context with user 'bob'
name|MessageImpl
name|msg
init|=
operator|new
...
expr_stmt|;
block|}
comment|/**      * Test to successfully issue a SAML 2 token on-behalf-of a SAML 2 token      * but WS-Security user different than on-behalf-of subject      * and request claims      */
annotation|@
name|org
operator|.
name|junit
...
specifier|public
name|void
name|testIssueSaml2TokenOnBehalfOfSaml2DifferentWSUserAndClaims
parameter_list|()
throws|throws
name|Exception
block|{
