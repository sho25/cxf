...
begin_comment
comment|/**  * Some unit tests for validating a SAML token via the SAMLTokenValidator in different realms.  */
end_comment
...
name|Assert
block|{
comment|/**      * Test a SAML 1.1 Assertion created in realm "A" and validated in realm "B".      */
annotation|@
name|org
operator|.
name|junit
...
argument_list|)
expr_stmt|;
comment|// Token Validation should fail as the TokenValidator doesn't know about the realm "A"
...
argument_list|)
expr_stmt|;
comment|// Now set the realms on the Validator and try to validate the token again
name|Map
argument_list|<
name|String
argument_list|,
