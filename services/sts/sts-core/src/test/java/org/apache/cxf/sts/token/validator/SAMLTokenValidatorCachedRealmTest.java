...
begin_comment
comment|/**  * Some unit tests for validating a SAML token with a realm against the cached tokens realm.  */
end_comment

begin_class
specifier|public
class|class
name|SAMLTokenValidatorCachedRealmTest
extends|extends
name|org
operator|.
name|junit
...
expr_stmt|;
block|}
comment|/**      * Test a SAML Assertion with valid cached realm.      */
annotation|@
name|org
operator|.
name|junit
...
expr_stmt|;
block|}
comment|/**      * Test a SAML Assertion with invalid cached realm.      */
annotation|@
name|org
operator|.
name|junit
