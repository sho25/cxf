...
expr_stmt|;
block|}
comment|/**      * Here we have two ClaimsHandlers that can both add claims for the same claim type. By default we will      * combine the Claims into one Attribute.      */
annotation|@
name|org
operator|.
name|junit
...
specifier|public
name|void
name|testSaml2CombinedClaimsMultipleClaimsHandlers
parameter_list|()
throws|throws
name|Exception
block|{
...
argument_list|)
expr_stmt|;
comment|// Check only one Role Claim
name|assertEquals
argument_list|(
name|tokenString
operator|.
...
expr_stmt|;
block|}
comment|/**      * Here we have two ClaimsHandlers that can both add claims for the same claim type. We configure the      * SAMLTokenProvider not to combine the claims unlike the test above.      */
annotation|@
name|org
operator|.
name|junit
...
specifier|public
name|void
name|testSaml2SeparateClaimsMultipleClaimsHandlers
parameter_list|()
throws|throws
name|Exception
block|{
...
operator|)
operator|.
name|setCombineClaimAttributes
argument_list|(
literal|false
argument_list|)
expr_stmt|;
...
argument_list|)
expr_stmt|;
comment|// Check we have two Role Claims
