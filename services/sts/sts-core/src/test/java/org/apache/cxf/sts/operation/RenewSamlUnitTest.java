...
expr_stmt|;
block|}
comment|/**      * Test to successfully renew an expired Saml 1.1 token (using the cache)      */
annotation|@
name|org
operator|.
name|junit
...
expr_stmt|;
block|}
comment|/**      * Test to successfully renew an expired Saml 1.1 token without using the cache      */
annotation|@
name|org
operator|.
name|junit
...
expr_stmt|;
block|}
comment|/**      * Test to successfully renew an expired Saml 2 token (using the cache)      */
annotation|@
name|org
operator|.
name|junit
...
expr_stmt|;
block|}
comment|/**      * Test to successfully renew an expired Saml 2 token without using the cache      */
annotation|@
name|org
operator|.
name|junit
...
specifier|public
name|void
name|testRenewExpiredSaml2TokenNoCache
parameter_list|()
throws|throws
name|Exception
block|{
...
name|fail
argument_list|(
literal|"Failure expected on trying to renew a valid token"
argument_list|)
expr_stmt|;
block|}
catch|catch
...
expr_stmt|;
block|}
comment|/**      * Test to successfully renew an expired Saml 2 token without using the cache, and sending      * no TokenType.      */
annotation|@
name|org
operator|.
name|junit
