...
expr_stmt|;
block|}
comment|/**      * Test custom claim parser and handler.      */
annotation|@
name|org
operator|.
name|junit
...
name|secondaryParameters
init|=
name|createCustomSecondaryParameters
argument_list|()
decl_stmt|;
name|request
operator|.
...
specifier|public
name|void
name|testIssueTokenUnknownClaim
parameter_list|()
throws|throws
name|Exception
block|{
...
argument_list|)
expr_stmt|;
comment|// Add a custom claim (unknown to the CustomClaimsHandler)
name|Element
name|secondaryParameters
init|=
name|createSecondaryParameters
...
name|fail
argument_list|(
literal|"Failure expected on an unknown non-optional claims type"
argument_list|)
expr_stmt|;
block|}
catch|catch
...
block|}
block|}
comment|/**      * @param issueOperation      * @param request      * @param webServiceContext      * @return      */
specifier|private
name|List
argument_list|<
name|RequestSecurityTokenResponseType
...
return|;
block|}
comment|/**      * @param issueOperation      * @throws WSSecurityException      */
specifier|private
name|void
name|addSTSProperties
parameter_list|(
...
return|;
block|}
comment|/*      * Mock up a SecondaryParameters DOM Element containing a custom claim dialect.      */
specifier|private
name|Element
name|createCustomSecondaryParameters
parameter_list|()
