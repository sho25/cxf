...
begin_comment
comment|/**  * Some unit tests for renewing a SecurityContextToken via the SCTRenewer.  */
end_comment
...
argument_list|()
decl_stmt|;
comment|/**      * Get a (valid) SecurityContextToken and successfully renew it.      */
annotation|@
name|org
operator|.
name|junit
...
argument_list|()
decl_stmt|;
comment|// Create a RenewTarget consisting of a SecurityContextToken
name|TokenProviderResponse
...
expr_stmt|;
block|}
comment|/**      * Try to renew an invalid SecurityContextToken      */
annotation|@
name|org
operator|.
name|junit
