...
expr_stmt|;
block|}
comment|/**      * Renew an expired SAML1 Assertion without using the cache      */
annotation|@
name|org
operator|.
name|junit
...
specifier|public
name|void
name|renewExpiredSAML1AssertionNoCache
parameter_list|()
throws|throws
name|Exception
block|{
...
expr_stmt|;
block|}
comment|/**      * Renew an expired SAML2 Assertion without using the cache      */
annotation|@
name|org
operator|.
name|junit
...
specifier|public
name|void
name|renewExpiredSAML2AssertionNoCache
parameter_list|()
throws|throws
name|Exception
block|{
