...
expr_stmt|;
block|}
comment|/**      * Test a SAML 1.1 Assertion that is configured with the ClaimsAttributeStatementProvider,      * but does not contain any claims. In older versions of the STS, this generated an invalid      * SAML Assertion.      */
annotation|@
name|org
operator|.
name|junit
...
specifier|public
name|void
name|testSAML1AssertionWithClaims
parameter_list|()
throws|throws
name|Exception
block|{
...
specifier|public
name|void
name|testSAML2AssertionWithRolesNoCaching
parameter_list|()
throws|throws
name|Exception
block|{
...
specifier|public
name|void
name|testSAML2AssertionWithRolesCaching
parameter_list|()
throws|throws
name|Exception
block|{
...
expr_stmt|;
block|}
comment|/**      * Test an invalid SAML 2 Assertion      */
annotation|@
name|org
operator|.
name|junit
...
specifier|public
name|void
name|testInvalidSAML2Assertion
parameter_list|()
throws|throws
name|Exception
block|{
...
argument_list|)
expr_stmt|;
comment|// Replace "alice" with "bob".
name|Element
name|nameID
init|=
operator|(
...
specifier|public
name|void
name|testSAML2SubjectWithComment
parameter_list|()
throws|throws
name|Exception
block|{
