...
expr_stmt|;
block|}
comment|/**      * Test a SAML 1.1 Assertion with an invalid issuer      */
annotation|@
name|org
operator|.
name|junit
...
specifier|public
name|void
name|testInvalidIssuerSAML1Assertion
parameter_list|()
throws|throws
name|Exception
block|{
...
expr_stmt|;
block|}
comment|/**      * Test a SAML 2 Assertion with an invalid issuer      */
annotation|@
name|org
operator|.
name|junit
...
specifier|public
name|void
name|testInvalidIssuerSAML2Assertion
parameter_list|()
throws|throws
name|Exception
block|{
