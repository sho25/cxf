...
begin_comment
comment|/**  * Some unit tests for validating a SecurityContextToken via the SCTValidator.  */
end_comment

begin_class
specifier|public
class|class
name|SCTValidatorTest
extends|extends
name|org
operator|.
name|junit
...
specifier|public
name|void
name|testValidSecurityContextToken
parameter_list|()
throws|throws
name|Exception
block|{
...
argument_list|()
decl_stmt|;
comment|// Create a ValidateTarget consisting of a SecurityContextToken
name|TokenProviderResponse
...
expr_stmt|;
block|}
comment|/**      * Test an invalid SecurityContextToken      */
annotation|@
name|org
operator|.
name|junit
...
specifier|public
name|void
name|testInvalidSecurityContextToken
parameter_list|()
throws|throws
name|Exception
block|{
