...
begin_comment
comment|/**  * Issue JWT tokens on behalf of other tokens.  */
end_comment

begin_class
specifier|public
class|class
name|IssueJWTOnbehalfofUnitTest
extends|extends
name|org
operator|.
name|junit
...
argument_list|()
decl_stmt|;
comment|/**      * Test to successfully issue a JWT token on-behalf-of a SAML 2 token      */
annotation|@
name|org
operator|.
name|junit
...
specifier|public
name|void
name|testIssueJWTTokenOnBehalfOfSaml2
parameter_list|()
throws|throws
name|Exception
block|{
...
expr_stmt|;
block|}
comment|/**      * Test to successfully issue a JWT token on-behalf-of a UsernameToken      */
annotation|@
name|org
operator|.
name|junit
...
specifier|public
name|void
name|testIssueJWTTokenOnBehalfOfUsernameToken
parameter_list|()
throws|throws
name|Exception
block|{
...
expr_stmt|;
block|}
comment|/**      * Test to successfully issue a JWT Token (realm "B") on-behalf-of a SAML 2 token      * on-behalf-of token issued by realm "A".      */
annotation|@
name|org
operator|.
name|junit
...
specifier|public
name|void
name|testIssueJWTTokenOnBehalfOfSaml2DifferentRealm
parameter_list|()
throws|throws
name|Exception
block|{
