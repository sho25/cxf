...
begin_comment
comment|/**  * Some unit tests for the issue operation to issue SAML tokens in a specific realm.  */
end_comment

begin_class
specifier|public
class|class
name|IssueSamlRealmUnitTest
extends|extends
name|org
operator|.
name|junit
...
argument_list|()
decl_stmt|;
comment|/**      * Test to successfully issue a Saml 1.1 token in realm "A".      */
annotation|@
name|org
operator|.
name|junit
...
specifier|public
name|void
name|testIssueSaml1TokenRealmA
parameter_list|()
throws|throws
name|Exception
block|{
...
expr_stmt|;
block|}
comment|/**      * Test to successfully issue a Saml 1.1 token in realm "B".      */
annotation|@
name|org
operator|.
name|junit
...
specifier|public
name|void
name|testIssueSaml1TokenRealmB
parameter_list|()
throws|throws
name|Exception
block|{
...
expr_stmt|;
block|}
comment|/**      * Test to successfully issue a Saml 1.1 token in the default realm.      */
annotation|@
name|org
operator|.
name|junit
...
specifier|public
name|void
name|testIssueSaml1TokenDefaultRealm
parameter_list|()
throws|throws
name|Exception
block|{
...
expr_stmt|;
block|}
comment|/**      * Test to successfully issue a Saml 1.1 token in realm "B"      * using crypto definition in SAMLRealm      */
annotation|@
name|org
operator|.
name|junit
...
specifier|public
name|void
name|testIssueSaml1TokenRealmBCustomCrypto
parameter_list|()
throws|throws
name|Exception
block|{
...
argument_list|)
expr_stmt|;
comment|// Set signature properties in SAMLRealm B
name|Map
argument_list|<
name|String
argument_list|,
...
argument_list|)
decl_stmt|;
comment|// Issue a token - this will fail as the SAMLRealm configuration is inconsistent
...
expr_stmt|;
block|}
comment|/**      * Test to successfully issue a Saml 1.1 token in realm "B"      * using PKCS12 crypto definition with default key in SAMLRealm      */
annotation|@
name|org
operator|.
name|junit
...
specifier|public
name|void
name|testIssueSaml1TokenRealmBCustomCryptoPKCS12
parameter_list|()
throws|throws
name|Exception
block|{
...
expr_stmt|;
block|}
comment|/**      * Create some SAML Realms      */
specifier|private
name|Map
argument_list|<
name|String
