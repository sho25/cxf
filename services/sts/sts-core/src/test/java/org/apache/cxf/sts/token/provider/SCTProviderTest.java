...
begin_comment
comment|/**  * Some unit tests for creating SecurityContextTokens.  */
end_comment

begin_class
specifier|public
class|class
name|SCTProviderTest
extends|extends
name|org
operator|.
name|junit
...
expr_stmt|;
block|}
comment|/**      * Create a SecurityContextToken with a different namespace      */
annotation|@
name|org
operator|.
name|junit
...
specifier|public
name|void
name|testCreateSCTDifferentNamespace
parameter_list|()
throws|throws
name|Exception
block|{
...
expr_stmt|;
block|}
comment|/**      * Create a SecurityContextToken that returns (and doesn't return) Entropy      */
annotation|@
name|org
operator|.
name|junit
...
specifier|public
name|void
name|testCreateSCTReturnEntropy
parameter_list|()
throws|throws
name|Exception
block|{
...
expr_stmt|;
block|}
comment|/**      * Create a SecurityContextToken and test that it's stored in the cache      */
annotation|@
name|org
operator|.
name|junit
...
expr_stmt|;
block|}
comment|/**      * Create a SecurityContextToken and test the KeySize      */
annotation|@
name|org
operator|.
name|junit
...
argument_list|)
expr_stmt|;
comment|// Test a bad KeySize - it will just use the default keysize
name|keyRequirements
operator|.
name|setKeySize
argument_list|(
