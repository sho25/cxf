...
begin_comment
comment|/**  * Some unit tests for the issue operation to issue JWT tokens with Claims information.  */
end_comment

begin_class
specifier|public
class|class
name|IssueJWTClaimsUnitTest
extends|extends
name|org
operator|.
name|junit
...
argument_list|)
decl_stmt|;
comment|/**      * Test to successfully issue a JWT token.      */
annotation|@
name|org
operator|.
name|junit
...
expr_stmt|;
block|}
comment|/**      * Test to successfully issue a SAML 2 token (realm "B") on-behalf-of a SAML 2 token      * which was issued by realm "A".      * The relationship type between realm A and B is: FederateClaims      * TODO      */
annotation|@
name|org
operator|.
name|junit
...
expr_stmt|;
block|}
comment|/**      * Test to successfully issue a SAML 2 token (realm "B") on-behalf-of a SAML 2 token      * which was issued by realm "A".      * The relationship type between realm A and B is: FederateIdentity      * IdentityMapper is configured globally in STSPropertiesMBean      * TODO      */
annotation|@
name|org
operator|.
name|junit
...
expr_stmt|;
block|}
comment|/**      * Test to successfully issue a SAML 2 token (realm "B") on-behalf-of a SAML 2 token      * which was issued by realm "A".      * The relationship type between realm A and B is: FederateIdentity      * IdentityMapper is configured in the Relationship      * TODO      */
annotation|@
name|org
operator|.
name|junit
