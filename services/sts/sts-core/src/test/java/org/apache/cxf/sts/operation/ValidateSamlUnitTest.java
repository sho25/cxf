...
begin_comment
comment|/**  * Some unit tests for the validate operation to validate SAML tokens.  */
end_comment

begin_class
specifier|public
class|class
name|ValidateSamlUnitTest
extends|extends
name|org
operator|.
name|junit
...
argument_list|()
decl_stmt|;
comment|/**      * Test to successfully validate a Saml 1.1 token.      */
annotation|@
name|org
operator|.
name|junit
...
expr_stmt|;
block|}
comment|/**      * Test to successfully validate a Saml 2 token.      */
annotation|@
name|org
operator|.
name|junit
