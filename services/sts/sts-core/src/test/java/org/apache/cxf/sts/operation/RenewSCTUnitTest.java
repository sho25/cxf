...
begin_comment
comment|/**  * Some unit tests for the renew operation to renew SecurityContextTokens.  */
end_comment

begin_class
specifier|public
class|class
name|RenewSCTUnitTest
extends|extends
name|org
operator|.
name|junit
...
argument_list|()
decl_stmt|;
comment|/**      * Test to successfully renew a SecurityContextToken      */
annotation|@
name|org
operator|.
name|junit
...
return|;
block|}
comment|/**      * Return true if the response has a valid RequestedSecurityToken element, false otherwise      */
specifier|private
name|boolean
name|validateResponse
parameter_list|(
