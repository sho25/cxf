...
expr_stmt|;
block|}
comment|/**      * Test to successfully issue a Saml 2 token, submitting an AppliesTo URI Element, instead      * of the usual EPR one.      */
annotation|@
name|org
operator|.
name|junit
...
specifier|public
name|void
name|testIssueSaml2AppliesToURIToken
parameter_list|()
throws|throws
name|Exception
block|{
...
name|add
argument_list|(
name|createAppliesToURIElement
argument_list|(
literal|"http://dummy-service.com/dummy"
argument_list|)
argument_list|)
