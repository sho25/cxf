...
specifier|public
name|void
name|testDefaultSaml1OnBehalfOfUsernameToken
parameter_list|()
throws|throws
name|Exception
block|{
...
expr_stmt|;
block|}
comment|/**      * Create a default Saml2 Bearer Assertion with OnBehalfOf from a SAML Assertion      */
annotation|@
name|org
operator|.
name|junit
...
specifier|public
name|void
name|testDefaultSaml2OnBehalfOfAssertion
parameter_list|()
throws|throws
name|Exception
block|{
...
expr_stmt|;
block|}
comment|/**      * Create a Saml1 Bearer Assertion with OnBehalfOf from a UsernameToken. The SAMLTokenProvider is      * configured with a custom Attribute Provider that instead creates a "CustomOnBehalfOf" attribute.      */
annotation|@
name|org
operator|.
name|junit
