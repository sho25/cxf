...
expr_stmt|;
block|}
comment|/**      *      * As specified in ws-trust      * "If this attribute isn't specified, then the current time is used as an initial period."      * if creation time is not specified, we use current time instead.      *      */
annotation|@
name|org
operator|.
name|junit
...
specifier|public
name|void
name|saml2LifetimeWithoutCreated
parameter_list|()
throws|throws
name|WSSecurityException
block|{
