...
begin_comment
comment|/**  * Some unit tests for renewing SAML Tokens with lifetime  */
end_comment

begin_class
specifier|public
class|class
name|SAMLTokenRenewerLifetimeTest
extends|extends
name|org
operator|.
name|junit
...
expr_stmt|;
block|}
comment|/**      * Renew SAML 2 token with a valid requested lifetime      */
annotation|@
name|org
operator|.
name|junit
...
expr_stmt|;
block|}
comment|/**      * Renew SAML 2 token with a lifetime configured in SAMLTokenProvider      * No specific lifetime requested      */
annotation|@
name|org
operator|.
name|junit
...
expr_stmt|;
block|}
comment|/**      * Renew SAML 2 token with a with a lifetime      * which exceeds configured maximum lifetime      */
annotation|@
name|org
operator|.
name|junit
...
block|}
block|}
comment|/**      * Renew SAML 2 token with a with a lifetime      * which exceeds default maximum lifetime      */
annotation|@
name|org
operator|.
name|junit
...
block|}
block|}
comment|/**      * Renew SAML 2 token with a with a lifetime      * which exceeds configured maximum lifetime      * Lifetime reduced to maximum lifetime      */
annotation|@
name|org
operator|.
name|junit
