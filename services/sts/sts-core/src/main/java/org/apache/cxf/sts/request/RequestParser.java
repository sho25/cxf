...
name|target
init|=
name|fetchTokenElementFromReference
argument_list|(
name|validateTarget
operator|.
name|getToken
...
name|fine
argument_list|(
literal|"Found X509Certificate UseKey type via reference"
argument_list|)
expr_stmt|;
block|}
catch|catch
...
name|WARNING
argument_list|,
literal|"No ClaimsParser is registered for dialect "
operator|+
name|dialect
argument_list|)
expr_stmt|;
...
name|WARNING
argument_list|,
literal|"No Reference URI was received"
argument_list|)
expr_stmt|;
throw|throw
operator|new
