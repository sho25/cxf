...
name|fine
argument_list|(
literal|"Received token is DOM element: "
operator|+
name|receivedToken
operator|.
name|isDOMElement
...
name|WARNING
argument_list|,
literal|"Failed to parse OnBehalfOf element"
argument_list|,
name|e
argument_list|)
expr_stmt|;
...
name|STSException
argument_list|(
literal|"Unknown OnBehalfOf element"
argument_list|,
name|STSException
operator|.
name|REQUEST_FAILED
...
block|}
block|}
comment|/**      * Create a KeyInfoBean that contains an X.509 certificate.      */
specifier|private
specifier|static
name|KeyInfoBean
name|createKeyInfo
