...
specifier|public
name|void
name|testRenewSecurityContextToken
parameter_list|()
throws|throws
name|Exception
block|{
...
argument_list|)
expr_stmt|;
comment|// Renew the SecurityContextToken - this should fail as the secret associated with the SCT
...
name|fail
argument_list|(
literal|"Failure expected on no proof-of-possession"
argument_list|)
expr_stmt|;
block|}
catch|catch
