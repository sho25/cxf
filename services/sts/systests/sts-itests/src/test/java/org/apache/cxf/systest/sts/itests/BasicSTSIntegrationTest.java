...
comment|//KarafDistributionOption.debugConfiguration(), // nor this
comment|//KarafDistributionOption.logLevel(LogLevelOption.LogLevel.INFO),
name|features
argument_list|(
name|maven
argument_list|(
...
argument_list|,
literal|"cxf-services-sts-systests-osgi"
argument_list|)
operator|.
name|versionAsInProject
argument_list|()
