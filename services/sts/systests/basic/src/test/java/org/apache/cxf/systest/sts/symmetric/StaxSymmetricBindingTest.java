...
begin_comment
comment|/**  * Test the Symmetric binding. The CXF client gets a token from the STS by authenticating via a  * Username Token over the symmetric binding, and then sends it to the CXF endpoint using   * the symmetric binding.  *   * It tests both DOM + StAX clients against the StAX server  */
end_comment

begin_class
specifier|public
class|class
name|StaxSymmetricBindingTest
extends|extends
name|AbstractBusClientServerTestBase
block|{
specifier|static
...
argument_list|)
expr_stmt|;
comment|// doubleIt(symmetricSaml1Port, 25);
operator|(
operator|(
name|java
operator|.
