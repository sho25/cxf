...
begin_comment
comment|/**  * Test the Asymmetric binding. The CXF client gets a token from the STS by authenticating via a  * Username Token over the symmetric binding, and then sends it to the CXF endpoint using   * the asymmetric binding.  *   * It tests both DOM + StAX clients against the StAX server  */
end_comment

begin_class
specifier|public
class|class
name|StaxAsymmetricBindingTest
extends|extends
name|AbstractBusClientServerTestBase
block|{
specifier|static
...
argument_list|)
expr_stmt|;
comment|// doubleIt(asymmetricSaml1EncryptedPort, 25);
operator|(
operator|(
name|java
operator|.
