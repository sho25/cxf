...
specifier|public
name|void
name|testIntermediaryTransformation
parameter_list|()
throws|throws
name|Exception
block|{
...
specifier|public
name|void
name|testIntermediaryTransformationBadClient
parameter_list|()
throws|throws
name|Exception
block|{
...
name|fail
argument_list|(
literal|"Expected failure on a bad user"
argument_list|)
expr_stmt|;
block|}
catch|catch
