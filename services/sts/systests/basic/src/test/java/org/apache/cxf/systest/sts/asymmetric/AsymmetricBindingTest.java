...
begin_comment
comment|/**  * Test the Asymmetric binding. The CXF client gets a token from the STS by authenticating via a  * Username Token over the symmetric binding, and then sends it to the CXF endpoint using   * the asymmetric binding.  *   * It tests both DOM + StAX clients against the DOM server  */
end_comment
