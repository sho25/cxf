...
argument_list|)
expr_stmt|;
comment|//the subscription is expired so can't get the notification
name|subscription
operator|.
name|renew
argument_list|(
...
argument_list|)
expr_stmt|;
comment|//renew another 60 sec to resend the notification
synchronized|synchronized
init|(
name|callback
operator|.
...
specifier|public
name|void
name|testPullPointWithQueueName
parameter_list|()
throws|throws
name|Exception
block|{
