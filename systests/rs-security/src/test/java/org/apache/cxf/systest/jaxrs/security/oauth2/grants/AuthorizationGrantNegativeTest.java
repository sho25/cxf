...
expr_stmt|;
block|}
comment|// The redirect URI if in the authz request, must be in the token request and must match
annotation|@
name|org
operator|.
name|junit
...
specifier|public
name|void
name|testNonMatchingRedirectURI
parameter_list|()
throws|throws
name|Exception
block|{
...
literal|"redirect_uri"
argument_list|,
literal|"http://www.bad.blah.apache.org"
argument_list|)
expr_stmt|;
name|Response
name|response
...
name|fail
argument_list|(
literal|"Failure expected on not sending the correct redirect URI"
argument_list|)
expr_stmt|;
block|}
catch|catch
...
block|}
block|}
comment|// Here we get a code for "consumer-id" but specify "consumer-id-aud" as the clientId in the
comment|// token request (but authenticate as "consumer-id").
annotation|@
name|org
operator|.
name|junit
...
specifier|public
name|void
name|testNonMatchingClientIdIgnored
parameter_list|()
throws|throws
name|Exception
block|{
...
block|}
block|}
comment|// We shouldn't be able to get a refresh token using the implicit grant
annotation|@
name|org
operator|.
name|junit
