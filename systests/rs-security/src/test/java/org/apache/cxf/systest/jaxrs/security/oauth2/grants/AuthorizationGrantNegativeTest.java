...
begin_comment
comment|/**  * Some (negative) tests for various authorization grants. The tests are run multiple times with different  * OAuthDataProvider implementations:  * a) PORT - EhCache  * b) JWT_PORT - EhCache with useJwtFormatForAccessTokens enabled  * c) JCACHE_PORT - JCache  * d) JWT_JCACHE_PORT - JCache with useJwtFormatForAccessTokens enabled  * e) JPA_PORT - JPA provider  * f) JWT_NON_PERSIST_JCACHE_PORT-  JCache with useJwtFormatForAccessTokens + !persistJwtEncoding  */
end_comment
...
name|getPortNumber
argument_list|(
literal|"jaxrs-oauth2-grants-negative"
argument_list|)
decl_stmt|;
specifier|public
specifier|static
...
name|getPortNumber
argument_list|(
literal|"jaxrs-oauth2-grants2-negative"
argument_list|)
decl_stmt|;
specifier|public
specifier|static
...
name|getPortNumber
argument_list|(
literal|"jaxrs-oauth2-grants-negative-jwt"
argument_list|)
decl_stmt|;
specifier|public
specifier|static
...
name|getPortNumber
argument_list|(
literal|"jaxrs-oauth2-grants2-negative-jwt"
argument_list|)
decl_stmt|;
specifier|public
specifier|static
...
name|getResource
argument_list|(
literal|"grants-negative-server.xml"
argument_list|)
decl_stmt|;
specifier|protected
name|void
