...
begin_comment
comment|/**  * Some unit tests for the UserInfo Service in OpenId Connect. This can be used to return the User's claims given  * an access token. The tests are run multiple times with different OAuthDataProvider implementations:  * a) JCACHE_SERVER - JCache  * b) JWT_JCACHE_SERVER - JCache with useJwtFormatForAccessTokens enabled  * c) JPA_SERVER - JPA provider  * d) JWT_NON_PERSIST_JCACHE_SERVER-  JCache with useJwtFormatForAccessTokens + !persistJwtEncoding  */
end_comment
...
name|SpringBusTestServer
argument_list|(
literal|"userinfo-server-jcache"
argument_list|)
decl_stmt|;
specifier|private
specifier|static
...
name|SpringBusTestServer
argument_list|(
literal|"userinfo-server-jcache-jwt"
argument_list|)
decl_stmt|;
specifier|private
specifier|static
...
name|SpringBusTestServer
argument_list|(
literal|"userinfo-server-jcache-jwt-non-persist"
argument_list|)
decl_stmt|;
specifier|final
name|String
