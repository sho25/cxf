...
argument_list|)
decl_stmt|;
comment|//CreateDigestInterceptor digestFilter = new CreateDigestInterceptor();
name|String
name|address
init|=
...
name|client
init|=
comment|// WebClient.create(address, Collections.singletonList(digestFilter), busFile.toString());
name|WebClient
operator|.
name|create
argument_list|(
