...
name|PORT
operator|+
literal|"/httpsigrequired/bookstore/books"
decl_stmt|;
name|client
operator|=
name|WebClient
...
specifier|public
name|void
name|testHttpSignatureDigestResponse
parameter_list|()
throws|throws
name|Exception
block|{
...
name|fail
argument_list|(
literal|"Failure expected on no digest"
argument_list|)
expr_stmt|;
block|}
catch|catch
...
specifier|public
name|void
name|testHttpSignatureDigestSHA512
parameter_list|()
throws|throws
name|Exception
block|{
...
specifier|public
name|void
name|testHttpSignatureEmptyResponse
parameter_list|()
throws|throws
name|Exception
block|{
...
name|PORT
operator|+
literal|"/httpsigresponse/bookstore/booksnoresp"
decl_stmt|;
name|WebClient
name|client
init|=
...
specifier|public
name|void
name|testHttpSignatureEmptyResponseProps
parameter_list|()
throws|throws
name|Exception
block|{
...
specifier|public
name|void
name|testMissingSignedDigestHeader
parameter_list|()
throws|throws
name|Exception
block|{
