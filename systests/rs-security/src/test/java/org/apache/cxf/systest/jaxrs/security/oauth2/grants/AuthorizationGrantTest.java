...
begin_comment
comment|/**  * Some tests for various authorization grants. The tests are run multiple times with different OAuthDataProvider  * implementations:  * a) PORT - EhCache  * b) JWT_PORT - EhCache with useJwtFormatForAccessTokens enabled  * c) JCACHE_PORT - JCache  * d) JWT_JCACHE_PORT - JCache with useJwtFormatForAccessTokens enabled  */
end_comment
