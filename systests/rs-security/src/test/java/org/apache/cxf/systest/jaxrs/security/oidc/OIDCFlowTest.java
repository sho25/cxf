...
begin_comment
comment|/**  * Some unit tests to test the various flows in OpenID Connect. The tests are run multiple times  * with different OAuthDataProvider implementations:  * a) PORT - EhCache  * b) JWT_PORT - EhCache with useJwtFormatForAccessTokens enabled  * c) JCACHE_PORT - JCache  * d) JWT_JCACHE_PORT - JCache with useJwtFormatForAccessTokens enabled  * e) JPA_PORT - JPA provider  * f) JWT_NON_PERSIST_JCACHE_PORT-  JCache with useJwtFormatForAccessTokens + !persistJwtEncoding  */
end_comment
...
name|getPortNumber
argument_list|(
literal|"jaxrs-oidc-jcache-jwt-non-persist"
argument_list|)
decl_stmt|;
specifier|final
name|String
...
name|launchServer
argument_list|(
name|OIDCServerJCacheJWTNonPersist
operator|.
name|class
argument_list|,
literal|true
...
name|getResource
argument_list|(
literal|"oidc-server-jcache.xml"
argument_list|)
decl_stmt|;
specifier|protected
name|void
...
name|getResource
argument_list|(
literal|"oidc-server-jcache-jwt.xml"
argument_list|)
decl_stmt|;
specifier|protected
name|void
...
name|getResource
argument_list|(
literal|"oidc-server-jcache-jwt-non-persist.xml"
argument_list|)
decl_stmt|;
specifier|protected
name|void
