...
begin_comment
comment|/**  * Some negative tests for OpenID Connect. The tests are run multiple times with different OAuthDataProvider  * implementations:  * a) PORT - EhCache  * b) JWT_PORT - EhCache with useJwtFormatForAccessTokens enabled  * c) JCACHE_PORT - JCache  * d) JWT_JCACHE_PORT - JCache with useJwtFormatForAccessTokens enabled  * e) JPA_PORT - JPA provider  * f) JWT_NON_PERSIST_JCACHE_PORT-  JCache with useJwtFormatForAccessTokens + !persistJwtEncoding  */
end_comment
...
name|getPortNumber
argument_list|(
literal|"jaxrs-negative-oidc-jwt"
argument_list|)
decl_stmt|;
specifier|static
specifier|final
...
name|getResource
argument_list|(
literal|"oidc-negative-server-jwt.xml"
argument_list|)
decl_stmt|;
specifier|protected
name|void
