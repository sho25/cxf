...
begin_comment
comment|/**  * A set of tests for SAML Tokens using the streaming interceptors.  */
end_comment
...
expr_stmt|;
block|}
comment|// NPE in outbound DOM because of SignatureConfirmation - should be fixed with StaX out
annotation|@
name|org
operator|.
name|junit
