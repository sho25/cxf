...
expr_stmt|;
block|}
comment|// Switch to the StAX stack
name|SecurityTestUtil
operator|.
...
parameter_list|)
block|{
comment|// TODO assertTrue(ex.getMessage().contains("This is a fault"));
block|}
operator|(
operator|(
name|java
...
specifier|public
name|void
name|testUnsecuredSoap11Action
parameter_list|()
throws|throws
name|Exception
block|{
...
name|NAMESPACE
argument_list|,
literal|"DoubleItSoap11UnsecuredPort"
argument_list|)
decl_stmt|;
name|DoubleItPortType
name|utPort
...
specifier|public
name|void
name|testUnsecuredSoap11ActionStAX
parameter_list|()
throws|throws
name|Exception
block|{
...
name|NAMESPACE
argument_list|,
literal|"DoubleItSoap11UnsecuredPort2"
argument_list|)
decl_stmt|;
name|DoubleItPortType
name|utPort
