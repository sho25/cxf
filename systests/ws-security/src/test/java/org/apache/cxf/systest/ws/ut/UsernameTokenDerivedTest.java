...
specifier|public
name|void
name|testSymmetricProtectionSignatureToken
parameter_list|()
throws|throws
name|Exception
block|{
...
name|getResource
argument_list|(
literal|"DoubleItUtDerived.wsdl"
argument_list|)
decl_stmt|;
name|Service
name|service
...
name|NAMESPACE
argument_list|,
literal|"DoubleItSymmetricProtectionSigPort"
argument_list|)
decl_stmt|;
name|DoubleItPortType
name|utPort
...
specifier|public
name|void
name|testSymmetricProtectionSignatureDKToken
parameter_list|()
throws|throws
name|Exception
block|{
...
name|NAMESPACE
argument_list|,
literal|"DoubleItSymmetricProtectionSigDKPort"
argument_list|)
decl_stmt|;
name|DoubleItPortType
name|utPort
...
specifier|public
name|void
name|testSymmetricProtectionEncryptionToken
parameter_list|()
throws|throws
name|Exception
block|{
...
name|NAMESPACE
argument_list|,
literal|"DoubleItSymmetricProtectionEncPort"
argument_list|)
decl_stmt|;
name|DoubleItPortType
name|utPort
...
expr_stmt|;
block|}
comment|/**      * Here the key derived from a UsernameToken is used to sign the message signature over the      * Symmetric binding. The UsernameToken is signed.      */
annotation|@
name|org
operator|.
name|junit
...
specifier|public
name|void
name|testSymmetricSignedEndorsing
parameter_list|()
throws|throws
name|Exception
block|{
...
name|NAMESPACE
argument_list|,
literal|"DoubleItSymmetricSignedEndorsingPort"
argument_list|)
decl_stmt|;
name|DoubleItPortType
name|utPort
...
specifier|public
name|void
name|testSymmetricSignedEndorsingEncrypted
parameter_list|()
throws|throws
name|Exception
block|{
...
name|NAMESPACE
argument_list|,
literal|"DoubleItSymmetricSignedEndorsingEncryptedPort"
argument_list|)
decl_stmt|;
name|DoubleItPortType
name|utPort
