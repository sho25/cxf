...
begin_comment
comment|/**  * A set of tests for Username Tokens over the Transport Binding. The client is using  * DOM and the service is using StAX.  */
end_comment
...
specifier|public
class|class
name|DOMToStaxUsernameTokenTest
extends|extends
name|AbstractBusClientServerTestBase
block|{
specifier|static
