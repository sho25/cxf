...
expr_stmt|;
block|}
comment|// Re-enable once we pick up WSS4J 2.2.3 (https://issues.apache.org/jira/browse/WSS-640)
annotation|@
name|org
operator|.
name|junit
...
specifier|public
name|void
name|testSaml2OverSymmetricSoap12
parameter_list|()
throws|throws
name|Exception
block|{
...
name|NAMESPACE
argument_list|,
literal|"DoubleItSaml2SymmetricSoap12Port"
argument_list|)
decl_stmt|;
name|DoubleItPortType
name|saml2Port
...
specifier|public
name|void
name|testAsymmetricSamlInitiatorProtectTokens
parameter_list|()
throws|throws
name|Exception
block|{
comment|// We don't support ProtectTokens + streaming clients
if|if
condition|(
name|test
operator|.
...
name|NAMESPACE
argument_list|,
literal|"DoubleItAsymmetricSamlInitiatorProtectTokensPort"
argument_list|)
decl_stmt|;
name|DoubleItPortType
name|saml2Port
...
argument_list|)
expr_stmt|;
comment|// It should pass because we explicitly allow the given audience restriction
name|portQName
operator|=
operator|new
name|QName
...
name|NAMESPACE
argument_list|,
literal|"DoubleItSaml2TransportPort4"
argument_list|)
expr_stmt|;
name|saml2Port
operator|=
...
specifier|public
name|void
name|testSaml2DifferentAlgorithms
parameter_list|()
throws|throws
name|Exception
block|{
