...
begin_comment
comment|/**  * A set of tests for the HttpsToken policy.  */
end_comment
...
specifier|public
name|void
name|testNoClientCertRequirement
parameter_list|()
throws|throws
name|Exception
block|{
...
name|NAMESPACE
argument_list|,
literal|"DoubleItNoClientCertRequirementPort"
argument_list|)
decl_stmt|;
name|DoubleItPortType
name|port
...
name|fail
argument_list|(
literal|"(Policy) Failure expected on not using a client cert"
argument_list|)
expr_stmt|;
block|}
catch|catch
...
comment|// expected
block|}
comment|// This should work, as we're disable the RequireClientCertificate check via a
comment|// JAX-WS property
name|portQName
operator|=
operator|new
name|QName
...
name|NAMESPACE
argument_list|,
literal|"DoubleItNoClientCertRequirementPort2"
argument_list|)
expr_stmt|;
name|port
operator|=
...
name|NAMESPACE
argument_list|,
literal|"DoubleItNoChildPolicyPort"
argument_list|)
decl_stmt|;
name|DoubleItPortType
name|port
