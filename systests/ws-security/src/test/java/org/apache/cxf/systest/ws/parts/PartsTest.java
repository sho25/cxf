...
begin_comment
comment|/**  * This is a test for various Required/Signed/Encrypted Parts/Elements. It tests both DOM + StAX   * clients against the DOM server  */
end_comment
...
name|error
init|=
literal|"RequiredParts: No header element"
decl_stmt|;
name|assertTrue
argument_list|(
name|ex
...
name|NAMESPACE
argument_list|,
literal|"DoubleItRequiredElementsPort"
argument_list|)
decl_stmt|;
name|DoubleItPortType
name|port
...
name|NAMESPACE
argument_list|,
literal|"DoubleItRequiredElementsPort2"
argument_list|)
expr_stmt|;
name|port
operator|=
...
name|error
init|=
literal|"RequiredElements: No header element"
decl_stmt|;
name|assertTrue
argument_list|(
name|ex
...
name|NAMESPACE
argument_list|,
literal|"DoubleItSignedElementsPort"
argument_list|)
decl_stmt|;
name|DoubleItPortType
name|port
...
name|NAMESPACE
argument_list|,
literal|"DoubleItSignedElementsPort2"
argument_list|)
expr_stmt|;
name|port
operator|=
...
name|NAMESPACE
argument_list|,
literal|"DoubleItEncryptedElementsPort"
argument_list|)
decl_stmt|;
name|DoubleItPortType
name|port
...
name|NAMESPACE
argument_list|,
literal|"DoubleItEncryptedElementsPort2"
argument_list|)
expr_stmt|;
name|port
operator|=
...
name|NAMESPACE
argument_list|,
literal|"DoubleItContentEncryptedElementsPort2"
argument_list|)
expr_stmt|;
name|port
operator|=
...
name|NAMESPACE
argument_list|,
literal|"DoubleItSignedAttachmentsPort"
argument_list|)
decl_stmt|;
name|DoubleItSwaPortType
name|port
...
comment|// This should fail, as the service requires that the Attachments must be signed
name|portQName
operator|=
operator|new
name|QName
...
name|NAMESPACE
argument_list|,
literal|"DoubleItSignedAttachmentsPort2"
argument_list|)
expr_stmt|;
name|port
operator|=
...
name|fail
argument_list|(
literal|"Failure expected on an attachment which isn't signed"
argument_list|)
expr_stmt|;
block|}
catch|catch
...
expr_stmt|;
block|}
comment|/*         // Streaming         try {             SecurityTestUtil.enableStreaming(port);             port.doubleIt(25);             fail("Failure expected on a body which isn't signed");         } catch (javax.xml.ws.soap.SOAPFaultException ex) {             // String error = "SignedParts";             // assertTrue(ex.getMessage().contains(error));         }         */
operator|(
operator|(
name|java
operator|.
...
name|NAMESPACE
argument_list|,
literal|"DoubleItEncryptedAttachmentsPort"
argument_list|)
decl_stmt|;
name|DoubleItSwaPortType
name|port
...
comment|// SecurityTestUtil.enableStreaming(port);
comment|// port.doubleIt(25);
comment|// This should fail, as the service requires that the Attachments must be encrypted
name|portQName
operator|=
operator|new
name|QName
...
name|NAMESPACE
argument_list|,
literal|"DoubleItEncryptedAttachmentsPort2"
argument_list|)
expr_stmt|;
name|port
operator|=
...
name|fail
argument_list|(
literal|"Failure expected on an attachment which isn't encrypted"
argument_list|)
expr_stmt|;
block|}
catch|catch
