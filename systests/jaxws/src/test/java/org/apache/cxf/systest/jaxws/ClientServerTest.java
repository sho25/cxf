...
name|fail
argument_list|(
literal|"Should have thrown SOAPFaultException exception"
argument_list|)
expr_stmt|;
block|}
catch|catch
...
name|assertEquals
argument_list|(
literal|"TestIllegalArgumentException"
argument_list|,
name|sfe
operator|.
name|getCause
...
argument_list|)
decl_stmt|;
comment|// just testing that GZIP is not enabled by default
name|httpConnection
operator|.
...
name|PORT
operator|+
literal|"/SoapContext/SoapPortWithGzip?wsdl"
decl_stmt|;
name|HttpURLConnection
name|httpConnection
init|=
...
name|PUB_PORT
operator|+
literal|"/DocLitWrappedCodeFirstService/?wsdl"
argument_list|)
decl_stmt|;
name|InputStream
name|ins
...
specifier|public
name|void
name|testEchoProviderAsyncDecoupledEndpoints
parameter_list|()
throws|throws
name|Exception
block|{
...
name|CLIENT_PORT
operator|+
literal|"/SoapContext/AsyncEchoClient"
argument_list|)
expr_stmt|;
name|StreamSource
name|request
