...
specifier|public
name|void
name|testSOAPMessageModeDocLitWithSchemaValidation
parameter_list|()
throws|throws
name|Exception
block|{
...
name|greetMe
argument_list|(
literal|"this is a greetMe message which length is more "
operator|+
literal|"than 30 so that I wanna a schema validation error"
argument_list|)
expr_stmt|;
name|fail
argument_list|(
