...
expr_stmt|;
block|}
comment|//This test will pass/fail completely dependent on the versions of JAXB picked up and what
comment|//version of Xerces is picked up.  Newer versions of JAXB will generate "--11Z" (correct per XMLSchema)
comment|//older version will generate "--11--Z".  Xerces will only parse "--11--Z".  The parser in the JDK
comment|//will depend on the JDK version used.
comment|/*         GMonthTest gm = new GMonthTest();         XMLGregorianCalendar dt = DatatypeFactory.newInstance().newXMLGregorianCalendarDate(2010, 11, 16, 0);         gm.setValue(dt);         GMonthTest gm2 = port.echoGMonthTest(gm);         assertEquals(gm.getValue().getMonth(), gm2.getValue().getMonth());         */
block|}
annotation|@
name|Test
specifier|public
...
specifier|public
name|void
name|testWrappedHolderOutNull
parameter_list|()
throws|throws
name|Exception
block|{
comment|// this test to verify CXF-3836 works
name|QName
name|portName
init|=
operator|new
...
specifier|public
name|void
name|testSimpleClientWithWsdlAndBindingId
parameter_list|()
throws|throws
name|Exception
block|{
...
name|ServerMisc
operator|.
name|DOCLIT_CODEFIRST_URL_XMLBINDING
operator|+
literal|"?wsdl"
argument_list|)
expr_stmt|;
...
name|contains
argument_list|(
literal|"NoName is not a valid name"
argument_list|)
argument_list|)
expr_stmt|;
block|}
...
specifier|public
name|void
name|testDynamicClientExceptions
parameter_list|()
throws|throws
name|Exception
block|{
...
argument_list|,
literal|"SOAPHeaderServiceImplService"
argument_list|)
decl_stmt|;
name|Service
name|service
