...
argument_list|)
decl_stmt|;
comment|//message is "one way", but there really isn't a way for us to know that
comment|//as we don't have a wsdl or other source of operation information to
comment|//compare the payload to.
name|InputStream
name|is1
init|=
name|getClass
...
name|getResourceAsStream
argument_list|(
literal|"resources/GreetMe1WDocLiteralReq2.xml"
argument_list|)
decl_stmt|;
name|SOAPMessage
name|soapReqMsg1
...
specifier|public
name|void
name|testJAXBObjectPAYLOADFromEPR
parameter_list|()
throws|throws
name|Exception
block|{
...
specifier|public
name|void
name|testSAXSourceMESSAGEWithSchemaValidation
parameter_list|()
throws|throws
name|Exception
block|{
...
name|getResource
argument_list|(
literal|"/org/apache/cxf/systest/provider/hello_world_with_restriction.wsdl"
argument_list|)
decl_stmt|;
name|assertNotNull
argument_list|(
...
name|getResourceAsStream
argument_list|(
literal|"resources/GreetMeDocLiteralReqWithExceedMaxLength.xml"
argument_list|)
expr_stmt|;
name|inputSource
operator|=
...
specifier|public
name|void
name|testStreamSourcePAYLOADWithSchemaValidation
parameter_list|()
throws|throws
name|Exception
block|{
...
name|getResourceAsStream
argument_list|(
literal|"resources/GreetMeDocLiteralSOAPBodyReqExceedMaxLength.xml"
argument_list|)
decl_stmt|;
name|StreamSource
name|streamSourceReq
