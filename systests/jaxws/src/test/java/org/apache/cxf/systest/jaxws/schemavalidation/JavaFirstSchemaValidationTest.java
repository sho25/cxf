...
begin_comment
comment|/**  * TODO - test where the default is NONE at the service level test where the default is IN or OUT, and then  * override at operation levels  */
end_comment
...
parameter_list|)
block|{
comment|// verify its server side and a schema validation
name|assertTrue
argument_list|(
name|sfe
operator|.
...
expr_stmt|;
block|}
comment|// no validation is required for incoming
annotation|@
name|Test
specifier|public
name|void
name|testSaveValidationOutAnnotated
parameter_list|()
block|{
name|Person
name|person
...
argument_list|)
expr_stmt|;
comment|// ensure all client schema validation is disabled
name|Map
argument_list|<
name|String
argument_list|,
