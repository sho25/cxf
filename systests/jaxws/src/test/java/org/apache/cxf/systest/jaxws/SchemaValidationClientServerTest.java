...
name|setHeaderValue
argument_list|(
literal|"AABBCCDDEEFFGGHHIIJJ"
argument_list|)
expr_stmt|;
comment|//Check if incoming validation on server side works, turn off outgoing
name|greeter
operator|.
name|ckR
argument_list|(
...
name|contains
argument_list|(
literal|"is not facet-valid with respect to maxLength"
argument_list|)
argument_list|)
expr_stmt|;
block|}
...
name|contains
argument_list|(
literal|"Could not validate soapheader "
argument_list|)
argument_list|)
expr_stmt|;
name|boolean
