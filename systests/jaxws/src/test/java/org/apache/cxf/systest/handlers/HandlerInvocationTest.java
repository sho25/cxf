...
argument_list|)
expr_stmt|;
comment|//CXF-3956 - check to make sure a Dispatch can also get the handlers
name|JAXBContext
name|context
init|=
name|JAXBContext
...
specifier|public
name|void
name|testLogicHandlerHandleMessageReturnFalseServerOutbound
parameter_list|()
throws|throws
name|PingException
block|{
...
init|=
block|{
literal|"server handler1 outbound stop"
block|,
literal|"soapHandler4"
block|,
literal|"soapHandler3"
...
specifier|public
name|void
name|testMustUnderstandSoapFaultOneWay
parameter_list|()
block|{
...
name|fail
argument_list|(
literal|"Catch unexpected exception: soap faule message "
operator|+
literal|"should not be returned for one way operation"
argument_list|)
expr_stmt|;
block|}
block|}
...
specifier|public
name|void
name|testHandlerMessgeContext
parameter_list|()
throws|throws
name|PingException
block|{
name|MessageContextFirstHandler
name|handler1
init|=
operator|new
name|MessageContextFirstHandler
...
name|assertNotNull
argument_list|(
literal|"handler2 can't retrieve header map from message context"
argument_list|,
name|handler2
operator|.
name|getHeaderMap
