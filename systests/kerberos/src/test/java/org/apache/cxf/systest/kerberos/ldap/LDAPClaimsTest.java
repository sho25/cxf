...
specifier|public
name|void
name|testRetrieveClaimsUsingLDAPLookup
parameter_list|()
throws|throws
name|Exception
block|{
...
name|CustomTokenPrincipal
argument_list|(
literal|"cn=alice,ou=users,dc=example,dc=com"
argument_list|)
argument_list|)
expr_stmt|;
name|ProcessedClaimCollection
...
specifier|public
name|void
name|testRetrieveRolesForAlice
parameter_list|()
throws|throws
name|Exception
block|{
...
name|getBean
argument_list|(
literal|"testGroupClaimsHandler"
argument_list|)
decl_stmt|;
name|String
name|user
...
specifier|public
name|void
name|testRetrieveRolesForAliceUsingLDAPLookup
parameter_list|()
throws|throws
name|Exception
block|{
...
name|getBean
argument_list|(
literal|"testGroupClaimsHandlerOtherUsers"
argument_list|)
decl_stmt|;
name|String
name|user
...
specifier|public
name|void
name|testRetrieveRolesForBobInBusinessCategoryWidgets
parameter_list|()
throws|throws
name|Exception
block|{
...
name|getBean
argument_list|(
literal|"testGroupClaimsHandlerFilter"
argument_list|)
decl_stmt|;
name|String
name|user
