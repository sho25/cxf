...
specifier|public
name|void
name|testGetUnformatServiceList
parameter_list|()
throws|throws
name|Exception
block|{
...
name|CONTEXT_URL
operator|+
literal|"/services?formatted=false"
argument_list|)
decl_stmt|;
name|assertTrue
argument_list|(
...
name|contains
argument_list|(
literal|"http://localhost/mycontext/services/greeter3"
argument_list|)
argument_list|)
expr_stmt|;
name|assertTrue
...
name|contains
argument_list|(
literal|"http://localhost/mycontext/services/greeter2"
argument_list|)
argument_list|)
expr_stmt|;
name|assertTrue
...
name|contains
argument_list|(
literal|"http://localhost/mycontext/services/greeter"
argument_list|)
argument_list|)
expr_stmt|;
block|}
...
specifier|public
name|void
name|testServiceListWithLoopAddress
parameter_list|()
throws|throws
name|Exception
block|{
...
name|loopAddr
init|=
literal|"http://127.0.0.1/mycontext"
decl_stmt|;
name|res
operator|=
name|client
...
name|contains
argument_list|(
literal|"http://127.0.0.1/mycontext/serviceshttp://localhost/mycontext/services/greeter"
argument_list|)
argument_list|)
expr_stmt|;
block|}
...
specifier|public
name|void
name|testGetWSDLWithMultiplePublishedEndpointUrl
parameter_list|()
throws|throws
name|Exception
block|{
...
name|CONTEXT_URL
operator|+
literal|"/services/greeter5?wsdl"
argument_list|)
decl_stmt|;
name|WebResponse
name|res
...
name|assertValid
argument_list|(
literal|"//wsdl:service[@name='SOAPService']/wsdl:port[@name='SoapPort']/wsdlsoap:address[@location='"
operator|+
literal|"http://cxf.apache.org/publishedEndpointUrl1']"
argument_list|,
name|doc
argument_list|)
expr_stmt|;
name|assertValid
argument_list|(
literal|"//wsdl:service[@name='SOAPService']/wsdl:port[@name='SoapPort1']/wsdlsoap:address[@location='"
operator|+
literal|"http://cxf.apache.org/publishedEndpointUrl2']"
argument_list|,
name|doc
argument_list|)
expr_stmt|;
