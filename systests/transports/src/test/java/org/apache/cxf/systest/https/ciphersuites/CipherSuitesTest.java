...
expr_stmt|;
block|}
comment|// Both client + server include AES, client enables a TLS v1.3 CipherSuite
annotation|@
name|org
operator|.
name|junit
...
name|getResource
argument_list|(
literal|"ciphersuites-client-tlsv13.xml"
argument_list|)
decl_stmt|;
name|Bus
name|bus
...
specifier|public
name|void
name|testAESIncludedTLSv13ViaCode
parameter_list|()
throws|throws
name|Exception
block|{
...
name|singletonList
argument_list|(
literal|"TLS_AES_128_GCM_SHA256"
argument_list|)
argument_list|)
expr_stmt|;
name|conduit
...
name|getResource
argument_list|(
literal|"ciphersuites-client-expired-cert.xml"
argument_list|)
decl_stmt|;
name|Bus
name|bus
...
argument_list|)
decl_stmt|;
comment|// Check we have no anon ciphersuites
name|assertFalse
argument_list|(
name|Arrays
operator|.
...
argument_list|)
decl_stmt|;
comment|// Check we have anon ciphersuites
name|assertTrue
argument_list|(
name|Arrays
operator|.
