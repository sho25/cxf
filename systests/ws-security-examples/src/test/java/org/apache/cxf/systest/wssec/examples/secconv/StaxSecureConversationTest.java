...
begin_comment
comment|/**  * A set of tests for SecureConversation using policies defined in the OASIS spec:  * "WS-SecurityPolicy Examples Version 1.0".  *   * It tests both DOM + StAX clients against the StAX server  */
end_comment

begin_class
specifier|public
class|class
name|StaxSecureConversationTest
extends|extends
name|AbstractBusClientServerTestBase
block|{
specifier|static
