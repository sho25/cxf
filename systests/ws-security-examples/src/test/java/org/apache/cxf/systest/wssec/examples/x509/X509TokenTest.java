...
expr_stmt|;
block|}
comment|/**      * 2.2.1 (WSS1.0) X.509 Certificates, Sign, Encrypt      */
annotation|@
name|org
operator|.
name|junit
...
specifier|public
name|void
name|testAsymmetricSignEncrypt
parameter_list|()
throws|throws
name|Exception
block|{
...
name|NAMESPACE
argument_list|,
literal|"DoubleItAsymmetricSignEncryptPort"
argument_list|)
decl_stmt|;
name|DoubleItPortType
name|x509Port
...
name|NAMESPACE
argument_list|,
literal|"DoubleItSymmetricSignEncryptPort"
argument_list|)
decl_stmt|;
name|DoubleItPortType
name|x509Port
...
name|NAMESPACE
argument_list|,
literal|"DoubleItSymmetricEndorsingPort"
argument_list|)
decl_stmt|;
name|DoubleItPortType
name|x509Port
...
expr_stmt|;
block|}
comment|// TODO - support endorsing Streaming
if|if
condition|(
operator|!
name|test
