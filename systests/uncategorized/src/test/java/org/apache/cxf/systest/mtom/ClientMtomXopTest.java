...
specifier|public
name|void
name|testMtomWithValidationErrorOnServer
parameter_list|()
throws|throws
name|Exception
block|{
...
argument_list|)
expr_stmt|;
comment|//name length> 80 to break the schema
comment|//will throw exception on server side
name|name
operator|=
operator|new
name|Holder
...
name|fail
argument_list|(
literal|"should throw javax.xml.ws.soap.SOAPFaultException"
argument_list|)
expr_stmt|;
block|}
catch|catch
