...
begin_comment
comment|/**  * Tests load distribution within a static cluster.  */
end_comment
...
init|=
literal|"org/apache/cxf/systest/clustering/load_distributor.xml"
decl_stmt|;
specifier|protected
name|String
name|getConfig
...
expr_stmt|;
block|}
comment|/*      * This test can't be left to super because the distributor ignores the default      * endpoint, so we need to get REPLICA_A added to the list of endpoints.      */
annotation|@
name|Test
annotation|@
name|Override
...
argument_list|()
expr_stmt|;
comment|// Change the strategy to iterate through the endpoints
name|ConduitSelector
name|conduitSelector
init|=
name|ClientProxy
