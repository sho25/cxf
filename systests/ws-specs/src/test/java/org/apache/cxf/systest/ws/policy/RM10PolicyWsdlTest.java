...
begin_comment
comment|/**  * Tests the use of the WS-Policy Framework to automatically engage WS-RM 1.0 in response to Policies defined for the  * endpoint via an direct attachment to the wsdl.  */
end_comment

begin_class
specifier|public
class|class
name|RM10PolicyWsdlTest
extends|extends
...
block|{
return|return
literal|"org/apache/cxf/systest/ws/policy/rm10wsdl_server.xml"
return|;
block|}
block|}
annotation|@
