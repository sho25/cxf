...
argument_list|,
literal|"http://localhost:9091/jaxws/addNonAnon"
argument_list|)
expr_stmt|;
try|try
block|{
...
name|ENDPOINT_ADDRESS_PROPERTY
argument_list|,
literal|"http://localhost:9091/jaxws/addAnon"
argument_list|)
expr_stmt|;
name|AddressingPropertiesImpl
name|maps
...
name|setValue
argument_list|(
literal|"http://localhost:9095/not/a/real/url"
argument_list|)
expr_stmt|;
name|ref
operator|.
