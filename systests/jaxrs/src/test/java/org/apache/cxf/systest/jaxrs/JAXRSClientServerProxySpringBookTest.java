...
init|=
literal|"http://localhost:9080/test/bookstore/books/12345"
decl_stmt|;
name|URL
name|url
init|=
...
name|getBook
argument_list|(
literal|"http://localhost:9080/test/4/bookstore/books/123"
argument_list|)
expr_stmt|;
name|getBook
argument_list|(
...
name|getBook
argument_list|(
literal|"http://localhost:9080/test/4/bookstorestorage/thosebooks/123"
argument_list|)
expr_stmt|;
block|}
annotation|@
...
name|getBook
argument_list|(
literal|"http://localhost:9080/test/5/bookstore/books/123"
argument_list|)
expr_stmt|;
block|}
annotation|@
...
name|getBook
argument_list|(
literal|"http://localhost:9080/test/5/bookstorestorage/thosebooks/123"
argument_list|)
expr_stmt|;
block|}
annotation|@
...
name|getBook
argument_list|(
literal|"http://localhost:9080/test/6/bookstorestorage/thosebooks/123"
argument_list|)
expr_stmt|;
block|}
annotation|@
...
name|getBook
argument_list|(
literal|"http://localhost:9080/test/2/bookstore/books/123"
argument_list|)
expr_stmt|;
block|}
annotation|@
...
name|getBook
argument_list|(
literal|"http://localhost:9080/test/3/bookstore2/books/123"
argument_list|)
expr_stmt|;
block|}
specifier|private
