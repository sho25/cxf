...
name|PORT
operator|+
literal|"/match/my/resource/1/matched/uris/param"
argument_list|)
decl_stmt|;
name|WebClient
operator|.
...
name|PORT
operator|+
literal|"/match/my/resource/1/matched/uris/param/2"
argument_list|)
decl_stmt|;
name|WebClient
operator|.
...
name|Path
argument_list|(
literal|"matched/uris/param"
argument_list|)
specifier|public
name|Object
name|getMatchedUrisParam
parameter_list|(
annotation|@
name|PathParam
argument_list|(
...
name|Path
argument_list|(
literal|"matched/uris/param/{param2}"
argument_list|)
specifier|public
name|Object
name|getMatchedUrisParam2
parameter_list|()
block|{
return|return
name|concat
