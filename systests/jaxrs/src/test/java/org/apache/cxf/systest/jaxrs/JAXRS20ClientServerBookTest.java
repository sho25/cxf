...
specifier|public
name|void
name|testPreMatchContainerFilterThrowsIOException
parameter_list|()
block|{
name|String
name|address
...
specifier|public
name|void
name|testClientFiltersLocalResponseLambdas
parameter_list|()
block|{
name|String
name|address
...
specifier|public
name|void
name|testBookExistsServerAddressOverwriteWithQuery
parameter_list|()
throws|throws
name|Exception
block|{
...
name|PORT
operator|+
literal|"/bookstore/books/checkNQuery?a=b"
decl_stmt|;
name|WebClient
name|wc
init|=
...
name|address
init|=
literal|"http://unknown-host/bookstore/bookheaders/simple/async"
decl_stmt|;
try|try
block|{
name|doTestPostBookAsyncHandler
...
name|fail
argument_list|(
literal|"Should fail with UnknownHostException"
argument_list|)
expr_stmt|;
block|}
catch|catch
...
specifier|public
name|void
name|testGetSetEntityStreamLambda
parameter_list|()
block|{
name|String
name|address
