...
specifier|public
name|Attachment
name|getAttachmentWithStringContent
parameter_list|()
throws|throws
name|Exception
block|{
...
specifier|public
name|Attachment
name|getAttachmentWithByteContent
parameter_list|()
throws|throws
name|Exception
block|{
...
name|RuntimeException
argument_list|(
literal|"Wrong attachinforef property"
argument_list|)
throw|;
block|}
if|if
...
name|Path
argument_list|(
literal|"/books/testnullpartprimitive"
argument_list|)
annotation|@
name|Consumes
argument_list|(
...
name|Path
argument_list|(
literal|"/books/jaxbjsonimage/read2"
argument_list|)
annotation|@
name|Produces
argument_list|(
...
specifier|public
name|Book
name|addBookFromInputStreamReadItself
parameter_list|(
name|InputStream
name|is
parameter_list|)
...
name|Path
argument_list|(
literal|"/books/jaxbjsonconsumes"
argument_list|)
annotation|@
name|Consumes
argument_list|(
...
name|Path
argument_list|(
literal|"/books/jaxbandsimpleparts"
argument_list|)
annotation|@
name|Consumes
argument_list|(
...
specifier|public
name|Response
name|addBookFilesFormNoOwnerParam
parameter_list|(
annotation|@
name|Multipart
argument_list|(
...
name|Path
argument_list|(
literal|"/books/filesform/singlefile"
argument_list|)
annotation|@
name|Produces
argument_list|(
...
specifier|public
name|Response
name|addBookFilesFormSingleFile
parameter_list|(
annotation|@
name|Multipart
argument_list|(
...
name|Path
argument_list|(
literal|"/books/mixedmultivaluedmap"
argument_list|)
annotation|@
name|Consumes
argument_list|(
...
specifier|public
name|Response
name|addBookFromFormConsumesMixed
parameter_list|(
annotation|@
name|Multipart
argument_list|(
...
name|Exception
argument_list|(
literal|"Map entry 0 does not match"
argument_list|)
throw|;
block|}
if|if
...
name|Exception
argument_list|(
literal|"Map entry 1 does not match"
argument_list|)
throw|;
block|}
if|if
...
name|Exception
argument_list|(
literal|"Map entry 2 does not match"
argument_list|)
throw|;
block|}
if|if
...
name|Exception
argument_list|(
literal|"Map size does not match"
argument_list|)
throw|;
block|}
if|if
condition|(
literal|"<hello>World2</hello>"
operator|.
name|equals
argument_list|(
name|testXml
...
name|Exception
argument_list|(
literal|"testXml does not match"
argument_list|)
throw|;
block|}
name|Book
