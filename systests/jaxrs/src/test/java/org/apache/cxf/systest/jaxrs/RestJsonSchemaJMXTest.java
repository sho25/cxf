...
name|createBus
argument_list|(
literal|"/org/apache/cxf/systest/jaxrs/jmx-enable.xml"
argument_list|)
decl_stmt|;
name|BusFactory
operator|.
...
argument_list|,
literal|"org.apache.cxf.systest.jaxrs.Book"
argument_list|)
expr_stmt|;
name|parseJson
argument_list|(
...
name|serviceName
init|=
literal|"{http://jaxrs.systest.cxf.apache.org/}BookStore"
decl_stmt|;
name|String
name|portName
init|=
