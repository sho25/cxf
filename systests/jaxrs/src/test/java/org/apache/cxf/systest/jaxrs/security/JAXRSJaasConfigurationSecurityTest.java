...
specifier|public
class|class
name|JAXRSJaasConfigurationSecurityTest
extends|extends
...
name|PORT
operator|+
literal|"/service/jaasConfig/bookstorestorage/thosebooks/123"
decl_stmt|;
name|getBook
argument_list|(
name|endpointAddress
...
name|PORT
operator|+
literal|"/service/jaasConfigFilter/bookstorestorage/thosebooks/123"
decl_stmt|;
name|WebClient
name|wc
init|=
