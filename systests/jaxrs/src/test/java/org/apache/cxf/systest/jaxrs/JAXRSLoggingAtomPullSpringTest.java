...
name|create
argument_list|(
literal|"http://localhost:9080/services"
argument_list|)
operator|.
name|get
argument_list|(
...
name|verifyPages
argument_list|(
literal|"http://localhost:9080/atom2/logs/3"
argument_list|,
literal|"previous"
argument_list|,
literal|2
...
name|create
argument_list|(
literal|"http://localhost:9080/resource3/storage"
argument_list|)
decl_stmt|;
name|HTTPConduit
name|conduit
...
argument_list|(
literal|"http://localhost:9080/atom3/logs"
argument_list|,
literal|"next"
argument_list|,
literal|"Resource3"
...
name|verifyStoragePages
argument_list|(
literal|"http://localhost:9080/atom3/logs/2"
argument_list|,
literal|"previous"
argument_list|,
literal|"Resource3"
...
name|verifyStoragePages
argument_list|(
literal|"http://localhost:9080/atom4/logs"
argument_list|,
literal|"next"
argument_list|,
literal|"Resource4"
...
name|verifyStoragePages
argument_list|(
literal|"http://localhost:9080/atom4/logs/2"
argument_list|,
literal|"previous"
argument_list|,
literal|"Resource4"
