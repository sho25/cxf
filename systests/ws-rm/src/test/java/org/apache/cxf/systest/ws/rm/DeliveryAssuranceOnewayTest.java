...
specifier|public
name|void
name|testOnewayAtLeastOnceInOrderDelay
parameter_list|()
throws|throws
name|Exception
block|{
...
name|init
argument_list|(
literal|"org/apache/cxf/systest/ws/rm/atleastonce-inorder.xml"
argument_list|,
literal|null
argument_list|)
expr_stmt|;
...
name|assertEquals
argument_list|(
literal|"Some messages were not received"
argument_list|,
name|numMessages
argument_list|,
name|actualArgs
