...
argument_list|)
expr_stmt|;
comment|//feature.setRMNamespace(RM11Constants.NAMESPACE_URI);
return|return
name|feature
return|;
block|}
...
argument_list|)
expr_stmt|;
comment|// this will cause an exception as the sequence is no longer valid
comment|//greeter.greetMe("four");
operator|(
operator|(
name|Closeable
operator|)
