...
expr_stmt|;
block|}
comment|/**      * Checks that all callbacks are received, that messages are accepted in order, and that each message is accepted      * before it is acknowledged (order of acknowledgements doesn't really matter).      */
specifier|private
name|void
name|verifyCallbacks
parameter_list|()
block|{
name|List
argument_list|<
