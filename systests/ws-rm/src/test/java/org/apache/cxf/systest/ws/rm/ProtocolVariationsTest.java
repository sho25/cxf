...
name|fail
argument_list|(
literal|"invalid namespace combination accepted"
argument_list|)
expr_stmt|;
block|}
catch|catch
...
specifier|public
name|void
name|testInvalidRM11WSA200408OnReceive
parameter_list|()
throws|throws
name|Exception
block|{
...
argument_list|)
expr_stmt|;
comment|// WS-RM 1.0 using the WS-A 1.0 namespace
name|Client
name|client
init|=
name|ClientProxy
...
argument_list|)
expr_stmt|;
comment|// rewrite the outgoing message's WS-RM namespace to 1.1
name|TransformOutInterceptor
name|trans
init|=
operator|new
...
argument_list|)
expr_stmt|;
comment|// rewrite the outgoing message's WS-A namespace to an invalid one
name|TransformOutInterceptor
name|trans
init|=
operator|new
...
literal|"}*"
argument_list|,
literal|"{http://cxf.apache.org/invalid}*"
argument_list|)
expr_stmt|;
name|trans
operator|.
...
name|fail
argument_list|(
literal|"invalid wsa header accepted"
argument_list|)
expr_stmt|;
block|}
catch|catch
...
name|text
init|=
literal|"WS-Addressing is required"
decl_stmt|;
name|assertTrue
argument_list|(
name|e
...
specifier|public
name|void
name|testInvalidWSRMMustUnderstandOnReceive
parameter_list|()
throws|throws
name|Exception
block|{
...
argument_list|)
expr_stmt|;
comment|// rewrite the outgoing message's WS-RM namespace to an invalid one
name|TransformOutInterceptor
name|trans
init|=
operator|new
...
argument_list|)
expr_stmt|;
comment|// remove the outgoing message's WS-RM header
name|TransformOutInterceptor
name|trans
init|=
operator|new
...
specifier|public
name|void
name|testTerminateSequenceDefault
parameter_list|()
throws|throws
name|Exception
block|{
...
specifier|public
name|void
name|testTerminateSequenceRM11
parameter_list|()
throws|throws
name|Exception
block|{
