...
init|=
literal|"http://schemas.xmlsoap.org/ws/2004/08/addressing/fault"
decl_stmt|;
specifier|private
specifier|static
name|String
...
specifier|public
name|void
name|testOnewayAnonymousAcksClientSequenceDemarcation
parameter_list|()
throws|throws
name|Exception
block|{
...
argument_list|)
expr_stmt|;
comment|// three application messages plus two createSequence plus one
comment|// terminateSequence
name|awaitMessages
argument_list|(
literal|6
...
specifier|public
name|void
name|testTwowayAnonymousSequenceLength1
parameter_list|()
throws|throws
name|Exception
block|{
...
argument_list|)
expr_stmt|;
comment|// outbound: CS, greetReq,     TS, SA
comment|// inbound: CSR, greetResp+SA,   , TS
name|awaitMessages
argument_list|(
literal|4
argument_list|,
...
name|fail
argument_list|(
literal|"Expected timeout. Received response: "
operator|+
name|s
argument_list|)
expr_stmt|;
...
expr_stmt|;
comment|// createSequenceResponse plus 3 greetMeResponse messages plus
comment|// one sequence ack response.
name|mf
operator|.
name|verifyMessages
argument_list|(
...
argument_list|)
expr_stmt|;
comment|// expecting 3 outbounds and 2 inbounds
name|awaitMessages
argument_list|(
literal|3
argument_list|,
...
argument_list|)
expr_stmt|;
comment|// expecting 2 outbounds and 2 inbounds
name|awaitMessages
argument_list|(
literal|2
argument_list|,
...
argument_list|)
decl_stmt|;
comment|// this test also verify the DB is correctly being updated during the shutdown
name|RMMemoryStore
name|store
init|=
operator|new
...
argument_list|)
expr_stmt|;
comment|// additional check to verify the operations performed on DB
name|assertEquals
argument_list|(
literal|"sequences not released from DB"
argument_list|,
literal|0
argument_list|,
name|store
...
name|assertEquals
argument_list|(
literal|"messages not released from DB"
argument_list|,
literal|0
argument_list|,
name|store
...
name|assertEquals
argument_list|(
literal|"sequence not closed in DB"
argument_list|,
literal|1
argument_list|,
name|store
...
specifier|public
name|void
name|testCreateSequenceRefused
parameter_list|()
throws|throws
name|Exception
block|{
name|init
argument_list|(
literal|"org/apache/cxf/systest/ws/rm/limit-seqs.xml"
argument_list|)
expr_stmt|;
name|RMManager
name|manager
...
name|assertEquals
argument_list|(
literal|"Unexpected maximum sequence count."
argument_list|,
literal|1
argument_list|,
name|manager
...
parameter_list|)
block|{
comment|// sequence creation refused
block|}
comment|// the third inbound message has a SequenceFault header
name|MessageFlow
name|mf
...
name|RMStore
block|{
comment|// during this particular test, the operations are expected to be invoked sequentially so use just HashMap
name|Map
argument_list|<
name|Identifier
argument_list|,
...
condition|)
block|{
comment|//  update the sequence status and add the message
name|cm
operator|.
name|add
argument_list|(
...
block|{
comment|// update only the sequence status
if|if
condition|(
name|seq
operator|.
