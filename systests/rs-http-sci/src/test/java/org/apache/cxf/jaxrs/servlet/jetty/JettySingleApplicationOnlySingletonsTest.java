...
specifier|public
class|class
name|JettySingleApplicationOnlySingletonsTest
extends|extends
name|AbstractSciTest
block|{
annotation|@
...
argument_list|)
block|,
comment|// Include JAX-RS application from org.apache.applications.singletons package
name|Resource
operator|.
name|newClassPathResource
argument_list|(
literal|"/org/apache/demo/applications/singletons"
argument_list|)
block|}
argument_list|,
name|PORT
