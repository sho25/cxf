...
argument_list|)
expr_stmt|;
comment|/*              * TODO             properties.addSignaturePart(                 new SecurePart(new QName("http://www.w3.org/2005/08/addressing", "ReplyTo"), SecurePart.Modifier.Element)             );             */
name|properties
operator|.
...
argument_list|)
expr_stmt|;
comment|/*              * TODO             // Check to make sure that the SOAP Body and Timestamp were signed,             // and that the SOAP Body was encrypted             DefaultCryptoCoverageChecker coverageChecker = new DefaultCryptoCoverageChecker();             coverageChecker.setSignBody(true);             coverageChecker.setSignTimestamp(true);             coverageChecker.setEncryptBody(true);             bus.getInInterceptors().add(coverageChecker);             */
name|GreeterService
name|service
init|=
operator|new
