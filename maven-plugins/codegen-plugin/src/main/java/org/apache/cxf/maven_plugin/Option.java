...
name|validateWsdl
decl_stmt|;
comment|/**      * Enables or disables generation of the type classes. Default value is true.      */
name|Boolean
name|generateTypes
decl_stmt|;
comment|/**      * Enables generation of fault Exception's SUID based on hash of classname.      */
name|Boolean
name|useFQCNForFaultSerialVersionUID
decl_stmt|;
...
specifier|public
name|void
name|setUseFQCNForFaultSerialVersionUID
parameter_list|(
name|boolean
name|useFQCNForFaultSerialVersionUID
parameter_list|)
