...
name|exceptionSuper
decl_stmt|;
comment|/**      * The superinterfaces to use for generated SEIs      */
name|List
argument_list|<
name|String
argument_list|>
...
name|markGenerated
decl_stmt|;
comment|/**      * Prevents dumping current date as part of @Generated annotation as well as part of      * the javadocs of the Java files generated.      */
name|Boolean
name|suppressGeneratedDate
decl_stmt|;
