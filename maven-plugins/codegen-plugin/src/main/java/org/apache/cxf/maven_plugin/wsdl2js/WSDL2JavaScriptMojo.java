...
name|property
operator|=
literal|"cxf.testJavascriptRoot"
argument_list|)
name|File
name|testSourceRoot
decl_stmt|;
...
name|defaultValue
operator|=
literal|"${project.build.directory}/generated-sources/cxf-js"
argument_list|,
name|property
operator|=
literal|"cxf.sourceJavascriptRoot"
argument_list|)
name|File
name|sourceRoot
decl_stmt|;
comment|/**      * Default options to be applied to all of the wsdls.      */
annotation|@
name|Parameter
name|Option
name|defaultOptions
